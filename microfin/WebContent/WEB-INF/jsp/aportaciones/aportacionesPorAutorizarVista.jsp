...
<html>
	<head>
     	...
     	<script type="text/javascript" src="dwr/interface/tiposAportacionesServicio.js"></script> 
   	 	<script type="text/javascript" src="js/aportaciones/aportacionesPorAutorizar.js"></script>  
	</head> 
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="aportacionesBean">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte Aportaciones Por Autorizar</legend>
          				...
          				<table  border="0"  width="560px">
							<tr>			
						   	...
						   	<tr>		
								...
								<td nowrap="nowrap">
									<form:input id="tipoAportacionID" name="tipoAportacionID" path="tipoAportacionID" tabIndex = "2" type="text" size="10" maxlength="11" autocomplete="off" />
