...
<head>
	...
	<script type="text/javascript" src="js/aportaciones/repVencimientosDiaAportacion.js"></script>
...
<div id="contenedorForma">
	...
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Vencimientos del D&iacute;a</legend>
		...
		<form id="formaGenerica" name="formaGenerica" method="POST" commandName="vencimientoAportaciones"  target="_blank">
						...
						<legend><label>Par&aacute;metros</label></legend>         
          				<table  border="0"  width="560px">
							...
							<tr>
								...
								<td>
								<input type="text" id="aportacionID" name="aportacionID" size="6" tabindex="3" maxlength="9"/>
							...
							<tr>
								...
								<td>
								<input type="text" id="sucursalID" name="sucursalID" size="6" tabindex="4" maxlength="9"/>
							...
							<tr>
								...
								<td>
								<input type="text" id="promotorID" name="promotorID" size="6" tabindex="5" maxlength="9"/>
