...
<html>
	<head>
		...
		<script type="text/javascript" src="js/aportaciones/reinvierteAportacion.js"></script>
		<title>
			Reinversi&oacute;n Manual Aportaci&oacute;n
		</title>
	</head>
	<body>
		<div id="contenedorForma">
				<fieldset class="ui-widget ui-widget-content ui-corner-all" >
					<legend class="ui-widget ui-widget-header ui-corner-all">Reinversi&oacute;n Manual Aportaci&oacute;n</legend>
						...
						<fieldset class="ui-widget ui-widget-content ui-corner-all">
							...
							<table border="0" width="100%">
								<tr>
									...
									<td>
										<input type="text" name="aportacionID" id="aportacionID" size="11" tabIndex = "1" autocomplete="off"/>
								...
								<tr>
									<table border="0" width="100%">
										...
										<tr>
											...
											<td nowrap="nowrap">
												<input id="tipoAportacionID" name="tipoAportacionID" size="5" autocomplete="off"  readonly="true"/>
												...
												<label id="tipoMonedaAportacion"></label>
											</td>
											<td>
										...
										<fieldset class="ui-widget ui-widget-content ui-corner-all">
											...
											<table border="0">
												...
												<tr>
													...
													<td nowrap="nowrap">
														<input type="text" name="tasa" id="tasa" size="12" readonly="true" 			style="text-align: right;" onkeypress="return validaDigitos(event, this.id)"/><label>%</label>
													</td>
														...
														<td>
															<div id="comentHistorial"  >
																<textarea id="comentAport" name="comentAport" disabled rows="2" cols="52"
																		style="margin: 2px; width: 640px; height: 64px;" ></textarea>
															</div>
														</td>
													</tr>
													...
													<table align="right" boder='0'>
														<tr>
															<td align="right">
																...
																<input type="submit" id="cancelar" name="cancelar" class="submit" value="No Reinvertir(Abonar Aportaci&oacute;n)" tabIndex="10" />
										                     	<button type="button" class="submit" id="imprime" name="imprime" tabIndex="11" >
																	Imprimir Pagar&eacute;</button>
