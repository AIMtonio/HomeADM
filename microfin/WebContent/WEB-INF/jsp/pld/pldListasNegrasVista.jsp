...
<script type="text/javascript" src="js/pld/pldListasNegras.js"></script>
</head>
<body>
	<div id="contenedorForma">
		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="listasNegras">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-content ui-widget-header ui-corner-all">Listas Negras</legend>
				<table border="0" width="100%">
					<tr>
						<td class="label"><label for="listaNegraID">N&uacute;mero: </label></td>
						<td class="label"><form:input type="text" id="listaNegraID" name="listaNegraID" path="listaNegraID" size="10" tabindex="1" /></td>
					...
					<tr name="personaFisica">
						...
						<td><form:input type="text" id="primerNombre" name="primerNombre" path="primerNombre" size="50" maxlength="200" tabindex="4" onBlur=" ponerMayusculas(this)" /></td>
						<td class="separador"></td>
						<td class="label"><label for="segundoNombre">Segundo Nombre: </label></td>
						<td><form:input type="text" id="segundoNombre" name="segundoNombre" path="segundoNombre" size="50" maxlength="50" tabindex="5" onBlur=" ponerMayusculas(this)" /></td>
					</tr>
					<tr name="personaFisica">
						<td class="label"><label for="tercerNombre">Tercer Nombre:</label></td>
						<td><form:input type="text" id="tercerNombre" name="tercerNombre" path="tercerNombre" size="50" maxlength="50" tabindex="6" onBlur=" ponerMayusculas(this)" /></td>
						<td class="separador"></td>
						<td class="label"><label for="apellidoPaterno">Apellido Paterno:</label></td>
						<td><form:input type="text" id="apellidoPaterno" name="apellidoPaterno" path="apellidoPaterno" size="50" maxlength="200" tabindex="7" onBlur=" ponerMayusculas(this)" /></td>
					</tr>
					<tr name="personaFisica">
						<td class="label"><label for="apellidoMaterno">Apellido Materno:</label></td>
						<td><form:input type="text" id="apellidoMaterno" name="apellidoMaterno" path="apellidoMaterno" size="50" maxlength="200" tabindex="8" onBlur=" ponerMayusculas(this)" /></td>
						<td class="separador"></td>
						<td class="label"><label type="text" for="fechaNacimiento">Fecha de Nacimiento:</label></td>
						<td><form:input type="text" id="fechaNacimiento" name="fechaNacimiento" esCalendario="true" path="fechaNacimiento" size="15" tabindex="9" maxlength="10" /></td>
					</tr>
					<tr name="personaFisica">
						<td class="label"><label for="frecuencia">RFC:</label></td>
						<td><form:input type="text" id="RFC" name="RFC" path="RFC" size="25" tabindex="10" onBlur=" ponerMayusculas(this)" maxlength="13" />
						<input type="button" id="generar" name="generar" value="Generar" class="submit" /></td>
						<td class="separador"></td>
						<td class="label"><label for="InvolucraEmpleado">Nombres Conocidos:</label></td>
						<td><form:input id="nombresConocidos" name="nombresConocidos" path="nombresConocidos" tabindex="11" size="50" maxlength="100" onBlur=" ponerMayusculas(this)" /></td>
					</tr>
					...
					<tr>
						...
						<td nowrap="nowrap"><form:input type="text" id="paisID" name="paisID" path="paisID" size="6" tabindex="14" onBlur=" ponerMayusculas(this)" /> <input type="text" id="nombrePais" name="nombrePais" size="45" disabled="true" readOnly="true" tabindex="11" /></td>
						<td class="separador"></td>
						<td class="label"><label for="estadoID" id="lblEstado">Estado:</label></td>
						<td nowrap="nowrap"><form:input type="text" id="estadoID" name="estadoID" path="estadoID" size="6" tabindex="15" /> <input type="text" id="nombreEstado" name="nombreEstado" size="45" disabled="true" readOnly="true" tabindex="13" /></td>
					</tr>
					<tr>
						<td class="label"><label for="tipoLista">Tipo Lista:</label></td>
						<td nowrap="nowrap"><form:input type="text" id="tipoLista" name="tipoLista" path="tipoLista" size="6" tabindex="16" onBlur=" ponerMayusculas(this)" autocomplete="off" /> <input type="text" id="tipoListaDes" name="tipoListaDes" size="45" disabled="true" readOnly="true" tabindex="13" /></td>
						<td class="separador"></td>
					...
					<tr>
						...
						<td><form:input type="text" id="numeroOficio" name="numeroOficio" maxlength="50" path="numeroOficio" size="12" tabindex="18"/></td>
					</tr>
					<tr>
