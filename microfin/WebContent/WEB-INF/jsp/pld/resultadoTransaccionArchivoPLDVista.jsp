...
<body onbeforeunload="javascript:devolverRutaArchivo()">
	...
	<form id="formaOculta">
		...
		<input type="hidden" name="operacion1" id="operacion1" value="${mensaje.consecutivoString}">
		<input type="hidden" name="tipoProceso1" id="tipoProceso1" value="${mensaje.nombreControl}">
	</form>
</body>
</html>
<script type="text/javascript">
	function devolverRutaArchivo() {
		var tipoProceso = document.forms["formaOculta"].tipoProceso1.value;
		var operacion = document.forms["formaOculta"].operacion1.value;
		window.opener.consultaArchivos(tipoProceso,operacion,operacion);
		self.close();
	}
</script>
