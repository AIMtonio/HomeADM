...
<%@page pageEncoding="UTF-8"%>
	<html>	
		<head> 
		   ...
		   <script type="text/javascript" src="js/regulatorios/regulatorioC453Sofipo.js"></script>	      
		</head>
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatoriosCarteraBean"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Baja de Créditos Otorgados  (C-0453)</legend> 
											...
											<td>
												<fieldset class="ui-widget ui-widget-content ui-corner-all">                
													<legend><label>Presentaci&oacute;n</label></legend>
														<input type="radio" id="excel" checked="checked" tabindex="5">
														<label> Excel </label>	
														<br>
														<input type="radio" id="csv" tabindex="6">
														<label> Csv </label>	
												</fieldset>
											</td>
