	...
	<html>	
		...
		<script type="text/javascript" src="dwr/interface/paramGeneralesServicio.js"></script> 
		   ...
		   <script type="text/javascript" src="js/regulatorios/regulatorioD2441.js"></script>	      
		</head>
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatorioD2441Bean"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Uso de Servicios Financieros (D-2441)</legend> 
