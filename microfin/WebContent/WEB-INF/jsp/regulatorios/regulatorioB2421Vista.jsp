	...
	<html>	
		<head>
		   ...
		   <script type="text/javascript" src="js/regulatorios/regulatorioB2421.js"></script>	      
		</head>
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatorioB2421Bean"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Operaciones Referentes a Productos de Captación (B-2421)</legend> 
