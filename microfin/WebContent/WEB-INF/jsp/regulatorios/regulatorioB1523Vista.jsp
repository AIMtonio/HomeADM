...
<%@page pageEncoding="UTF-8"%>
	<html>	
		<head>
		   ...
		   <script type="text/javascript" src="js/regulatorios/regulatorioB1523.js"></script>	      
		</head>
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatoriosCarteraBean"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Operaciones de Clientes a tráves de Medios Electrónicos (B-1523)</legend> 
