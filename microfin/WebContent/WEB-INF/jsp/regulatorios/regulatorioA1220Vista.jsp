	...
	<html>	
		<head>
			...
			<script type="text/javascript" src="dwr/interface/regulatorioInsServicio.js"></script>
		   	...
		   	<script type="text/javascript" src="js/regulatorios/regulatorioA1220.js"></script>	      
		</head>
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatorioA1220Bean"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Consolidaci&oacute;n del estado de Resultados con sus subsidiarias (A-1220)</legend> 
