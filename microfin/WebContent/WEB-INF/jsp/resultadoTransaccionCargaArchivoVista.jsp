...
<form id="formaOculta">
	...
	<input type="hidden" name="consecutivo" id="consecutivo" value="${mensaje.consecutivoInt}">
...
function devolverMensajeArchivo() {		
	window.opener.consultaGridDepositosRefe($('#consecutivo').val(), $('#numeroMensaje').val(), $('#consecutivoString').val(), $("#nombreControl").val());
	self.close();	
}
</script> 