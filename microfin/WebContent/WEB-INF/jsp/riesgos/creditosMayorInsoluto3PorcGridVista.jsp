			...
			<c:when test="${tipoLista == '1'}">
				<tr>
					...
					<td class="label" align="center" nowrap="nowrap">
			  		...
			  		<td class="label" align="center">
						<label for="diferencia">Diferencia entre el Monto<br>del 3.5% del Capital Neto </label> 
			  		</td>
			 	</tr>
				<c:forEach items="${listaResultado}" var="listaSaldo" varStatus="status">
					<tr id="renglon${status.count}" name="renglon">
						...
						<td> 
					  	...
					  	<td> 
					  		<input type="text" id="diferencia${status.count}" name="diferencia" size="20" value="${listaSaldo.difMontoCapNeto}" readOnly="true" style='text-align:right;'/> 
					  	</td> 
					</tr>
				</c:forEach>
			</c:when>
