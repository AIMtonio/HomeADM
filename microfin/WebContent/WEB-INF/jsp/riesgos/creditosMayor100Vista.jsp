...
<html>
	<head>
 	   <script type="text/javascript" src="dwr/interface/creditosMayor100Servicio.js"></script>   
      <script type="text/javascript" src="js/riesgos/creditosMayor100.js"></script> 		
	</head>
      
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="pagosMayor100">
			...
			<tr>
				<td colspan="4">
					<table align="right" border='0'>
						<tr>
							<td align="right">
							<a id="ligaGenerar" href="credMayor100Rep.htm" target="_blank" >  		 
