...
<html>
	<head> 
 	   <script type="text/javascript" src="dwr/interface/creditosMayorInsolutoPFServicio.js"></script>   
      <script type="text/javascript" src="js/riesgos/creditosMayorInsolutoPF.js"></script>  		
	</head>
      
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="mayorSaldoInsolutoPF">

<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Cr&eacute;ditos Mayor Insoluto P.F.</legend>
		<table border="0"  width="100%">
          ...
          <table  border="0"  width="100%">
 			...
 			<table>
	 	    	...
	 	    	<tr>	
					<td>
					 	<div id="divCredMayorInsolutoPF" style="display:none"/>
					</td>		
				</tr> 	
	 		</table>
 		</td>  
			...
			<table width="100%">
				<tr>
					<td class="label">
					<label for="">Total 20 Cr&eacute;ditos P/F&iacute;sicas: </label>
					</td>
					<td>
						<input id="totalCreditoPF" name="totalCreditoPF" size="20" type="text" readonly="true"  style="text-align: right;" />	
					</td>	
				</tr>
				<tr>
					<td class="label">
			...
			<tr>
				<td colspan="4">
					<table align="right" border='0'>
						<tr>
							<td align="right">
							<a id="ligaGenerar" href="credMayorInsolutoPFRep.htm" target="_blank" >  		 
