...
<html>
	<head>
 	   <script type="text/javascript" src="dwr/interface/creditosPagosParcialesServicio.js"></script>   
      <script type="text/javascript" src="js/riesgos/creditosPagosParciales.js"></script>  	
	</head>
      
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="pagosParciales">

<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Cr&eacute;ditos Pagos Parciales</legend>
					...
					<td>
						...
						<legend>Monto de Cartera Acumulado del D&iacute;a de Ayer</legend>
							<table>
								<tr>
									<td class="label">
										<label for="">Monto de Cartera Pagos Parciales: </label>
									</td>
									<td>
						...
						<fieldset class="ui-widget ui-widget-content ui-corner-all">                
							<legend>Saldo de Cartera Acumulado al D&iacute;a de Ayer</legend>
								<table>
									...
									<tr>
									<td class="label">
										<label for="">Saldo de Cartera Pagos Parciales: </label>
									</td>
									<td>
			...
			<tr>
				<td colspan="4">
					<table align="right" border='0'>
						<tr>
							<td align="right">
							<a id="ligaGenerar" href="credPagosParcialesRep.htm" target="_blank" >  		 
