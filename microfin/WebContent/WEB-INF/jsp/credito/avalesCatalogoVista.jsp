...
<html>
	<head>
		...
		<script type="text/javascript" src="js/credito/avales.js"></script>  
    ...
    <body>
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="avales">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">	                
					<legend class="ui-widget ui-widget-header ui-corner-all">Alta de Avales</legend>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody>
							<tr>
								<td class="label"> 
			         				<label for="avalID">N&uacute;mero: </label> 
					   			</td>
					  			<td> 
					      			<form:input id="avalID" name="avalID" path="avalID" size="12" tabindex="1" />  
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr>
									...
									<td>
										<form:input id="rFCpm" name="rFCpm" path="rFCpm" maxlength="12" tabindex="20" onBlur=" ponerMayusculas(this)" style="display: none"/>
									</td>
								</tr>
					 			<tr>  
					     			<td class="label">
					...
					<fieldset class="ui-widget ui-widget-content ui-corner-all">	
						...
						<table border="0" width="100%"> 		
							<tr> 
							   ...
							   <td> 
								   <form:input id="numIdentific" name="numIdentific" path="numIdentific" maxlength="18" size="25" tabindex="44" onBlur=" ponerMayusculas(this)"/> 
							   </td> 
							   <td class="label"> 
									 <label for="lblFecExIden">Fecha Expedici&oacute;n: </label> 
							   </td> 
							   <td> 
									 <form:input id="fecExIden" name="fecExIden" path="fecExIden" size="14" tabindex="45" esCalendario="true" /> 
							   </td> 
							</tr> 
							<tr> 
							   <td class="label"> 
							   ...
							   <td> 
									<form:input id="fecVenIden" name="fecVenIden" path="fecVenIden" size="14" tabindex="46" esCalendario="true"/> 
							   </td> 
							   <td></td>
							   <td></td>
							</tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tbody>									
							     	<tr> 
							     		...
							     		<td> 
							        		<form:select id="esc_Tipo" name="esc_Tipo" path="esc_Tipo" onblur="validaCampoSelect(this,this.id)" tabindex="47" >
							     		...
							     		<td> 
							         		<form:input id="escrituraPub" name="escrituraPub" path="escrituraPub" size="15" tabindex="48" maxlength="50" onkeyPress="soloLetrasYNum(this.id, this.value)" onBlur=" ponerMayusculas(this)" /> 											
							     		</td> 
						       		 </tr>   
							        <tr> 
								     	<td class="label"> 
								     	...
								     	<td> 
								        	<form:input id="libroEscritura" name="libroEscritura" path="libroEscritura" size="15" tabindex="49" maxlength="50" onkeyPress="soloLetrasYNum(this.id, this.value)" onBlur=" ponerMayusculas(this)" /> 
								     	</td> 
								        <td class="separador"></td> 
										<td class="label"> 
								     	...
								     	<td> 
								        	<form:input id="volumenEsc" name="volumenEsc" path="volumenEsc" size="15" tabindex="50" maxlength="20" onkeyPress="soloLetrasYNum(this.id, this.value)" onBlur=" ponerMayusculas(this)"/> 
								     	</td> 
							 		</tr> 
							 		<tr> 
							    		<td class="label"> 
							     		...
							     		<td> 
							         		<form:input id="fechaEsc" name="fechaEsc" path="fechaEsc" size="15" tabindex="51" esCalendario="true"/> 
							    		 </td> 
							          	<td class="separador"></td> 
										<td class="label" nowrap="nowrap"> 
							     		...
							     		<td> 
							         		<form:input id="estadoIDEsc" name="estadoIDEsc" path="estadoIDEsc" size="7" tabindex="52" /> 
									...
									<tr>
										<td class="label"> 
							     		...
							     		<td> 
									        <form:input id="localidadEsc" name="localidadEsc" path="localidadEsc" size="6" tabindex="53" /> 
									    ...
									    <td> 
									        <form:input id="notaria" name="notaria" path="notaria" size="7" tabindex="54" /> 
									    </td> 
								 	</tr> 
									<tr> 
								    	<td class="label" nowrap="nowrap"> 
							...
							<legend>Información Apoderados</legend>	
								<table border="0" width="100%"> 		
							 		<tr> 
									    ...
									    <td> 
									         <form:input id="RFC_Apoderado" name="RFC_Apoderado" path="RFC_Apoderado" size="15" tabindex="53" maxlength="13"
									         onBlur=" ponerMayusculas(this)"/> 
									    </td> 
							 		</tr> 							 		
							 	</table>
