...
<html>
	...
	<head>	
		...
		<script type="text/javascript" src="js/credito/lineasCreditoCatalogo.js"></script>        
	</head>
...
<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Líneas de Cr&eacute;dito</legend>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				   ...
				   <td> 
				      <form:input id="lineaCreditoID" name="lineaCreditoID" path="lineaCreditoID" size="20" 
				...
				<tr>  
				   ...
				   <td>
				      <form:input id="cuentaID" name="cuentaID" path="cuentaID" size="20" tabindex="4" numMax ="12"/>  
		 		...
		 		<tr> 
				   ...
				   <td> 
		     		...
		     		<td> 
		         	 <form:input id="folioContrato" name="folioContrato" path="folioContrato" size="20" tabindex="8" maxlength="15"/>  
		     		</td>
		 		</tr>  
		 		<tr> 
		     		<td class="label"> 
		     		...
		     		<td> 
		         	 <form:input id="fechaVencimiento" name="fechaVencimiento" path="fechaVencimiento" size="20" 
		         	 		tabindex="10" esCalendario="true"/>  
		     		</td>
		 		</tr>  
		 		<tr>  
		     		<td class="label"> 
		         	<label for="lblproductoCreditoID">Producto de Cr&eacute;dito:</label> 
					</td> 		     		
		     		<td>
		         	 <form:input id="productoCreditoID" name="productoCreditoID" path="productoCreditoID" size="20" 
		         	 		tabindex="11"/> 
		         	 <input type="text" id="desProductoCred" name="desProductoCred" path="desProductoCred" size="40" 
					...
					<td class="label"> 
		     		...
		     		<td> 
		         	 <form:input id="solicitado" name="solicitado" path="solicitado" size="20" 
		         	 		tabindex="11" esMoneda="true" style="text-align: right"/>  
		     		</td> 	
		     		<td class="separador"></td>
		 	 </tr> 	   
		 		<tr id= "valores1">
		     	...
		     	<tr id= "valores3">			 			
		     	   ...
		     	   <td class="separador"></td> 
		     		...
		     		<td> 
		         	 <form:input id="estatus" name="estatus" path="estatus" size="20" tabindex="18"
		         	 		readOnly="true" disabled = "true" style="text-align: right" />  
		     		</td>
		 		...
		 		<tr id= "valores4">   
		     		...
		     		<td>
		         	 <form:input id="numeroCreditos" name="numeroCreditos" path="numeroCreditos" size="20" 
		         	 		tabindex="17" readOnly="true" disabled = "true" style="text-align: right" />  
		     		</td> 
				...
				<tr>
					<td colspan="5">
						<table align="right"> 
							<tr>
								<td align="right">
									<input type="submit" id="agrega" name="agrega" class="submit" value="Agregar" tabindex="18"/>
