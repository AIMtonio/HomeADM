...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="js/credito/creditoAutoriza.js"></script>
...
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="creditos">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">
		...
		<tr id="capacidadDescuento">
		    <td class="label"> 
		        <label for="lblCapacidadPago">Capacidad de descuento: </label> 
		    </td> 
		    <td> 
		        <form:input id="capacidadPago" name="capacidadPago" path="capacidadPago" size="11"  esMoneda="true" readOnly = "true" disabled="true"
		...
		<tr>
		   ...
		   <td>
			 	<form:input type="text" id="fechaVencimien" name="fechaVencimien" path="fechaVencimien" size="18" tabindex="12" disabled="true"/>
			</td>
		 </tr>
		 <tr>
			<td class="label">
		...
		<br>
		 <input type="hidden" id="datosGridDocEnt" name="datosGridDocEnt" size="100" />
				...
				<table >
					<tr>
						...
						<td>
		     			...
		     			<td>
		      				<form:textarea  id="comentarioCond" name="comentarioCond" path="comentarioCond" tabindex="18" COLS="50" ROWS="4" onBlur=" ponerMayusculas(this);" disabled="false" maxlength="500"  />
		     			</td>
			...
			<table align="right">
				<tr>
					<td align="right">
						<input type="submit" id="condicionar" name="condicionar" class="submit" value="Condicionar" tabindex="5"  />
