...
<script type="text/javascript" src="js/originacion/solicitudesCreARep.js"></script>
</head>
<body>
	<div id="contenedorForma">
		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="solicitudesCreAsigBean" target="_blank">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Asignaci&oacute;n de Solicitudes a Analistas </legend>
