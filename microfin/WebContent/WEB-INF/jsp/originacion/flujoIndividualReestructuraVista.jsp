...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/esquemaOtrosAccesoriosServicio.js"></script>
 		...
 		<script type="text/javascript" src="js/originacion/flujoIndividualReestructura.js"></script>
...
<input type="hidden" id="clienteSocio" value="<s:message code="safilocale.cliente"/>" />
	...
	<div id="tabs"> 
		<ul> 
			...
			<li ><a id="obligado" href="#contObligados">Obligados Solidarios <br> <br></a></li> 
			<li ><a id="asigAval" href="#asignaAval">Asignación <br>Aval</a></li> 
			<li ><a id="asigObligado" href="#asignaObligados">Asignación <br>Obligado Solidario</a></li>  
			<li ><a id="garan" href="#garantias" >Garantías <br> <br></a></li> 
			<li ><a id="asigGaran" href="#asignaGarantias" >Asigna <br>Garantías</a></li>  
			<li ><a id="calculaRatios" href="#ratios">Ratios <br> <br></a></li>
			...
			<li ><a id="instruccionesDispersion" href="#instrucciones">Instrucciones<br>de Dispersi&oacute;n<br></a></li>
		</ul> 
		
	 	<div id="solicitud"></div>
		<div id="checklist"></div>
		<div id="contAvales"></div>
		<div id="contObligados"></div>
		<div id="asignaAval"></div>
		<div id="asignaObligados"></div>
		...
		<div id="_selecciona"> 
			<form:form id="formaMenu" name="formaMenu" method="POST" commandName="solicitudCredito">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Flujo Individual Reestructuras</legend>
								...
								<table align="left">
									...
									<tr>
										...
										<td >
											...
											<input type="hidden" id="valorReestructura" name="valorReestructura" value=""/>
