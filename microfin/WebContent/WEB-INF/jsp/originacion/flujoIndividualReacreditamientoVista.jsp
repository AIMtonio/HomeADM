...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/esquemaOtrosAccesoriosServicio.js"></script>
 		...
 		<script type="text/javascript" src="js/originacion/flujoIndividualReacreditamiento.js"></script>
...
<input type="hidden" id="clienteSocio" value="<s:message code="safilocale.cliente"/>" />
	...
	<div id="tabs"> 
		...
		<div id="_selecciona"> 
			<form:form id="formaMenu" name="formaMenu" method="POST" commandName="solicitudCreditoReacreditamiento">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Flujo Individual Reacreditaci&oacute;n</legend>
