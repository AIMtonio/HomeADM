...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td>
			<table id="tbParametrizacion" border="0" width="230px">
				<tr>
					<td class="label"><label>Frecuencia</label></td>
					<td class="label"><label>D&iacute;as</label></td>
					<td nowrap="nowrap"></td>
				</tr>
				...
				<tr id="tr${status.count}">
					...
					<td>
						<input type="text" id="dias${status.count}" tabindex="<%=counter %>" name="dias" size="5" value="${detalle.dias}" onchange="validarDias(this.id,${status.count})" maxlength="11"/>
					</td>
					<td nowrap="nowrap">
