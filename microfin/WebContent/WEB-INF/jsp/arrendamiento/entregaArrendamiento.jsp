...
<html>
	<head>
		...
		<script type="text/javascript" src="js/arrendamiento/entregaArrendamiento.js"></script>
	</head>
	...
	<body>
		...
		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="arrendamientosBean">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Entrega Arrendamiento</legend>
				...
				<table align="right">
					<tr>
						<td align="right">
							<input type="submit" id="entregar" name="entregar" class="submit" value="Entregar" tabindex="2" />
							<input type="hidden" id="tipoTransaccion" name="tipoTransaccion" value="5"/>
						</td>
					</tr>
				</table>
			</fieldset>
