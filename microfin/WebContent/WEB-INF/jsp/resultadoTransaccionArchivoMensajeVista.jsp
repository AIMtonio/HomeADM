...
<script type="text/javascript">
	...
	function devolverMensajeArchivo() {
		...
		datos = lote.split('|');
		opener.document.forms["formaGenerica"].loteDebitoID.value=datos[0];
		opener.document.forms["formaGenerica"].regCorrectos.value=datos[1];
		opener.document.forms["formaGenerica"].regIncorrectos.value=datos[2];
		opener.document.forms["formaGenerica"].ruta.value=datos[3];	
		window.opener.deshabilitaProcesar()
