		...
		<table id="miTabla" border="0" >
			<c:choose>
				...
				<tbody>	
					...
					<c:forEach items="${listaResultado}" var="tipoRespuestaLis" varStatus="status">
					<tr id="renglons${status.count}" name="renglons">
						<td>
							...
							<input type="text" id="respuestaID${status.count}" name="lisRespuestaID" size="4" value="${tipoRespuestaLis.respuestaID}" readOnly="true"  style="height:100%" />							
						</td>				
						<td>
							<input type="hidden" id="descriResp${status.count}" name="descriResp" value="${tipoRespuestaLis.descripcion}" />
						...
						<td>
							<input type="hidden" id="estatusSelec${status.count}" name="estatusSelec" size="3" value="${tipoRespuestaLis.estatus	}"  />  																	
