...
<html>
	<head>
	   ...
	   <script type="text/javascript" src="js/cobranza/repLiberaCartera.js"></script>
	</head>
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="asignaCarteraBean"> 
<fieldset class="ui-widget ui-widget-content ui-corner-all">                
<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Liberaci&oacute;n de Cartera</legend> 
<table>
	<tr>
		<td>
			<fieldset class="ui-widget ui-widget-content ui-corner-all" >
