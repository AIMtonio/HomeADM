...
<html>
	<head>
        ...
        <script type="text/javascript" src="js/bancaMovil/pantallasPorPerfil.js"></script>                   
	</head>
<body>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
     ...
     <td>
			<form:input type="text" id="rolID" name="rolID" path="rolID" size="10" tabindex="1" iniforma="false" /> 
			<input type="text" id="descripcion" name="descripcion" tabindex="3" size="50"/>
     </td> 
		<td class="separador"></td>
		<td align="right">
						<input type="submit" tabindex="80" id="grabar" name="grabar" class="submit" value="Grabar"/>
...
<td>  <input class="check" type="checkbox" id="selecTodas" tabindex="2" value="0" name="selecTodas" />
							</td>
</tr>
</table> 
