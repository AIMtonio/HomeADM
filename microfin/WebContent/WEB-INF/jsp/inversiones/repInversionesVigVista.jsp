...
<head>
	...
	<script type="text/javascript" src="js/inversiones/repInversionesVig.js"></script>
</head>
<body>
...
<div id="contenedorForma">
	...
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Inversiones Vigentes</legend>
	
		<form id="formaGenerica" name="formaGenerica" method="POST" commandName="inversionesVig" target="_blank">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>								
					...
					<a id="ligaImp" href="InversionesVi.htm" target="_blank" >
