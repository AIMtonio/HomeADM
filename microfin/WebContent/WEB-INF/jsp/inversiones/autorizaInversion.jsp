...
<head>
	...
	<script type="text/javascript" src="js/inversiones/autorizaInversion.js"></script>
...
<body>
	...
	<legend class="ui-widget ui-widget-header ui-corner-all">Autorizaci&oacute;n de Inversiones</legend>
		...
		<legend >Datos Generales</legend>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td>
						<label>Inversi&oacute;n:</label></td>
					<td>
				...
				<tr>
					<td>
						<label>No. <s:message code="safilocale.cliente"/>:</label></td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" id="nombreCuenta" name="nombreCuenta"/>
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<form:input id="tipoInversionID" name="tipoInversionID" path="tipoInversionID" size="7" autocomplete="off" readonly="true" />
						<input type="text" id="descripcion" name="descripcion" size="23" readonly="true"  />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
						<label>Etiqueta:</label>
						<form:input id="etiqueta" name="etiqueta" path="etiqueta" size="48" autocomplete="off" readonly="true"  />
				</tr>
				<tr>
					<td colspan='4' >&nbsp;</td>
				</tr>
					...
					<td colspan="4">
						...
						<table border="0">
							<tr>
								...
								<td>
									<form:input type="text" name="tasa" id="tasa" path="tasa" size="12" style="text-align: right;"
								...
								<td>
									<form:input name="interesGenerado" id="interesGenerado" path="interesGenerado" style="text-align: right;"
							...
							<tr>
								...
								<td>
									<form:input name="plazo" id="plazo" path="plazo" size="18" readonly="true"  style="text-align: right;"/>
								</td>
								<td>
								...
								<td>&nbsp;&nbsp;</td>
								<td>
									<label>Inter&eacute;s Retener</label>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<form:input type="text" name="tasaNeta" id="tasaNeta" path="tasaNeta" style="text-align: right;"
								...
								<td>
									<form:input name="interesRecibir" id="interesRecibir" path="interesRecibir" style="text-align: right;"
												size="18" readonly="true"  esMoneda="true"/>
								</td>
							</tr>
							<tr>
					...
					<tr>
						...
						<td colspan="4">
							<table align="right" boder='0'>
								<tr>
									<td align="right">
										<input type="submit" id="autoriza" name="autoriza"
												 class="submit"  value="Autoriza" tabIndex="2" />
										<a id="enlace" href="pagareInversionRep.htm" target="_blank">
										<button type="button" class="submit" id="imprime" name="imprime" tabIndex="3" >
									 		Imp.Pagaré
										</button>
										</a>
