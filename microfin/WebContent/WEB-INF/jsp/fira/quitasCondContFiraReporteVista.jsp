...
<html>
	<head>
     ...
     <script type="text/javascript" src="js/fira/repQuitasCondonacionesCont.js"></script>  
...
<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Quitas y Condonaciones 	Contingentes Agro</legend>
