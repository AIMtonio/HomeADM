...
<html>
	<head>	
	   ...
	   <script type="text/javascript" src="dwr/interface/garantiaAgroServicioScript.js"></script>
	   ...
	   <script type="text/javascript" src="js/fira/RegistroGarantiasAgro.js"></script>
	</head>
<body>
				...
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
		   		<legend>Tipo Garant&iacute;a</legend>
					<table border="0">	
						...
						<tr>
							<td class="label"> 
								<label for="usufructuaria">Usufructuaria: </label> 
							</td>
							<td>
								<label for="usufructuaria">Si </label>
								<input type="radio" id="usuafructuariaSi"   value="S"  name="usufructuaria" path="usufructuaria" tabindex="18" />
								<label for="usufructuaria">No </label>		
								<input type="radio" id="usuafructuariaNo" checked="true" value="N"  name="usufructuaria" path="usufructuaria" tabindex="19"/>
							</td>	
							<td class="separador"></td>
						</tr>
					</table>
					...
					<table>
						...
						<tr> 
			 			...
			 			<tr>
				     		...
				     		<td class="separador"></td> 
				     		<td class="label" nowrap="nowrap"> 
			         			<label for="proporcion">Proporci&oacute;n: </label> 
			     			</td>
			     			<td> 
				         		<form:input id="proporcion" name="proporcion" path="proporcion"  size="14" tabindex="75" maxlength="11"  autocomplete="off"/> 
				     		</td> 
		      			...
		      			<tr id="trEstatusGrabado"> 
							...
							<td>
								<input id="fechagravemen"   name="fechagravemen" path="fechagravemen" esCalendario="true" size="11" tabindex="77"  maxlength="10" autocomplete="off"/> 
							</td>
							<td class="separador"></td> 
							<td class="label">
							...
							<td>
								<input   id="montoGravemen" name="montoGravemen" value="0" esMoneda="true" path="montoGravemen" size="11" tabindex="77" autocomplete="off" />
							</td>
						</tr>          	
