...
<html>
	...
	<head>	
	    ...
	    <script type="text/javascript" src="js/fira/autorizaSolicitudGrupo.js"></script>   
	</head>
		...
		<legend class="ui-widget ui-widget-header ui-corner-all">Autorizaci&oacute;n de Solicitud Grupal</legend>
			...
			<table width="100%">
				<tr>
				    ...
				    <td>
				      <form:input type="text"  id="grupoID" name="grupoID" path="grupoID" size="10" tabindex="1" maxlength ="10" autocomplete="off"/>  
				   ...
				   <td nowrap="nowrap"> 
		         	<input type="text" id="descripProducto" name="descripProducto" size="50" type="text" 
		         		readOnly="true" />
		     		</td>	
		 		</tr>  
		 		<tr> 
		     		...
		     		<td> 
		         		 <form:input type="text"  id="ciclo" name="ciclo" path="ciclo" size="10"  readOnly = "true"/>  
		     		</td>
		     		<td class="separador"></td> 
		     		<td class="label"> 
		     		...
		     		<td> 
		         		 <form:input type="text" id="fechaAutoriza" name="fechaAutoriza" path="fechaAutoriza" size="12" 
		         		 readOnly="true"   />  
