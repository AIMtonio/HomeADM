...
<title>Adjuntar Archivo Monitoreo FIRA</title>
</head>
<body>
	<c:set var="varFecha" value="<%= request.getParameter(\"fecha\") %>" />
	<c:set var="varArchivo" value="<%= request.getParameter(\"archivo\") %>" />
	<div id="contenedorForma">
		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="CatReportesFIRABean" enctype="multipart/form-data">
