...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/opRolServicio.js"></script> 	
 		<script type="text/javascript" src="js/fira/flujoIndividualRenovacionFira.js"></script>
		...
		<div id="_selecciona"> 
			<form:form id="formaMenu" name="formaMenu" method="POST" commandName="solicitudCredito">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Flujo Individual Renovaciones Agro</legend>
							...
							<td>
								<table border="0"  width="100%">
									<tr>
										...
										<td >
											<input type="text"  id="numSolicitud" name="numSolicitud"  size="15" tabindex="1" maxlength="10" autofocus  />
										</td>
