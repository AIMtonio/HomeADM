...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="js/fira/simuladorPagosLibres.js"></script>
      	<script type="text/javascript" src="js/fira/solicitudCreditoReestAgro.js"></script>
		...
		<fieldset class="ui-widget ui-widget-content ui-corner-all">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td class="label">
			        	<label for="creditoID">Cr&eacute;dito a Reestructurar: </label>
			     	</td>
			     	<td>
				...
				<tr>
					<td>
			     	...
			     	<td nowrap="nowrap">
			        	<form:input type="text" id="clienteID" name="clienteID" path="clienteID" tabindex="3" size="12"/>
			    ...
			    <tr>
			    	<td class="label">
			     	...
			     	<td>
			        	<form:input type="text" id="promotorID" name="promotorID" path="promotorID" size="12" tabindex="4" />
				...
				<tr id="trNomina">
					...
					<td id="institNominaID">
						<form:input type="text" id="institucionNominaID" name="institucionNominaID"  path="institucionNominaID" size="12" tabindex="5"/>
					...
					<td id="folioCtrlCaja" >
						<form:input type="text" id="folioCtrl" name="folioCtrl"  path="folioCtrl" size="20" maxlength="20" tabindex="6"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<form:input type="text" id="horarioVeri" name="horarioVeri" path="horarioVeri" maxlength="20" size="12" tabindex="7"/>
					</td>
					<td class="separador"></td>
					<td>
					...
					<td>
						<input type="text" id="tipoSolCredito" name="tipoSolCredito" size="20" value="REESTRUCTURA" iniForma="false"/>
						<input type="hidden" id="tipoCredito" name="tipoCredito" value="R" iniForma="false"/>
					</td>
				</tr>
				<tr>
					<td class="label">
			 	...
			 	<table table border="0" cellpadding="0" cellspacing="0" width="100%">
			     	...
			     	<tr>
			     		<td class="label">
			   			...
			   			<td>
				 			<input type="text" id="factorMora" name="factorMora" size="15"  esMoneda="true" tabindex="102"/>
				...
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					...
					<table>
						<tr>
							...
							<td nowrap="nowrap">
								<form:input type="text" id="lineaCreditoID" name="lineaCreditoID" path="lineaCreditoID" size="15" tabindex="103" numMax ="12" />
							...
							<td nowrap="nowrap">
								<input type="text" id="saldoDisponible" name="saldoDisponible" size="15" tabindex="104" esMoneda="true" style="text-align: right" onkeypress="return ingresaSoloNumeros(event,2,this.id);" />
							</td>
						</tr>
						<tr>
							<td class="label">
							...
							<td nowrap="nowrap">
								<form:select id="manejaComAdmon" name="manejaComAdmon" path="manejaComAdmon" tabindex="105">
									<form:option value="">SELECCIONAR</form:option>
							...
							<td nowrap="nowrap">
								<form:input type="checkbox" id="comAdmonLinPrevLiq" name="comAdmonLinPrevLiq" path="comAdmonLinPrevLiq" tabindex="106"/>
							</td>
						</tr>
						<tr id ="cobroComAdmon">
							<td class="label">
							...
							<td>
								<form:select id="forPagComAdmon" name="forPagComAdmon" path="forPagComAdmon" tabindex="107">
									<form:option value="">SELECCIONAR</form:option>
							...
							<td>
								<input type="text" id="montoPagComAdmon" name="montoPagComAdmon" path="montoPagComAdmon" size="15" tabindex="107" esMoneda="true" style="text-align: right" onkeypress="return ingresaSoloNumeros(event,2,this.id);"/>
								...
								<form:input type="hidden" id="porcentajeComAdmon" name="porcentajeComAdmon" path="porcentajeComAdmon" size="15" tabindex="108" esMoneda="true" style="text-align: right" onkeypress="return ingresaSoloNumeros(event,2,this.id);"/>
							</td>
						</tr>
						<tr>
							<td class="label">
							...
							<td nowrap="nowrap">
								<form:select id="manejaComGarantia" name="manejaComGarantia" path="manejaComGarantia" tabindex="109">
									<form:option value="">SELECCIONAR</form:option>
									<form:option value="S">SI</form:option>
									<form:option value="N">NO</form:option>
								</form:select>
							...
							<td nowrap="nowrap">
								<form:input type="checkbox" id="comGarLinPrevLiq" name="comGarLinPrevLiq" path="comGarLinPrevLiq" tabindex="110"/>
							</td>
						</tr>
						<tr id ="cobroComGarantia">
							...
							<td>
								<form:select id="forPagComGarantia" name="forPagComGarantia" path="forPagComGarantia" tabindex="111">
									<form:option value="">SELECCIONAR</form:option>
							...
							<td>
								<input type="text" id="montoComGarantia" name="montoComGarantia" path="montoComGarantia" size="15" tabindex="112" esMoneda="true" style="text-align: right" onkeypress="return ingresaSoloNumeros(event,2,this.id);"/>
								...
								<form:input type="hidden" id="porcentajeComGarantia" name="porcentajeComGarantia" path="porcentajeComGarantia" size="15" tabindex="113" esMoneda="true" style="text-align: right" onkeypress="return ingresaSoloNumeros(event,2,this.id);"/>
							</td>
						</tr>
					</table>
				</fieldset>
			...
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td >
							<input type="text" id="tasaFija" name="tasaFija" size="8"  tabindex="114"  style="text-align: right;"/>
				...
				<table border="0" cellpadding="0" cellspacing="0"   width="100%">
					...
					<tr>
						<td class="label" colspan="1">
							...
							<form:input type="hidden" id="calendIrregular" name="calendIrregular" path="calendIrregular"   value="N" tabindex="403"/>
					...
					<tr>
						...
						<td>
					    	<select  id="tipoPagoCapital" name="tipoPagoCapital" tabindex="404" >
				...
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<table border="0" width="100%">
						...
						<tr>
							...
							<td>
					        	<select  id="frecuenciaInt" name="frecuenciaInt" tabindex="405" >
							    	<option value="">SELECCIONAR</option>
								</select>
						 	</td>
							<td class="separador"></td>
							...
							<td>
					        	<select  id="frecuenciaCap" name="frecuenciaCap" tabindex="406" >
							    	<option value="">SELECCIONAR</option>
								</select>
						 	</td>
						</tr>
						<tr>
							<td class="label">
			  				...
			  				<td>
				 				<form:input  type="text"  id="periodicidadInt" name="periodicidadInt" path="periodicidadInt" size="10"  tabindex="407" />
							</td>
							<td class="separador"></td>
							<td class="label">
			   				...
			   				<td>
				 				<form:input type="text" id="periodicidadCap" name="periodicidadCap" path="periodicidadCap" size="10"  tabindex="408" />
							</td>
						</tr>
						<tr>
							<td class="label">
							...
							<td nowrap="nowrap">
								<input type="radio" id="diaPagoInteres1" name="diaPagoInteres1" value="F" tabindex="409"/>
								<label for="diaPagoInteres1">&Uacute;ltimo día del mes</label>
								<input type="radio"  id="diaPagoInteres2" name="diaPagoInteres1" value="A" tabindex="410"/>
							...
							<td class="label">
						 	...
						 	<td nowrap="nowrap">
								<input type="radio" id="diaPagoCapital1" name="diaPagoCapital1" value="F" tabindex="411"/>
								<label for="diaPagoCapital2">&Uacute;ltimo día del mes</label>&nbsp;
								<input type="radio" id="diaPagoCapital2" name="diaPagoCapital1" value="A" tabindex="412"/>
						...
						<tr>
							<td class="label">
				 			...
				 			<td>
				 				<form:input  type="text" id="diaMesInteres" name="diaMesInteres" path="diaMesInteres" size="10" tabindex="413" />
							</td>
							<td class="separador"></td>
							<td class="label">
				 			...
				 			<td>
				 				<form:input  type="text" id="diaMesCapital" name="diaMesCapital" path="diaMesCapital" size="10" tabindex="414"/>
							</td>
						</tr>
						<tr>
							<td class="label">
							...
							<td >
								<form:input  type="text"  id="numAmortInteres" name="numAmortInteres" path="numAmortInteres" size="10" tabindex="415"/>
							</td>
							<td class="separador"></td>
							<td class="label">
							...
							<td >
								<form:input  type="text"  id="numAmortizacion" name="numAmortizacion" path="numAmortizacion" size="8" tabindex="416"/>
						...
						<tr>
							...
							<td>
								<input type="text" id="CAT" name="CAT" size="10" esMoneda="true" style="text-align: right;"/>
						...
						<tr>
							<td colspan="5" align="right">
								<input type="button" id="simular" name="simular" class="submit" value="Simular" tabindex="417" />
							</td>
						</tr>
					</table>
				</fieldset>
						...
						<div id="comentarios" style="display: none;">
							<fieldset class="ui-widget ui-widget-content ui-corner-all" >
								...
								<table border="0" cellpadding="0" cellspacing="0" >
									<tr>
										<td>
									    	<textarea  id="comentario" name="comentario" tabindex="418" COLS="60" ROWS="4" onBlur=" ponerMayusculas(this);"></textarea>
									  	</td>
									</tr>
								</table>
							</fieldset>
			...
			<br>
			<div class="separador" id="seccionFira">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<legend>Datos Fondeo</legend>
					<table border="0" width="100%">
						<tr class="mostrarAcredFIRA" style="display: none">
							...
							<td class="mostrarAcred" style="display: none">
								<input type="text" id="acreditadoIDFIRA" name="acreditadoIDFIRA" size="18" maxlength="20" tabindex="419"/>
							</td>
							...
							<td class="mostrarCred" style="display: none">
								<input type="text" id="creditoIDFIRA" name="creditoIDFIRA" size="18" maxlength="20" tabindex="420"/>
							</td>
						</tr>
					</table>
				</fieldset>
