...
<html>
	<head>	
		...
		<script type="text/javascript" src="js/fira/clidatsocioe.js"></script> 
        <script type="text/javascript" src="js/fira/socDemograficos.js"></script>
 		<script type="text/javascript" src="js/fira/datSosConyugue.js"></script> 
 		<script type="text/javascript" src="js/fira/datSocVivienda.js"></script>
