				...
				<c:when test="${mensaje.numero == '0'}">
					<c:forEach items="${listaResultado}" var="amortizacion" varStatus="status">
						<tr id="tramor${status.count}">
							...
							<td align="center" nowrap="nowrap">
								<input type="button" id="eliminarAmor" name="eliminarAmor" class="btnElimina" disabled="disabled" tabindex="<%=numTab++%>" onclick="eliminarAmortizacion('tramor${status.count}');">
