...
<script type="text/javascript">
	function devolverRutaArchivo() {
		opener.document.forms["formaGenerica"].rutaFinal.value = document.forms["formaOculta"].rutaArchivoFinal.value;
		opener.document.forms["formaGenerica"].rutaArchivo.value = document.forms["formaOculta"].rutaArchivoFinal.value;
