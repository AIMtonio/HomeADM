...
<html>
	...
	<head>	
		...
		<script type="text/javascript" src="js/cliente/reporteLocalidadesMarginadas.js"></script> 
		 		     
	</head>
   
<body>
<div id="contenedorForma">													  
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="reporteLocalidadesMarginadasBean">

<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Localidades Marginadas</legend>	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<td colspan="4">
					<table align="right" border='0'>
						<tr>
							<td align="right">
								<a id="ligaGenerar" href="reporteLocMarginadas.htm" target="_blank" >	 
