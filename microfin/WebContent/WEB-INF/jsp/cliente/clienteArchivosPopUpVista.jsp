...
<head> 
    ...
    <script type="text/javascript" src="js/cliente/clienteArchivosPopUpVista.js"></script>
    <title>Digitalizar Archivos del <s:message code="safilocale.cliente"/></title>
</head>
...
<c:set var="varInstrumento" value="<%= request.getParameter(\"instrumento\") %>"/>

<div id="contenedorForma">
<form method="post" id="formaGenerica" name="formaGenerica"  enctype="multipart/form-data">
<fieldset class="ui-widget ui-widget-content ui-corner-all">		
<legend class="ui-widget ui-widget-header ui-corner-all">Digitalización de Documentos del <s:message code="safilocale.cliente"/></legend>			
<table border="0" cellpadding="0" cellspacing="0" width="650px">
	<tr>
    	<td>
     	...
     	<td><input type="hidden" id="prospectoID" name="prospectoID" size="13" tabindex="3" iniforma='false' readOnly="readonly" value="${varPro}" /></td>
     	<td><input type="hidden" id="instrumento" name="instrumento" size="13" tabindex="4" iniforma='false' readOnly="readonly" value="${varInstrumento}" /></td>
	</tr> 
   	<tr>
    	<td class="label"> 
