...
<html>
	<head>
		<script type="text/javascript" src="js/buroCredito/EnvioCinCirculo.js"></script>
	</head>
	<body>
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="EnvioCintaCirculoBean">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Env&iacute;o Informaci&oacute;n C&iacute;rculo de Cr&eacute;dito</legend>
					<br>
