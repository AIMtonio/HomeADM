...
<head>
    ...
    <script type="text/javascript" src="js/nomina/archivoAfiliacionCtaClabe.js"></script>  
    

	<title>Archivo Afiliaci&oacute;n/Bajas Cuenta Clabe</title>
</head>

<body>
	<c:set var="varTipo" value="<%= request.getParameter(\"tip\") %>"/>
	<div id="contenedorForma" style="top:0px; padding:10px; left:0px; width: 98%; height: 90%; ">
		<form:form method="POST" commandName="procAfiliaBajaCtaClabeBean" enctype="multipart/form-data" name="formaGenerica2" id="formaGenerica2">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Archivo Afiliaci&oacute;n/Bajas Cuenta Clabe</legend>
							...
							<table align="right">
								<tr>
									<td align="right">									
										...
										<input type="hidden" id="tipo" name="tipo" size="20" value="${varTipo}"/>
									</td>
								</tr>
							</table>
						</td>
