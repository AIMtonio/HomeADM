	...
	<html>	
		<head>
		   ...
		   <script type="text/javascript" src="js/contabilidad/regulatorioB2021.js"></script>	      
		</head>
		...
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatoriosContabilidadBean"> 
					...
					<legend class="ui-widget ui-widget-header ui-corner-all">Razones Financieras Relevantes por Entidad (B-2021)</legend> 
