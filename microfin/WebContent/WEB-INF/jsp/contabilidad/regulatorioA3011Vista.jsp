	...
	<html>	
		<head>
		   ...
		   <script type="text/javascript" src="js/contabilidad/regulatorioA3011.js"></script>	      
		</head>
		...
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatoriosContabilidadBean"> 
					...
					<legend class="ui-widget ui-widget-header ui-corner-all">Inclusi&oacute;n Financiera (A-3011)</legend> 
