...
<html>
	...
	<head>
	   <script type="text/javascript" src="js/contabilidad/repRegCatalogoMinimo.js"></script>
	</head>
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="repRegCatalogoMinimoBean"> 
<fieldset class="ui-widget ui-widget-content ui-corner-all">                
<legend class="ui-widget ui-widget-header ui-corner-all">Reporte Regulatorio de Cat&aacute;logo M&iacute;nimo</legend> 
	...
	<tr>
		<td class="label" colspan="2">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">                
				...
				<br>
				<input type="radio" id="csv" name="csv" value="2"><label>Csv</label>
		</td>
		 <td class="separador"></td>
		  <td class="separador"></td>	
		  <td class="separador"></td> 
