...
<head> 
	...
	<script type="text/javascript" src="js/tesoreria/repEstatusCtaSantander.js"></script>  	
				
</head>
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="repEstatusCtaSantanderBean">

<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte Estatus Cuentas Santander</legend>
			          	...
			          	<table  border="0"  width="100%">
							...
							<tr>
								...
								<td><select id="estatus" name="estatus"  tabindex="4" >
							         ...
							         <option value="J">EJECUTADO</option>
							         <option value="N">EN PROCESO</option>
							         <option value="P">PENDIENTE AUTORIZAR</option>
							         <option value="D">PENDIENTE ACTIVAR</option>
