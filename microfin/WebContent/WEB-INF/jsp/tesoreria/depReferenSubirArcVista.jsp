...
<body>
	...
	<c:set var="varTranAnt" value="<%= request.getParameter(\"tAn\") %>"/>
	<c:set var="cargaXLS" value="<%= request.getParameter(\"cargaXLS\") %>"/>
	<div id="contenedorForma">
		<form:form method="POST" commandName="depositosReferencia" enctype="multipart/form-data" name="formaGenerica2" id="formaGenerica2">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">			
					...
					<tr> 
						<td> 
					    	...
					    	<form:input type="hidden" id="numTranAnt" name="numTranAnt"  size="14" tabindex="8" value="${varTranAnt}" 
					    		path="numTranAnt" esCalendario="true"/>		
					    	<form:input type="hidden" id="cargaLayoutXLSDepRef" name="cargaLayoutXLSDepRef" value="${cargaXLS}" path="cargaLayoutXLSDepRef"/>					    	
					   	</td> 
					</tr>
					<tr>
						 <td class="label">
