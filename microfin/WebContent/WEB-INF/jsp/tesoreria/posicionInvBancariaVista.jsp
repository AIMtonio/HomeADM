...
<html>
	<head>
		...
		<script type="text/javascript" src="js/tesoreria/posicionInvBancaria.js"></script>
		<title>Posicion de Inversiones Bancarias</title>
	</head>
	<body>
 		<div id="contenedorForma">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
			<legend class="ui-widget ui-widget-header ui-corner-all">Posición de Inversiones Bancarias</legend>
					...
					<tr>
						<td colspan="4">
							<table align="right" border='0'>
								<tr>
									<td align="right">
										<a id="ligaPDF" href="RepPosicionInvBancaria.htm" target="_blank" >
