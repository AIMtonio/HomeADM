...
<html>
	<head>
		...
		<title>Carga de Archivo de Conciliación de Transacciones POS</title>
	</head>
	<body>
		...
		<div id="contenedorForma">
			<form:form method="POST" commandName="cargaConciPOS" enctype="multipart/form-data" name="formaGenerica2" id="formaGenerica2">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<legend class="ui-widget ui-widget-header ui-corner-all">Carga de Archivo de Conciliación de Transacciones POS</legend>
