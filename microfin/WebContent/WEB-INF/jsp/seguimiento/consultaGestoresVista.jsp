...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/usuarioServicio.js"></script> 
     	 ...
     	 <script type="text/javascript" src="js/seguimiento/consultaGestores.js"></script>     
	</head>
<body>
...
<fieldset class="ui-widget ui-widget-content ui-corner-all">	
	<legend class="ui-widget ui-widget-header ui-corner-all">Consulta de Gestores</legend>		
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td>
				 <input type="text" id="gestorID" name="gestorID" size="11" tabindex="1"  />
				 <input type="text" id="nombreGestor" name="nombreGestor" size="68"  readOnly="true" iniForma="false"/>	 
			</td>
		</tr>
		<tr>
			<td class="label">
				<label for="lblTipoGestorID">Tipo Gestor: </label>
			</td>
		  	<td nowrap="nowrap">
				<input type="text" id="tipoGestionID" name="tipoGestionID"  size="11" tabindex="2"/>
		...
		<tr>
			<td class="label">
		  	...
		  	<td nowrap="nowrap">
				<input type="text" id="supervisorID" name="supervisorID"  size="11" tabindex="3"/>
