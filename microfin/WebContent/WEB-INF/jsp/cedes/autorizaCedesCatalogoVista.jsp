...
<head>
	...
	<script type="text/javascript" src="js/cedes/autorizaCedes.js"></script>

<title>Autorizaci&oacute;n de CEDES</title>
</head>
<body>

	<div id="contenedorForma">
	<fieldset class="ui-widget ui-widget-content ui-corner-all" >
	<legend class="ui-widget ui-widget-header ui-corner-all">Autorizaci&oacute;n de CEDES</legend>
		...
		<legend >Datos Generales</legend>
			<table border="0" width="100%">
				...
				<tr>
					...
					<td nowrap="nowrap">
						<form:input id="tipoCedeID" name="tipoCedeID" path="tipoCedeID" size="7" autocomplete="off" readonly="true" disabled="true"  />
						...
						<legend >Condiciones</legend>
							<table border="0">
								...
								<tr>
									...
									<td>
										<form:input name="plazoOriginal" id="plazoOriginal" path="plazoOriginal" size="18" readonly="true" autocomplete="off" style="text-align: right;"  disabled="true" tabIndex="10"  />
									</td>	
