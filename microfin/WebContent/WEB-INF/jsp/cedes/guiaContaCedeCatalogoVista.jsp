...
<html>
	<head>	      
		...
		<script type="text/javascript" src="dwr/interface/plazosCedesServicio.js"></script>
		<script type="text/javascript" src="dwr/interface/monedasServicio.js"></script>   
      	<script type="text/javascript" src="dwr/interface/cuentasContablesServicio.js"></script>  
      	<script type="text/javascript" src="dwr/interface/conceptosCedeServicio.js"></script>
      	<script type="text/javascript" src="dwr/interface/cuentasMayorCedeServicio.js"></script>
		<script type="text/javascript" src="dwr/interface/subCtaTiProCedeServicio.js"></script>         
		<script type="text/javascript" src="dwr/interface/subCtaTiPerCedeServicio.js"></script>
		<script type="text/javascript" src="dwr/interface/subCtaMonedaCedeServicio.js"></script>
		<script type="text/javascript" src="dwr/interface/subCtaPlazoCedeServicio.js"></script>	
      
	   <script type="text/javascript" src="js/forma.js"></script>
	   <script type="text/javascript" src="js/cedes/guiaContaCedeCatalogo.js"></script>
	</head>
   
	<body>
		<div id="contenedorForma">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">                
				<legend class="ui-widget ui-widget-header ui-corner-all">Gu&iacute;a Contable CEDES</legend>
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="GuiaContable">  	
					...
					<legend class="ui-widget ui-widget-header ui-corner-all">Cuentas Mayor</legend>     
						<table border="0" cellpadding="0" cellspacing="0" width="100%">     
							<tr>
						  		<td class="label"> 
						       	<label for="conceptoCedeID">Concepto:</label> 
						    	</td>
						    	<td> 
						       		<select id="conceptoCedeID" name="conceptoCedeID" tabindex="1" style="text-transform:uppercase">
							...
							<tr> 
						    	<td class="label"> 
						        	<label for="nomenclatura">Nomenclatura Cuentas CEDES:</label> 
						     	</td>
						     	<td>
							...
							<tr>
								<td class="label"> 
					         		<label for="lblClaves"><b>Claves de Nomenclatura Cuentas CEDES: 	
				...
				<form:form id="formaGenerica3" name="formaGenerica3" method="POST" commandName="GuiaContable"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">     
							<tr>
						   		<td> 
						     		<input id="conceptoCedeID3" name="conceptoCedeID3"  size="13" tabindex="8" type="hidden"/> 
						     	</td> 
						   </tr> 
						   <tr>
						   		<td class="label"> 
				...
				<form:form id="formaGenerica2" name="formaGenerica2" method="POST" commandName="GuiaContable"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">     
							<tr>
					   			<td> 
					     			<input id="conceptoCedeID2" name="conceptoCedeID2"  size="13" tabindex="14" type="hidden" /> 
					     		</td> 
					   		</tr> 
							<tr>
					   			<td class="label"> 
					         		<label for="subCtaPlazoCedeID">Plazo:</label> 
					     		</td>
					     		<td> 
					         		<select id="subCtaPlazoCedeID" name="subCtaPlazoCedeID"  tabindex="15" style="text-transform:uppercase">
										<option value="-1">SELECCIONAR</option>
									</select>
					     		</td> 
					   		</tr> 
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="right">  
							<tr>
								<td align="right">
									...
									<input type="hidden" id="tipoCedeID" name="tipoCedeID" />
				...
				<form:form id="formaGenerica4" name="formaGenerica4" method="POST" commandName="GuiaContable"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">                
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">     
							<tr>
						   		<td> 
						     		<input id="conceptoCedeID4" name="conceptoCedeID4"  size="10" tabindex="20" type="hidden"/> 
								</td> 
						  	</tr> 
						  	<tr>
						  		<td class="label"> 
				...
				<form:form id="formaGenerica5" name="formaGenerica5" method="POST" commandName="GuiaContable"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">     
							<tr>
					   			<td> 
					     			<input id="conceptoCedeID5" name="conceptoCedeID5"  size="13" tabindex="27" type="hidden"/> 
					     		</td> 
							</tr> 
							<tr>
					   			<td class="label"> 
