...
<c:set var="tasaCedesLista" value="${tasasLista[2]}"/>
...
<fieldset class="ui-widget ui-widget-content ui-corner-all">
	...
	<table id="miTabla"  border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td class="label"> 
					<label for="lblCal">Calificación</label> 
		     	</td>	
	 		</tr>
	 		<c:forEach items="${tasaCedesLista}" var="tasas" varStatus="status">
	 		<tr id="renglon${status.count}" name="renglon">
	 			<td> 
					<input id="tasaCedeID${status.count}"  name="tasaCedeGridID" size="3" value="${tasas.tasaCedeID}" readOnly="true"  type="text"/> 
			  	</td> 
