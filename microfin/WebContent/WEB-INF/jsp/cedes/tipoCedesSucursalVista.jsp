...
<html>
	<head>   
		...
		<script type="text/javascript" src="js/cedes/tipoCedesSucursal.js"></script>                
	</head>
	<body> 
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="tipoCuentaSucursalBean"> 
				<fieldset class="ui-widget ui-widget-content ui-corner-all">            
					<legend class="ui-widget ui-widget-header ui-corner-all">Tipos de CEDES por Sucursal</legend>            
				   <table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td class="label"> 
						         <label for="lblcedeID">Tipo CEDES:</label> 
						     </td>
						     <td>
						         <input type="text" id="tipoCedeID" name="tipoCedeID"  size="10" tabindex="1" />  
					...
					<table align="right">
						<tr>
							<td align="right">
								...
								<input type="hidden" id="tipoInstrumentoID"  name="tipoInstrumentoID" value="28"/>	
							</td>			
