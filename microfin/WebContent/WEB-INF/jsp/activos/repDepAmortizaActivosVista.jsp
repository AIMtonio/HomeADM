...
<html>
	<head>
		<script type="text/javascript" src="dwr/interface/repDepAmortizaActivosServicio.js"></script>
		...
		<script type="text/javascript" src="js/activos/repDepAmortizaActivos.js"></script>
	</head>
	<body>
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="repDepAmortizaActivosBean">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<legend class="ui-widget ui-widget-header ui-corner-all">Depreciaci&oacute;n y Amortizaci&oacute;n de Activos</legend>
									...
									<table  border="0"  width="560px">
										<tr>
											<td class="label" nowrap="nowrap">
												<label for="fechaInicio">Fecha Inicio Depreciación: </label>
											</td>
											<td>
										...
										<tr>
											<td>
												<label for="fechaFin">Fecha Final Depreciación: </label>
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<form:select id="clasificacion" name="clasificacion" path="clasificacion" tabindex="4">
							...
							<td>
								...
								<table >
									<tr>
										<td class="label" >
											<fieldset class="ui-widget ui-widget-content ui-corner-all">
												<legend><label>Nivel de Reporte</label></legend>
												<input type="radio" id="reporteContable" name="tipoReporte" tabindex="8" value ="Contable" checked="checked" />
												<label>Contable</label>
												<br>
												<input type="radio" id="reporteFiscal" name="tipoReporte" tabindex="9" value="Fiscal" />
												<label>Fiscal</label>
												<br>
												<input type="radio" id="reporteAmbos" name="tipoReporte" tabindex="10" value="Ambos" />
												<label>Ambos</label>
											</fieldset>
										</td>
									</tr>
