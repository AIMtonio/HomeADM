...
function generarContratoRefaccionarioPMCA(creditoID, productoCreditoID,  monedaID, montoTotal, razonSocialInst,
		...
		content: [
			...
			{ // Clausula Vigesima Quinta.
				text: [
					...
					{ text: '"CONSEJO DE ADMINISTRACCIÓN".- ', bold: true },consejoAdmon[0].nombreCompleto,', ',consejoAdmon[1].nombreCompleto,', ',consejoAdmon[2].nombreCompleto,' ',aliasConsejoAdmon(consejoAdmon[0].alias, consejoAdmon[1].alias, consejoAdmon[2].alias).toUpperCase().substring(1),'.\n',
					{ text: '"ADMINISTRADOR GENERAL UNICO".- ', bold: true },consejoAdmon[3].nombreCompleto,' ',aliasCliente(consejoAdmon[3].alias).toUpperCase().substring(1),'.\n',
			...
			{ // Clausula Trigesima Tercera.
				text: [
					...
					{ text: '"CONSEJO DE ADMINISTRACCIÓN. -": \n', bold: true },
						{ text: consejoAdmon[0].nombreCompleto+' .- '+consejoAdmon[0].direccion+'\n', bold: true },
						{ text: consejoAdmon[1].nombreCompleto+' .- '+consejoAdmon[1].direccion+'\n', bold: true },
						{ text: consejoAdmon[2].nombreCompleto+' .- '+consejoAdmon[2].direccion+'\n', bold: true },
					{ text: '"CONSEJO DE ADMINISTRACCIÓN. -": \n', bold: true },
						{ text: consejoAdmon[0].nombreCompleto+' .- '+consejoAdmon[0].direccion+'\n', bold: true },
						{ text: consejoAdmon[1].nombreCompleto+' .- '+consejoAdmon[1].direccion+'\n', bold: true },
						{ text: consejoAdmon[2].nombreCompleto+' .- '+consejoAdmon[2].direccion+'\n\n', bold: true },
