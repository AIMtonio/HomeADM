...
function generarContratoAvioPM(creditoID, productoCreditoID,  monedaID, montoTotal, razonSocialInst,
	...
	// Se evalua que tipo de persona Moral es (Admin. General único | Consejo de Admon.).
	if (consejoAdmon != null){
		if(consejoAdmon[0].cargoID == contratoAdmonGenUnico){
			generarContratoAvioPMAGU(creditoID, productoCreditoID,  monedaID, montoTotal, razonSocialInst,
												RFCInst, direccionInst, telefonoInst, calcInteres, fechaEmision);
		}else {
			if(consejoAdmon[0] == undefined || consejoAdmon[1] == undefined || consejoAdmon[2] == undefined || consejoAdmon[3] == undefined){
				mensajeSis("El registro del consejo de administración está incompleto.");
			}else{
				generarContratoAvioPMCA(creditoID, productoCreditoID,  monedaID, montoTotal, razonSocialInst,
													RFCInst, direccionInst, telefonoInst, calcInteres, fechaEmision);
			}
		}
	}else{
...
function generarContratoAvioPMAGU(creditoID, productoCreditoID,  monedaID, montoTotal, razonSocialInst,
		...
		content: [
			...
			{ text: '\n\n'},
			{
				stack: [
					...
					'EN SU CARÁCTER DE ' + consejoAdmon[0].nombreCargo,
						...
						{ text: [ 'Bajo protesta de conducirse con verdad Declara ', { text: '"EL ACREDITADO"', bold: true}, ':']},
						{
							...
							ol: [
								...
								{ text: [
									...
									' que contiene la protocolización del acta de asamblea general extraordinaria donde se nombra al consejo de Administración Presidente_, Secretario_, Tesorero_ y como ',
