$(document).ready(function() {
	...
	//-- Lista de tipo de gestores-//
	$('#tipoGestionID').bind('keyup',function(e) { 
		var camposLista = new Array();
		var parametrosLista = new Array();
		camposLista[0] = "gestorID"; //DONDE MOSTRAR RESULTADO		
		parametrosLista[0] = $('#gestorID').val();//FILTROS	
		lista('tipoGestionID', '2', '3',  camposLista, parametrosLista, 'listaTipoGestion.htm');
	}); 	
...
//	});
	...
	$('#supervisorID').bind('keyup',function(e) { 
		...
		var parametrosLista = new Array();
		camposLista[0] = "gestorID"; //DONDE MOSTRAR RESULTADO
		camposLista[1] = "tipoGestionID"; 
		parametrosLista[0] = $('#gestorID').val();//FILTROS
		parametrosLista[1] = $('#tipoGestionID').val();
		lista('supervisorID', '2', '4',  camposLista, parametrosLista, 'listaTipoGestion.htm');
	}); 
