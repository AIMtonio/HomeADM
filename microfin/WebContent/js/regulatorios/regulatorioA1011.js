...
$(document).ready(function() {
   ...
   $('#formaGenerica').validate({
	   ...
	   var regulatoriobean = { 
		   ...
		   if(valida.aplica == 'S'){
			   	paramRegulatoriosServicio.consulta(tipoConsulta,regulatoriobean,function(parametros){
				   	if(parametros == null || parametros == undefined){
					    mensajeSis("La fecha de consulta no esta Registrada en el Catálogo Mínimo, Favor de Generarlo.");
				  	}else{
					   url = 'reporteRegulatorioA1011.htm?tipoReporte=' + tipoReporte + '&tipoEntidad='+tipoInstitucion+'&anio='+anio+ '&mes=' + mes;
					   window.open(url);
				   	}
	   			}); 
		   }else{
