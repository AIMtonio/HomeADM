$(document).ready(function() {	
   ...
   $('#generar').click(function() {	
	   ...
	   else if($('#csv2').is(":checked") && $('#año14').is(":checked")){ 
			generaReporteCSV2014();
		}
   ...
   /* Función para generar el reporte regulatorio por captacion Csv 2014*/
   function generaReporteCSV2014(){
		var tipoReporte = 5;
	    var tipoLista = 4;
	    var pagina='regulatorioCapt821Rep.htm?fecha='+$('#fechaReporte').val()+'&tipoReporte='+tipoReporte+'&tipoLista='+tipoLista;
	    window.location=pagina;
   ...
   /* Función para generar el reporte regulatorio por captacion Csv 2013*/
