$(document).ready(function() {
	...
	function imprimir(){
		...
		var nombreAnalista=$('#nombreCompletoC').val();
		var fechaSis = parametroBean.fechaSucursal;
		var nombreUsuario = $('#usuarioID').val(); 
		...
		if(seguir){
			var pagina ='solicitudesCreAReporte.htm?fechaInicio='+fechaIni+
			'&fechaFin='+fechaFin+
