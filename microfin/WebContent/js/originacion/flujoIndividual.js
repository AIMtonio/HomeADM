...
$(document).ready(function() {
   ...
   deshabilitaBoton('agregar', 'submit');
	...
	$('#solic').click(function() {
		...
		$("#capacidadPag").attr("href", "#capacidadPago");
	...
	$('#asigGaran').click(function() {
		...
		$("#obligado").attr("href", "#contObligados");
		$("#asigAval").attr("href" ,"#asignaAval");
		$("#asigObligado").attr("href" ,"#asigaObligados");
		$("#garan").attr("href", "#garantias");		
		$("#check").attr("href" , "#checklist");
		$("#capacidadPag").attr("href", "#capacidadPago");
		$("#calculaRatios").attr("href" , "#ratios");
...
function muestraPestanias(){
	...
	var tipoCon = 5;
	var opcionMenuID = 491;//491 es el numero de recurso en OPCIONESMENU;
	var bean = {
					...
					productosCreditoServicio.consulta(1,ProdCredBeanCon,function(prodCred) {
						if(prodCred!=null){
							if(prodCred.esGrupal == 'N'){
								...
								// Validacion del Boton rechazar
								if(ocultaBtnRechazoSol == 'S'){
...
function consultaRolesLiberaRechazaSol() {
	...
	parametrosSisServicio.consulta(24,parametrosSisCon, function(parametroSistema) {
		if (parametroSistema != null) {
			ocultaBtnRechazoSol =  parametroSistema.ocultaBtnRechazoSol;
