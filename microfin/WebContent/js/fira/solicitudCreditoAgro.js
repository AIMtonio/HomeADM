...
$(document).ready(function() {
	...
	$('#tipoGarantiaFIRAID').change(function() {
		HabilitaCamposFIRA();
	});
		...
		tiposLineasAgroServicio.consulta(consulta, tiposLineasAgro, {
			async: false, callback: function(tiposLineasAgroBean){
				if(tiposLineasAgroBean != null){
					...
					if(tipoConsulta == 2){
						if(tiposLineasAgroBean.tipoLineaAgroID > 0 && ($('#grupoID').val()== '0' || $('#grupoID').val()== '')){
...
function consultaTipoIntegrante() {
	...
	if (solicitud != '' && !isNaN(solicitud) && esTab) {
		integraGruposServicio.consulta(listaIntegrante, grupoInteGruBeanCon, { async: false, callback: function(integrantes) {
			if (integrantes != null) {
					...
					if (solicitud != null && solicitud.solicitudCreditoID != 0) {
						if(solicitud.tipoCredito=='N'){
							...
							if ($('#grupo').val() != solicitud.grupoID && $('#grupo').val() != undefined) {
								...
								montoOriginalSolicitud = solicitud.montoSolici;
								...
								if (solicitud.tipoFondeo == "P") {
									...
									deshabilitaControl('lineaFondeoID');
									deshabilitaControl('tasaPasiva');
									$('#acreditadoIDFIRA').val(solicitud.acreditadoIDFIRA);
									$('#creditoIDFIRA').val(solicitud.creditoIDFIRA);

									var tipoGaranFIRA = $('#tipoGarantiaFIRAID').val();
									if(tipoGaranFIRA == Enum_TipoGarantiaFIRA.Ninguna){
										$('#acreditadoIDFIRA').val("");
										$('#creditoIDFIRA').val("");
										mostrarElementoPorClase('mostrarAcredFIRA', false);
							...
							if ($('#grupo').val() != undefined || (solicitud.grupoID > 0 && solicitud.grupoID != "" && solicitud.grupoID != null)) {
								...
								consultaMinistraciones(solicitud.estatus);
							}

							if(solicitud.esConsolidacionAgro == 'S'){
								mensajeSis( "La Solicitud de Crédito " +solicitud.solicitudCreditoID +
											" es Consolidada.<br>Favor de consultarla en " + "<b><a onclick=\"$('#Contenedor').load('solicitudCreditoConsolidacionAgro.htm',function(response, status, xhr){" + "if(status == 'error') {$('#Contenedor').html(response);}});consultaSesion();\"> Solicitud de Crédito de Consolidación. <img src=\"images/external.png\"></a></b>");
							...
							if(solicitud.lineaCreditoID > 0){
								...
								if(manejaComAdmon == 'S'){
									...
									montoPagComAdmon = montoPagComAdmon.toFixed(2);
									if( solicitud.forPagComAdmon != 'D' ){
										montoPagComAdmon = solicitud.montoPagComAdmon;
									}
							...
							if(solicitud.esConsolidacionAgro == 'S'){
								mensajePantalla = "La Solicitud de Crédito " +solicitud.solicitudCreditoID +
												  " no es del Tipo Consolidación.<br>Favor de consultarla en " + "<b><a onclick=\"$('#Contenedor').load('flujoIndividualConsolidacion.htm',function(response, status, xhr){" + "if(status == 'error') {$('#Contenedor').html(response);}});consultaSesion();\"> Flujo Individual Solicitud de Crédito Agro. <img src=\"images/external.png\"></a></b>";
							}
			...
			callback : function(prodCred) {
				if (prodCred != null) {
					...
					if ($('#clienteID').asNumber() > 0 || prodCred.permiteAutSolPros == permiteSolicitudProspecto) {
						...
						instFond = prodCred.institutFondID;
		...
		if ($('#prospectoID').val() != '0' && $('#prospectoID').val() != '') {
			if ($('#plazoID').val() != '') {
				creditosServicio.consultaTasa(numCred, credBeanConsulta, {
					async: false, callback : function(tasas) {
						if (tasas != null) {
							if (tasas.valorTasa > 0) {
								$('#tasaFija').val(tasas.valorTasa).change();
...
function consultaComboPlazos(varPlazos) {
	...
	if (varPlazos != null) {
		...
		plazosCredServicio.listaCombo(3, {
			async: false, callback : function(plazoCreditoBean) {
				for (var i = 0; i < tamanio; i++) {
...
function consultaComboPlazosSolicitud(varPlazos, plazoValor) {
	...
	if (varPlazos != null) {
		var plazo = varPlazos.split(',');
		var tamanio = plazo.length;
		plazosCredServicio.listaCombo(3, { async: false, callback: function(plazoCreditoBean) {
			for (var i = 0; i < tamanio; i++) {
				for (var j = 0; j < plazoCreditoBean.length; j++) {
					if (plazo[i] == plazoCreditoBean[j].plazoID) {
						$('#plazoID').append(new Option(plazoCreditoBean[j].descripcion, plazo[i], true, true));
...
function consultaPromotor(idControl) {
	...
	if (numPromotor != '' && !isNaN(numPromotor) && esTab) {
		promotoresServicio.consulta(tipConForanea, promotor,{ async: false, callback: function(promotor) {
			if (promotor != null) {
...
function consultaDestinoCredito(idControl) {
	...
	if (DestCred != '' && !isNaN(DestCred) && esTab) {
		destinosCredServicio.consulta(2, DestCredBeanCon, { async: false, callback: function(destinos) {
			if (destinos != null) {
...
function consultaProspecto(idControl) {
	...
	if (numProspecto != '' && !isNaN(numProspecto) && esTab) {
		prospectosServicio.consulta(tipoConProspForanea, prospectoBeanCon,{ async: false, callback: function(prospectos) {
			if (prospectos != null) {
...
function consultaCalificacion(idControl) {
	...
	prospectosServicio.consulta(tipoConProspCal, prospectoBeanCons,{ async: false, callback: function(calificacion) {
...
function consultaInstitucionFondeo(idControl) {
	...
	if(tipoDeFondeo == Enum_TipoFondeo.Financiamiento
		&&  $("#productoCreditoID").asNumber() > 0
		&& $("#institutFondID").asNumber() == 0){
			$("#institutFondID").val(instFond);
	}
...
function consultaLineaFondeo(control) {
	...
	if (numLinea != '' && numLinea != '0' && !isNaN(numLinea) && esTab) {
		...
		lineaFonServicio.consulta(1, lineaFondBeanCon, {
			async: false, callback : function(lineaFond) {
				if (lineaFond != null) {
	...
	if (tipoDisper == 'S' && numero != '') {
		...
		if (numero.length == 18 && numero != '') {
			if (!isNaN(numero)) {
				...
				institucionesServicio.consultaInstitucion(tipoConsulta, DispersionBean,{ async: false, callback: function(data) {
					if (data == null) {
...
function consultaParentesco(idControl) {
	...
	if (numParentesco != '' && !isNaN(numParentesco)) {
		parentescosServicio.consultaParentesco(tipConPrincipal, ParentescoBean,{ async: false, callback: function(parentesco) {
			if (parentesco != null) {
...
function consultaBeneficiario(idControl) {
	...
	if (Credito != '' && !isNaN(Credito) && esTab) {
		seguroVidaServicio.consulta(catTipoConsultaSeguroVida.foranea, SeguroVidaBean,{ async: false, callback: function(seguro) {
			if (seguro != null) {
...
function consultaCadenaProductiva() {
	...
	if (cadenaProductivaID != '' && !isNaN(cadenaProductivaID) ) {
		catCadenaProductivaServicio.consulta(1, cadenaProductivaBean, {
			async: false, callback : function(cadenaBean) {
				if (cadenaBean != null) {
...
function calculosyOperacionesDosDecimalesMultiplicacion(valor1, valor2) {
	...
	calculosyOperacionesServicio.calculosYOperaciones(2, calcOperBean, {
		async: false, callback : function(valoresResultado) {
...
function validaDatosGrupales(idControl, solicitud, prospecto, cliente, productoCre, grupo) {
	...
	if (productoCre > 0) {
		...
		productosCreditoServicio.consulta(4, proCredBean, {
			async: false, callback : function(procred) {
				if (procred != null) {
					if (procred.esGrupal == 'S') {
						...
						if (grupo > 0) {
							...
							gruposCreditoServicio.consulta(conGrupo, GrupoBeanCon, {
								async: false, callback : function(grupo) {
									if (grupo != null) {
...
function consultaRelacionCliente(controlID) {
	...
	parametrosSisServicio.consulta(tipoCon, beanParametros, { async: false, callback: function(parametros) {
		if (parametros != null && parametros.validaAutComite == 'S') {
			...
			if ((parseInt(clienteID) > 0 || parseInt(prospectoID) > 0) && producCreditoID != '' && producCreditoID != '0') {
				...
				relacionClienteServicio.consulta(tipoCon, beanCliente, { async: false, callback: function(respuesta) {

					if (respuesta != null) {
						productosCreditoServicio.consulta(tipoCon, ProdCredBean, { async: false, callback: function(prodCred) {
							if (prodCred != null) {
...
function consultaTiposPago(prod, esq, varTipoPagoSeguro) {
	...
	esquemaSeguroVidaServicio.lista(esquemaSeguroBean, tipoLista,{ async: false, callback: function(esquemasSeguroVida) {
...
function HabilitaCamposFIRA(){
	var tipoGarantiaFIRA = $('#tipoGarantiaFIRAID').asNumber();

	if(tipoGarantiaFIRA ==  Enum_TipoGarantiaFIRA.Ninguna ){
		mostrarElementoPorClase('mostrarAcredFIRA', false);
		mostrarElementoPorClase('mostrarAcred', false);
		mostrarElementoPorClase('mostrarCred', false);
	}else{
