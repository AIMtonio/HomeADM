$(document).ready(function (){
	...
	$.validator.setDefaults({
		submitHandler: function(event) {
			grabaFormaTransaccionRetrollamada(event, 'formaGenerica', 'contenedorForma', 'mensaje', 'false','fechaRegistro','funcionExito','funcionError');
	...
	function subirArchivos() {
		var url ="cargaConciliaATMSubirArch.htm"+
