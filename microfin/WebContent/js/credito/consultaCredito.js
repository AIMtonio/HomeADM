...
$(document).ready(function(){
		...
		if(lineaCred != '' && !isNaN(lineaCred) && esTab){
			lineasCreditoServicio.consulta(catTipoConsultaCredito.principal,lineaCreditoBeanCon,function(linea) {
					...
					if(linea!=null){
						...
						$('#comAnualLin').val((linea.comisionAnual==null)?'0.00':linea.comisionAnual);
		...
		if(varSucurCli!=0 && pagaIVA=='S'){
			sucursalesServicio.consultaSucursal(1,varSucurCli,{
				...
				callback: function(sucursal) {
					if (sucursal!=null) {
						$('#IVAComAnualLin').val( $('#comAnualLin').asNumber() * sucursal.IVA );
	...
	$('#ExportExcel').click(function() {
		var tipoReporte 		= 3; // reporte AMORTIZACIONES en la pantalla de Informacion Creditos
		var tipoLista			= 2; //Tipo de consulta
		var tituloReporte 		= 'AMORTIZACIONES INFORMACION DE CREDITO';
		...
		var liga = 'repAmortizacionesCred.htm?'+
				...
				'&diasFaltaPago='+$('#diasFaltaPago').val()+
				'&tasaFija='+$('#tasaFija').val()+
				'&grupoID='+$('#grupoID').val()+
				'&cicloID='+$('#cicloID').val()+
				'&grupoDes='+$('#grupoDes').val()+
				'&tipoPrepagoTD='+$('#tipoPrepagoTD option:selected').val()+
				'&origen='+$('#origen').val()+
				'&cobraSeguroCuota='+$('#cobraSeguroCuota').val()+

				'&totalAde='+$('#totalAde').is(':checked')+
				'&adeudoTotal='+$('#adeudoTotal').val()+
				'&exigible='+$('#exigible').is(':checked')+
				'&pagoExigible='+$('#pagoExigible').val()+
				'&exigibleAlDia='+$('#exigibleAlDia').val()+
				'&montoProyectado='+$('#montoProyectado').val()+

				'&montoTotDeudaPC='+$('#montoTotDeudaPC').val()+
				'&montoTotExigiblePC='+$('#montoTotExigiblePC').val()+
				'&exigibleAlDiaG='+$('#exigibleAlDiaG').val()+
				'&montoProyectadoG='+$('#montoProyectadoG').val()+

				'&saldoIVAInteres='+$('#saldoIVAInteres').val()+
				'&saldoCapVigent='+$('#saldoCapVigent').val()+
				'&saldoInterOrdin='+$('#saldoInterOrdin').val()+
				'&saldoComFaltPago='+$('#saldoComFaltPago').val()+
				'&salIVAComFalPag='+$('#salIVAComFalPag').val()+
				'&saldoCapAtrasad='+$('#saldoCapAtrasad').val()+
				'&saldoInterAtras='+$('#saldoInterAtras').val()+
				'&saldoMoratorios='+$('#saldoMoratorios').val()+
				'&saldoOtrasComis='+$('#saldoOtrasComis').val()+
				'&saldoIVAComisi='+$('#saldoIVAComisi').val()+
				'&saldoCapVencido='+$('#saldoCapVencido').val()+
				'&saldoInterVenc='+$('#saldoInterVenc').val()+
				'&saldoIVAMorator='+$('#saldoIVAMorator').val()+
				'&saldoAdmonComis='+$('#saldoAdmonComis').val()+
				'&saldoIVAAdmonComisi='+$('#saldoIVAAdmonComisi').val()+
				'&saldCapVenNoExi='+$('#saldCapVenNoExi').val()+
				'&saldoInterProvi='+$('#saldoInterProvi').val()+
				'&saldoSeguroCuota='+$('#saldoSeguroCuota').val()+
				'&saldoIVASeguroCuota='+$('#saldoIVASeguroCuota').val()+
				'&totalCapital='+$('#totalCapital').val()+
				'&saldoIntNoConta='+$('#saldoIntNoConta').val()+
				'&saldoComAnual='+$('#saldoComAnual').val()+
				'&saldoComAnualIVA='+$('#saldoComAnualIVA').val()+
				'&totalComisi='+$('#totalComisi').val()+
				'&totalIVACom='+$('#totalIVACom').val()+
				'&totalInteres='+$('#totalInteres').val()+

				'&tipoReporte='+tipoReporte+
				'&tipoLista='+tipoLista+
				'&fechaSistema='+$('#fechaActual').val()+
