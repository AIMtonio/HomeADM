...
var parametroBean = consultaParametrosSession();  
	...
	$('#clienteID').bind('keyup',function(e) {
		lista('clienteID', '2', '30','nombreCompleto', $('#clienteID').val(), 'listaCliente.htm');
	});
	...
	function generaReporte() {
			...
			var sucursalCliente = $("#sucursalIDDes").val();
			...
			$('#ligaGenerar').attr('href','reporteClientesCancela.htm?fechaInicio='+fechaInicio + '&fechaFin=' + fechaFin + '&clienteID=' + cliente +'&sucursalID='+sucursal+'&fechaSistema='+fechaSis
					+'&nombreUsuario='+nombreUsuario+'&nombreCliente='+nombrecliente+'&sucursalCliente='+sucursalCliente+'&tipoReporte='+tipoReporte
		...
		if (numCliente != '' && !isNaN(numCliente) && numCliente != 0) {
			clienteServicio.consulta(conCliente, numCliente, function(cliente) {
				if (cliente != null) {
					...
					$("#sucursalID").attr('readonly', false);
