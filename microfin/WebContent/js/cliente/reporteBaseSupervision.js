$(document).ready(function(){
	...
	function generaCSV(tipoRep){	
		var tipoReporte = tipoRep;
		$('#excel').attr("checked",false);
		if($('#csv').is(':checked')){	
		$('#ligaGenerar').attr('href','reportesBaseCaptacionRep.htm?tipoReporte='+tipoReporte+
	...
	function generaExcel(){	
		...
		$('#ligaGenerar').attr('href','reportesBaseCaptacionRep.htm?tipoPresentacion='+tipoPresentacion+'&tipoLista='+tipoLista
				+'&fechaReporte='+$('#fechaReporte').val()+'&empresa='+$('#empresaID').val()
