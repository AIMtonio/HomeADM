				...
				// función para consultar las sucursales registradas para el tipo de cuenta */
				function listarSucursales(numeroLista){
						...
						if (tipoCuenta != ''  && !isNaN(tipoCuenta)){
							...
							params['instrumentoID'] =$('#tipoAportacionID').val();
							params['tipoInstrumentoID'] =$('#tasaAportacionID').val();
		...
		function agregarSucursales(numeroLista){
			...
			params['sucursalID'] = $("#sucursalID").val();
			params['estadoID'] = $("#estadoID").val();
			params['tipoInstrumentoID'] ='31';
			tipoCuentaSucursalServicioAport.lista(numeroLista,params, function(sucursales) {
			$("#contenedorForma").unblock();
