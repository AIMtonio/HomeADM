...
public class CuentasMayorInvBean {
	private String conceptoInvID; 
	...
	public String getConceptoInvID() {
		return conceptoInvID;
	}
	public void setConceptoInvID(String conceptoInvID) {
		this.conceptoInvID = conceptoInvID;
	}
