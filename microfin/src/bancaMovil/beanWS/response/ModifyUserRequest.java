...
public class ModifyUserRequest extends BaseBeanWS {
	...
	public String getFailedsLogin() {
		return failedsLogin;
	}

	public void setFailedsLogin(String failedsLogin) {
		this.failedsLogin = failedsLogin;
	}
