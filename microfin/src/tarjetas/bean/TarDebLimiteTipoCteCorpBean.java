...
public class TarDebLimiteTipoCteCorpBean extends BaseBean{
	
	private String tipoTarjetaDebID;
	private String clienteCorpID;
	private String nombreClienteCorp;
	...
	public String getNombreClienteCorp() {
		return nombreClienteCorp;
	}
	public void setNombreClienteCorp(String nombreClienteCorp) {
		this.nombreClienteCorp = nombreClienteCorp;
	}
