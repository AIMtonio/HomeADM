...
public class ReporteOperacionesVenControlador  extends AbstractCommandController{	
	...
	public ReporteOperacionesVenControlador () {
	...
	String htmlString= "";
		...
		List<RepPolizasIntersucBean> excel = reportePolizasIntersucServicio.listaReportesOperacionesVenSocios(tipoLista,reportePolIntersucBean, response);
