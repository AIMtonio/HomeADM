...
import crowdfunding.dao.TiposFondeadoresDAO;
...
public class TiposFondeadoresServicio extends BaseServicio{
	...
	public static interface Enum_Lis_TiposFondeadores{
		int principal = 1;
	}
	...
	public List<TiposFondeadoresBean> lista(int tipoLista, TiposFondeadoresBean listaBean){		
		List listaFond = null;
		switch (tipoLista) {
			case Enum_Lis_TiposFondeadores.principal:		
				listaFond=  tiposFondeadoresDAO.listaPrincipal(tipoLista, listaBean);				
				break;
		}		
		return listaFond;
	}
