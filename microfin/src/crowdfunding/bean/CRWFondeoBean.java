...
public class CRWFondeoBean {
	...
	private String diasAtraso; // para consulta de saldos y pagos de pantalla de
								// originacion (detalle inversiones)
	...
	private String saldoInteresMoratorio;
	private String capCtaOrden;
	private String intCtaOrden;
	...
	public void setSaldoInvAtrasadas1a15Resumen(
			String saldoInvAtrasadas1a15Resumen) {
	...
	public void setNumeroInvQuebrantadasResumen(
			String numeroInvQuebrantadasResumen) {
	...
	public void setSaldoInvQuebrantadasResumen(
			String saldoInvQuebrantadasResumen) {
	...
	public String getSaldoInteresMoratorio() {
		return saldoInteresMoratorio;
	}

	public void setSaldoInteresMoratorio(String saldoInteresMoratorio) {
	...
	public String getCapCtaOrden() {
		return capCtaOrden;
	}

	public void setCapCtaOrden(String capCtaOrden) {
		this.capCtaOrden = capCtaOrden;
	}

	public String getIntCtaOrden() {
		return intCtaOrden;
	}

	public void setIntCtaOrden(String intCtaOrden) {
		this.intCtaOrden = intCtaOrden;
	}
