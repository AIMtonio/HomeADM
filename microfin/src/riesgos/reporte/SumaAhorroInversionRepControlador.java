...
public class SumaAhorroInversionRepControlador extends AbstractCommandController{
	...
	public SumaAhorroInversionRepControlador (){
		...
		int tipoReporte =(request.getParameter("tipoReporte")!=null)?
			...
			switch(tipoReporte){
				case Enum_Con_TipRepor.ReporteExcel:
					reporteSumaAhorroInversion(tipoReporte,riesgosBean,response);
				break;
			}
			return null;
		}
	// Reporte de Sumas de Ahorro e Inversiones
	public List reporteSumaAhorroInversion(int tipoReporte,UACIRiesgosBean riesgosBean,  HttpServletResponse response){
		List listaRepote=null;
		String nombreArchivo = "";
		nombreArchivo = "Suma Ahorro Inversión "+riesgosBean.getFechaOperacion(); 
		listaRepote = sumaAhorroInversionServicio.listaReporteSumaAhorroInversion(tipoReporte, riesgosBean, response); 
		...
		try {
			...
			// Creacion de hoja					
			HSSFSheet hoja = libro.createSheet("Suma Ahorro Inversión");
			...
			celdaInst.setCellStyle(estiloDatosCentrado);
			  ...
			  hoja.addMergedRegion(new CellRangeAddress(//funcion para unir celdas
				...
				celdaRep.setCellValue("REPORTE SUMA AHORRO INVERSIÓN: "+riesgosBean.getFechaOperacion());
				...
				for( itera=0; itera<1; itera ++){
					...
					capitalNetoMensual	 = riesgos.getCapitalNetoMensual();
					...
					salCapitalNetoMensual 	= riesgos.getSalCapitalNetoMensual();
				...
				celdaMonto.setCellValue("Monto Máximo Captado Socio");
				...
				celdaMonto.setCellValue("Saldo Máximo Captado Socio");
				celdaMonto.setCellStyle(estilo8);
				...
				HSSFCell celdaAhoOrdinario=fila.createCell((short)8);
				...
				HSSFCell celdaAhoVista=fila.createCell((short)9);
				...
				HSSFCell celdaCtaSinMov=fila.createCell((short)10);
				celdaCtaSinMov = fila.createCell((short)1);
				celdaCtaSinMov.setCellValue("Inversiones");
				celdaCtaSinMov.setCellStyle(estilo8);
				celdaCtaSinMov = fila.createCell((short)2);
				celdaCtaSinMov.setCellValue(Double.parseDouble(depositoInversion));
				...
				celdaCtaSinMov.setCellValue(Double.parseDouble(saldDepInversion));
				celdaCtaSinMov.setCellStyle(estiloFormatoDecimal);
				
				
				fila = hoja.createRow(12);
				HSSFCell celdaCapNeto=fila.createCell((short)12);
				celdaCapNeto = fila.createCell((short)1);
				celdaCapNeto.setCellValue("Monto de Capital Neto Mensual");
				celdaCapNeto.setCellStyle(estilo8);
				celdaCapNeto = fila.createCell((short)2);
				celdaCapNeto.setCellValue(Double.parseDouble(capitalNetoMensual));
				celdaCapNeto.setCellStyle(estiloFormatoDecimal);
				celdaCapNeto = fila.createCell((short)4);
				celdaCapNeto.setCellValue("Monto de Capital Neto Mensual");
				celdaCapNeto.setCellStyle(estilo8);
				celdaCapNeto = fila.createCell((short)5);
				celdaCapNeto.setCellValue(Double.parseDouble(salCapitalNetoMensual));
				celdaCapNeto.setCellStyle(estiloFormatoDecimal);
				...
				HSSFCell celdaParamPorcentaje=fila.createCell((short)16);
				...
				HSSFCell celdaDiferencia=fila.createCell((short)18);
