...
public class CreditosPagosUnicosRepControlador extends AbstractCommandController{
	...
	public CreditosPagosUnicosRepControlador (){
		...
		int tipoReporte =(request.getParameter("tipoReporte")!=null)?
			...
			switch(tipoReporte){
				case Enum_Con_TipRepor.ReporteExcel:
					reportePagosUnico(tipoReporte,riesgosBean,response);
				break;
			}
			return null;
		}
	// Reporte de Créditos Pagos Únicos
	public List reportePagosUnico(int tipoReporte,UACIRiesgosBean riesgosBean,  HttpServletResponse response){
		List listaRepote=null;
		String nombreArchivo = "";
		nombreArchivo = "Créditos Pagos Únicos"; 
		listaRepote = creditosPagosUnicosServicio.listaReportePagoUnico(tipoReporte, riesgosBean, response); 
		...
		try {
			...
			// Creacion de hoja					
			HSSFSheet hoja = libro.createSheet("Créditos Pagos Únicos");
			...
			celdaInst.setCellStyle(estiloDatosCentrado);
			  ...
			  hoja.addMergedRegion(new CellRangeAddress(//funcion para unir celdas
				...
				celdaRep.setCellValue("REPORTE DE CRÉDITOS PAGOS ÚNICOS: "+riesgosBean.getFechaOperacion());
				...
				celdaMonto.setCellValue("Monto de Cartera Pagos Únicos");
				...
				celdaMonto.setCellValue("Saldo de Cartera Pagos Únicos");
				celdaMonto.setCellStyle(estilo8);
