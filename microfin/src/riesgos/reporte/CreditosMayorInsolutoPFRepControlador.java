...
public class CreditosMayorInsolutoPFRepControlador extends AbstractCommandController{
	...
	public CreditosMayorInsolutoPFRepControlador (){
		...
		int tipoReporte =(request.getParameter("tipoReporte")!=null)?
			...
			switch(tipoReporte){
				case Enum_Con_TipRepor.ReporteExcel:
					reporteMayorSaldoInsolutoPF(tipoReporte,riesgosBean,response);
				break;
			}
			return null;
		}
	// Reporte de Mayor Saldo Insoluto Persona Física
	public List reporteMayorSaldoInsolutoPF(int tipoReporte,UACIRiesgosBean riesgosBean,  HttpServletResponse response){
		List listaRepote=null;
		String mesEnLetras	= "";
		String anio	= "";
		String nombreArchivo = "";
		mesEnLetras = creditosMayorInsolutoPFServicio.descripcionMes(riesgosBean.getMes());
		anio = riesgosBean.getAnio();
		nombreArchivo = "Mayor Saldo Insoluto P.F. "+mesEnLetras +" "+anio;  
		listaRepote = creditosMayorInsolutoPFServicio.listaReporteMayorSaldoPF(tipoReporte, riesgosBean, response); 
		...
		try {
			...
			// Creacion de hoja					
			HSSFSheet hoja = libro.createSheet("Mayor Saldo Insoluto P.F.");
			...
			celdaInst.setCellStyle(estiloDatosCentrado);
			  ...
			  hoja.addMergedRegion(new CellRangeAddress(//funcion para unir celdas
				...
				celda.setCellValue("REPORTE MAYOR SALDO INSOLUTO P.F. "+mesEnLetras+" - "+riesgosBean.getAnio());
				...
				celdaSuma.setCellValue("Total 20 Créditos P/FÍSICAS");
				...
				celdaResultado.setCellValue("Resultado Porcentual");
