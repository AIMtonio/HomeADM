...
import credito.servicio.ReporteCarteraCNBVServicio.Enum_Con_Creditos;
import general.bean.MensajeTransaccionBean;
import general.servicio.BaseServicio;

public class ReporteCastigosQuitasCNBVServicio extends BaseServicio{	
	CreditosDAO creditosDAO=null;
 
	public ReporteCastigosQuitasCNBVServicio() {
		super();
	}
	//---------- Tipo de Consulta ----------------------------------------------------------------
	...
	public List <CreditosBean>listaReportesCreditos(int tipoLista, CreditosBean creditosBean, HttpServletResponse response){
		...
		switch(tipoLista){
			case Enum_Lis_ReportesCNBV.excel:
				listaReportes = creditosDAO.consultaCastigosQuitasCNBV(creditosBean, tipoLista);
				break;
			case Enum_Lis_ReportesCNBV.csv:
				listaReportes = generarReporteCastigosQuitas(creditosBean, Enum_Lis_ReportesCNBV.csv,  response);		
				break;		
		}
	...
	private List generarReporteCastigosQuitas(CreditosBean repDIOTBean,int tipoReporte,HttpServletResponse response){
		String nombreArchivo="";
		List listaBeans = creditosDAO.consultaCastigosQuitasCNBVCsv(repDIOTBean, tipoReporte);
		nombreArchivo="ReporteCastigosQuitasCNBV.csv";
