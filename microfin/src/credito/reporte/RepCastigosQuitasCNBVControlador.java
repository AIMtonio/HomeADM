...
public class RepCastigosQuitasCNBVControlador extends AbstractCommandController  {
	...
	String htmlString= "";
		switch(tipoReporte){
			...
			case Enum_Con_TipRepor.ReporteCSV:
				reporteCastigosQuitasCNBVServicio.listaReportesCreditos(tipoLista,creditosBean,response); 
			break;
			}
	...
	listaCreditos = reporteCastigosQuitasCNBVServicio.listaReportesCreditos(tipoLista,creditosBean,response); 	
		int regExport = 0;
			...
			// Creacion de hoja
			Sheet hoja = null;
			hoja =libro.createSheet("Reporte de Castigos y Quitas CNBV");
			...
			celda.setCellValue("REPORTE CARTERA CNBV DEL "+creditoEnc.getFechaInicioRep() + " AL " + creditoEnc.getFechaFinRep());
			...
			celda.setCellValue("Monto Castigo");
			celda.setCellStyle(estiloCentrado);	
			
			celda = fila.createCell((short)17);
			celda.setCellValue("Monto Condonacion/Quita/Descuento");
			celda.setCellStyle(estiloCentrado);	
			...
			for( iter=0; iter<tamanioLista; iter ++){
					...
					celda=fila.createCell((short)16);
					celda.setCellValue(Utileria.convierteDoble(credito.getMontoCastigo()));
					celda.setCellStyle(estiloFormatoDecimal);					
					
					celda=fila.createCell((short)17);
					celda.setCellValue(Utileria.convierteDoble(credito.getMontoCondonacion()));
					celda.setCellStyle(estiloFormatoDecimal);
			...
			//Creo la cabecera
			response.addHeader("Content-Disposition","inline; filename=ReporteCastigosQuitasCNBV.xlsx");
