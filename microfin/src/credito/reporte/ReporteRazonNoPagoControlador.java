...
public class ReporteRazonNoPagoControlador extends AbstractCommandController {
	...
	public ReporteRazonNoPagoControlador() {
	...
	protected ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
		...
		RazonesNoPagoBean razonesNoPagoBean = (RazonesNoPagoBean) command;
		...
		case Enum_Con_TipRepor.ReporteExcel:
			List<RazonesNoPagoBean> listaReportes = repRazonesNoPagoExcel(tipoLista,razonesNoPagoBean,response);
			break;
		}
	...
	// Reporte de razpnes no pago excel
		public List<RazonesNoPagoBean> repRazonesNoPagoExcel(int tipoLista, RazonesNoPagoBean razonesNoPagoBean, HttpServletResponse response) {
			...
			try {
				...
				int regExport = 0;
				listaCreditos = creditosServicio.listaReportesRazonNoPago(tipoLista,razonesNoPagoBean,response);
				...
				// Creacion de hoja
				Sheet hoja = null;
				hoja = libro.createSheet("ReporteRazonNoPago");
				...
				String fechaIni = razonesNoPagoBean.getFechaInicio();// aportacionesBean.getFechaInicio().toString();
				String fechaFin = razonesNoPagoBean.getFechaFin();// aportacionesBean.getFechaVencimiento().toString();
				
				Cell celda2 = fila.createCell((short) 1);
				celda2.setCellValue("Financiera Condfiadora");
				...
				celda3.setCellValue("RAZONES DE NO PAGO DEL " + Utileria.convertirFechaLetras(fechaIni) + " A " + Utileria.convertirFechaLetras(fechaFin));
				...
				celdaSucrsal.setCellValue(parametrosSesionBean.getSucursal());
				...
				cel.setCellValue("CLIENTE");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("CREDITO");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("VALOR DEL CRÉDITO");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("CUOTA NO PAGADA");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("FECHA TRANSACCION");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("MONTO CUOTA");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("DIAS MORATORIO");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("RAZON DE NO PAGO");
				cel.setCellStyle(estiloNeg10Izq);
				col++;
				cel= fila.createCell(col);
				cel.setCellValue("ASESOR");
				cel.setCellStyle(estiloNeg10Izq);
				...
				RazonesNoPagoBean  razonNoPagoBean = null;
				for( iter=0; iter<tamanioLista; iter ++){
					filaN++;//agregamos linea
					razonNoPagoBean = (RazonesNoPagoBean ) listaCreditos.get(iter);//Iteramos la lista
					fila=hoja.createRow(filaN);
					
					celda=fila.createCell((short)1);
					celda.setCellValue(razonNoPagoBean.getNombreCliente());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)2);
					celda.setCellValue(razonNoPagoBean.getCreditoID());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)3);
					celda.setCellValue(razonNoPagoBean.getMontoCre());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)4);
					celda.setCellValue(razonNoPagoBean.getAmortizacionID());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)5);
					celda.setCellValue(razonNoPagoBean.getFecha());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)6);
					celda.setCellValue(razonNoPagoBean.getCapital());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)7);
					celda.setCellValue(razonNoPagoBean.getDiasMora());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)8);
					celda.setCellValue(razonNoPagoBean.getRazonDescripcion());
					celda.setCellStyle(estilo10);
					
					celda=fila.createCell((short)9);
					celda.setCellValue(razonNoPagoBean.getNombrePromotor());
					celda.setCellStyle(estilo10);
				}
				...
				// Creo la cabecera
				response.addHeader("Content-Disposition", "inline; filename=ReporteRazonesNoPago.xls");
