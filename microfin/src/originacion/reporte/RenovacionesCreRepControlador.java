...
import originacion.servicio.RenovacionesCreServicio;
import reporte.ParametrosReporte;
import reporte.Reporte;

@SuppressWarnings("deprecation")
public class RenovacionesCreRepControlador extends AbstractCommandController{

	private ParametrosAuditoriaBean parametrosAuditoriaBean=null;
	RenovacionesCreServicio renovacionesCreServicio = null;	
	ParametrosSesionBean parametrosSesionBean;
	String nombreReporte = null;
	String successView = null;	
	
	public RenovacionesCreRepControlador(){
		setCommandClass(RepRenovacionesBean.class);
		setCommandName("repRenovacionesBean");
	}
	...
	protected ModelAndView handle(HttpServletRequest request,
		...
		RepRenovacionesBean repRenovacionesBean =(RepRenovacionesBean) command;
		...
		int tipoReporte =(request.getParameter("tipoReporte")!=null)?
				...
				switch(tipoReporte){
					case Enum_Con_TipRepor.ReporPDF:
						ByteArrayOutputStream htmlStringPDF = RenovacionesRepPDF(repRenovacionesBean, nombreReporte,response);
					break;
					case Enum_Con_TipRepor.ReporteExcel:
						List htmlStringExcel = RenovacionesRepExcel(repRenovacionesBean,response);
					break;
	...
	private ByteArrayOutputStream RenovacionesRepPDF( RepRenovacionesBean repRenovacionesBean, String nombreReporte,
			HttpServletResponse response) {
	...
	public ByteArrayOutputStream repRenovacionesPDF(RepRenovacionesBean repRenovacionesBean, 
	...
	public List  RenovacionesRepExcel(RepRenovacionesBean repRenovacionesBean,  HttpServletResponse response){
		List listaRenovacionesRepExcel=null;
		listaRenovacionesRepExcel = renovacionesCreServicio.listaRepRenovaciones(repRenovacionesBean); 	
		...
		int row=8;
		RepRenovacionesBean repRenovaciones;
				
		for(int iter=0; iter<tamanioLista; iter ++){					
			repRenovaciones = (RepRenovacionesBean) listaRenovacionesRepExcel.get(iter);
	...
	public RenovacionesCreServicio getRenovacionesCreServicio() {
		return renovacionesCreServicio;
	}

	public void setRenovacionesCreServicio(
			RenovacionesCreServicio renovacionesCreServicio) {
		this.renovacionesCreServicio = renovacionesCreServicio;
	}
