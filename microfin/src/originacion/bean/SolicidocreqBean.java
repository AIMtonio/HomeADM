...
public class SolicidocreqBean extends BaseBean{
	
	private String solDocReqID;
	...
	public String getSolDocReqID() {
		return solDocReqID;
	}
	public void setSolDocReqID(String solDocReqID) {
		this.solDocReqID = solDocReqID;
	}
