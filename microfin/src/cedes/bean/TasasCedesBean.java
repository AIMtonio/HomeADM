...
public class TasasCedesBean extends BaseBean {
	...
	public String getTasaCedeID() {
		return tasaCedeID;
	}
	public void setTasaCedeID(String tasaCedeID) {
		this.tasaCedeID = tasaCedeID;
	}
