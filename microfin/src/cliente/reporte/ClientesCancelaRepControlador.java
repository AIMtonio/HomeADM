...
public class ClientesCancelaRepControlador  extends AbstractCommandController{
	...
	public ClientesCancelaRepControlador () {
	...
	public ByteArrayOutputStream reportePDF(int tipoReporte,ClientesCancelaBean bean, String nomReporte, HttpServletResponse response){
		...
		try {
			htmlStringPDF = clientesCancelaServicio.reporteClientesCancela(tipoReporte,bean, nomReporte);
			response.addHeader("Content-Disposition","inline; filename=ReporteClientesCancela.pdf");
