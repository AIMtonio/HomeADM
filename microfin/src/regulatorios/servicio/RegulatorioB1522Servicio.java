		...
		if(listaRegulatorioB1522Bean != null){
			try {
				...
				//////////////////////////////////////////////////////////////////////////////
					...
					celda.setCellValue("SECCIÓN DE USUARIOS");
					celda.setCellStyle(estiloAgrupacion);
					//funcion para unir celdas
					hoja.addMergedRegion(new CellRangeAddress(
				            0, //primera fila (0-based)
					...
					celda.setCellValue("SECCIÓN DATOS DE LAS OPERACIONES MONETARIAS");
					celda.setCellStyle(estiloAgrupacion);
					//funcion para unir celdas
					hoja.addMergedRegion(new CellRangeAddress(
				            0, //primera fila (0-based)
					...
					celda=fila.createCell((short)5);
					celda.setCellValue("NÚMERO DE USUARIOS QUE OPERARON");
					celda.setCellStyle(estiloEncabezado);
