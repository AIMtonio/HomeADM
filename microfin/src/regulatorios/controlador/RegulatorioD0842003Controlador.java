...
public class RegulatorioD0842003Controlador extends SimpleFormController{
	RegulatorioD0842Servicio	regulatorioD0842Servicio=null;
	protected final Logger loggerSAFI = Logger.getLogger("SAFI");

	public RegulatorioD0842003Controlador(){
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
		...
		System.out.println("aqui 1"+tipoTransaccion);
