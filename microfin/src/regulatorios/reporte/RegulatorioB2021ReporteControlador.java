...
import regulatorios.servicio.RegulatorioB2021Servicio;
import regulatorios.servicio.RegulatorioB2021Servicio.Enum_Lis_ReportesA2111;

public class RegulatorioB2021ReporteControlador extends AbstractCommandController{
	RegulatorioB2021Servicio regulatorioB2021Servicio = null;
	String successView = null;
	
	public RegulatorioB2021ReporteControlador () {
		setCommandClass(RegulatorioB2021Bean.class);
		setCommandName("RegulatorioB2021Bean");
	}
	...
	protected ModelAndView handle(HttpServletRequest request,
		...
		RegulatorioB2021Bean reporteBean = (RegulatorioB2021Bean) command;
		int tipoReporte =(request.getParameter("tipoReporte")!=null)?
			...
			switch(tipoReporte)	{
				...
				case Enum_Lis_ReportesA2111.csv:
					regulatorioB2021Servicio.listaReporteRegulatorioB2021(tipoReporte, reporteBean, response); ;
			}
	...
	public List  reporteRegulatorioB2021(int tipoReporte,RegulatorioB2021Bean reporteBean,  HttpServletResponse response){
		List listaRepote=null;
		listaRepote = regulatorioB2021Servicio.listaReporteRegulatorioB2021(tipoReporte, reporteBean, response); 	
		...
		try {
			...
			RegulatorioB2021Bean reporteRegBean = null;
			for( iter=0; iter<tamanioLista; iter ++){				
				reporteRegBean = (RegulatorioB2021Bean) listaRepote.get(iter);
	...
	public RegulatorioB2021Servicio getRegulatorioB2021Servicio() {
		return regulatorioB2021Servicio;
	}


	public void setRegulatorioB2021Servicio(
			RegulatorioB2021Servicio regulatorioB2021Servicio) {
		this.regulatorioB2021Servicio = regulatorioB2021Servicio;
	}
