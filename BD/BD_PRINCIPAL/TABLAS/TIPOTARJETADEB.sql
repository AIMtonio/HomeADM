...
CREATE TABLE `TIPOTARJETADEB` (
  ...
  `TarBinParamsID`  INT(11)       NOT NULL COMMENT 'Identificador de la tabla TARBINPARAMS',
  `NumSubBIN`       CHAR(2)       NOT NULL COMMENT 'Número de SubBin',
  `AliasSubBIN`     VARCHAR(30)   NOT NULL COMMENT 'Alias para identificar a quien pertenede el SubBin',
  `TipoCore`        INT(11)       NOT NULL COMMENT 'Tipo de Core 1-Core Externo, 2-SAFI Externo, 3-SAFI (Copayment)',
  `UrlCore`         VARCHAR(100)   NOT NULL COMMENT 'La cadena de la url del core',
  `TipoMaquilador`  INT(11)       NOT NULL  COMMENT 'Tipo de maquilador 1-ISS, 2-TGS',
