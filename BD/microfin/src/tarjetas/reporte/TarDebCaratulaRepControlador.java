...
public class TarDebCaratulaRepControlador  extends AbstractCommandController{
	...
	public TarDebCaratulaRepControlador () {
	...
	public ByteArrayOutputStream reportePDF(int tipoReporte,TarjetaDebitoBean bean, String nomReporte, HttpServletResponse response){
		...
		try {
			htmlStringPDF = tarjetaDebitoServicio.reporteCaratulaContrato(tipoReporte,bean, nomReporte);
