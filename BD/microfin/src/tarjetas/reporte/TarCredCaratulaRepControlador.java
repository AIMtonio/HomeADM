...
public class TarCredCaratulaRepControlador  extends AbstractCommandController{
	...
	public TarCredCaratulaRepControlador () {
	...
	public ByteArrayOutputStream reportePDF(int tipoReporte,TarjetaDebitoBean bean, String nomReporte, HttpServletResponse response){
		...
		try {
			htmlStringPDF = tarjetaCreditoServicio.reporteCaratulaContrato(tipoReporte,bean, nomReporte);
			response.addHeader("Content-Disposition","inline; filename=TarDebCaratula.pdf");
