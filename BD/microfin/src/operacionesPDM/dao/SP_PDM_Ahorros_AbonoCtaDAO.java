...
public class SP_PDM_Ahorros_AbonoCtaDAO extends BaseDAO{

	public SP_PDM_Ahorros_AbonoCtaDAO(){
		super();
	}

	public SP_PDM_Ahorros_AbonoCtaResponse abonoCuentaWS(final SP_PDM_Ahorros_AbonoCtaRequest requestBean, final int tipoTransaccion) {
		SP_PDM_Ahorros_AbonoCtaResponse mensaje = new SP_PDM_Ahorros_AbonoCtaResponse();
		transaccionDAO.generaNumeroTransaccionWS();

		mensaje = (SP_PDM_Ahorros_AbonoCtaResponse) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
				SP_PDM_Ahorros_AbonoCtaResponse mensajeBean = new SP_PDM_Ahorros_AbonoCtaResponse();
				try{
					// Query con el Store Procedure
					mensajeBean = (SP_PDM_Ahorros_AbonoCtaResponse) ((JdbcTemplate) conexionOrigenDatosBean.getOrigenDatosMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(
						new CallableStatementCreator() {
							public CallableStatement createCallableStatement(Connection arg0) throws SQLException {
								String query = "call ABONOCTAPDMWSPRO(?,?,?,?,?, ?,?,?,?,?,?, ?,?,?, ?,?,?,?,?,?,?);";
								...
								sentenciaStore.setInt("Par_NumCon",tipoTransaccion);
								...
								sentenciaStore.setString("Aud_ProgramaID","operacionesPDM.WS.abonoCuentaWS");
							...
							public Object doInCallableStatement(CallableStatement callableStatement) throws SQLException,
																											DataAccessException {
								SP_PDM_Ahorros_AbonoCtaResponse mensajeTransaccion = new SP_PDM_Ahorros_AbonoCtaResponse();
					...
					if(mensajeBean ==  null){
						mensajeBean = new SP_PDM_Ahorros_AbonoCtaResponse();
					...
					e.printStackTrace();
					loggerSAFI.error(parametrosAuditoriaBean.getOrigenDatos()+"-"+"Error al Procesar el Abono a Cuenta WS", e);
