...
public class GarantiasDAO extends BaseDAO {
	public GarantiasDAO(){
		super();
	}
	...
	public MensajeTransaccionBean altaGarantia(final GarantiaBean garantiaBean) {
				...
				try {
					mensajeBean = (MensajeTransaccionBean) ((JdbcTemplate) conexionOrigenDatosBean.getOrigenDatosMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new CallableStatementCreator() {
						public CallableStatement createCallableStatement(Connection arg0) throws SQLException {
							String query = "call GARANTIASALT(" +
									"?,?,?,?,?, ?,?,?,?,?," +
									"?,?,?,?,?, ?,?,?,?,?," +
									"?,?,?,?,?, ?,?,?,?,?," +
									"?,?,?,?,?, ?,?,?,?,?," +
	...
	public MensajeTransaccionBean actualizaGarantia(final GarantiaBean garantiaBean) {
		MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
		transaccionDAO.generaNumeroTransaccion();
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
			...
			mensajeBean = (MensajeTransaccionBean) ((JdbcTemplate) conexionOrigenDatosBean.getOrigenDatosMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(
							new CallableStatementCreator() {
								public CallableStatement createCallableStatement(Connection arg0) throws SQLException {
									String query = "call GARANTIASACT(" +
											"?,?,?,?,?, ?,?,?,?,?," +
											"?,?,?,?,?, ?,?,?,?,?," +
											"?,?,?,?,?, ?,?,?,?,?," +
											"?,?,?,?,?, ?,?,?,?,?," +
	...
	// ::::::::::::::::  C O N S U L T A S  :::::::::::::::::
	public List clasificacionGarantias(int tipoLista, GarantiaBean garantiaBean){
	...
	public GarantiaBean consultaPrincipalGarantia(int tipoCon, GarantiaBean garantiaBean){
			GarantiaBean garantiaBeanRetorno = null;

		try{
				String query = "CALL GARANTIASCON(?,?,?,?,?," +
												 "?,?,?,?,?,?,? );";
				Object[] parametros = {
		...
		loggerSAFI.info(parametrosAuditoriaBean.getOrigenDatos()+"-"+"CALL GARANTIASCON(" + Arrays.toString(parametros) + ")");
		List matches= ((JdbcTemplate)conexionOrigenDatosBean.getOrigenDatosMapa().get(parametrosAuditoriaBean.getOrigenDatos())).query(query,parametros  ,new RowMapper() {
			...
			garantiaBeanRetorno = matches.size() > 0 ? (GarantiaBean) matches.get(0) : null;
	...
	//LISTA
	public List listaPrincipal( GarantiaBean garantiaBean, int tipoLista){
		...
		List matches= ((JdbcTemplate)conexionOrigenDatosBean.getOrigenDatosMapa().get(parametrosAuditoriaBean.getOrigenDatos())).query(query,parametros  ,new RowMapper() {
			public Object mapRow(ResultSet resultSet, int rowNum) throws SQLException {
				GarantiaBean garantiaBeanSalida = new GarantiaBean();
	...
	public MensajeTransaccionBean  altaAsignacionGarantia(final GarantiaBean garantiaBean) {
	MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
				...
				mensajeBean = (MensajeTransaccionBean) ((JdbcTemplate) conexionOrigenDatosBean.getOrigenDatosMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(
					new CallableStatementCreator() {
						public CallableStatement createCallableStatement(Connection arg0) throws SQLException {
								...
								sentenciaStore.setDate("Aud_FechaActual", parametrosAuditoriaBean.getFecha());
								sentenciaStore.setString("Aud_DireccionIP",parametrosAuditoriaBean.getDireccionIP());
								sentenciaStore.setString("Aud_ProgramaID", "GarantiasDAO.altaAsignacionGarantia");
								sentenciaStore.setInt("Aud_Sucursal",parametrosAuditoriaBean.getSucursal());
								sentenciaStore.setLong("Aud_NumTransaccion",parametrosAuditoriaBean.getNumeroTransaccion());
	...
	public MensajeTransaccionBean bajaAsignacionGarantia(final GarantiaBean garantiaBean) {
		MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
		transaccionDAO.generaNumeroTransaccion();
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
	...
	public MensajeTransaccionBean bajaAsignacionGarantiaReest(final GarantiaBean garantiaBean) {
		MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
		transaccionDAO.generaNumeroTransaccion();
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
	...
	public List listaGrigAsignacion( GarantiaBean garantiaBean, int tipoLista){
	...
	public List listaGarantiaReest( GarantiaBean garantiaBean, int tipoLista){
		...
		Object[] parametros = {
				...
				Constantes.FECHA_VACIA,
				Constantes.STRING_VACIO,
				"GarantiasDAO.listaGarantiaReest",
				Constantes.ENTERO_CERO,
				Constantes.ENTERO_CERO
	...
	public List listaAutorizadas( GarantiaBean garantiaBean, int tipoLista){
		List grid=null;
		try{
	...
	public GarantiaBean productoRequiereGarantia( GarantiaBean garantiaBean, int tipoLista){
	...
	public GarantiaBean estaAsignadaGarantia( GarantiaBean garantiaBean, int tipoLista){
		GarantiaBean garantiaBeanRetorno = null;
		try{
		String query = "call ASIGNAGARANTIASCON(?,?,?,?, ?,?,?,?,?,?,?);";
		Object[] parametros = {
	...
	public GarantiaBean estaAsigGarantiaASolicitud( GarantiaBean garantiaBean, int tipoLista){
	...
	public List listaCliPro(GarantiaBean garantiaBean, int tipoLista) {
		String query = "call GARANTIALIS(?,?,  ?,?,?,?,?   ,?,?,?,?,?);";
		Object[] parametros = {
				Constantes.STRING_VACIO,
				Constantes.ENTERO_CERO,
	...
	public MensajeTransaccionBean grabaListaGarantias(final  GarantiaBean garantiaBean, final List listaGarantias) {
		MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
		transaccionDAO.generaNumeroTransaccion();
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
				...
				try {
					...
					for(int i=0; i<listaGarantias.size(); i++){
						bean = (GarantiaBean)listaGarantias.get(i);
	...
	public MensajeTransaccionBean altaAsignaGarReest(final GarantiaBean garantiaBean, final List listaGarantias){
		MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
		transaccionDAO.generaNumeroTransaccion();
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
				...
				try {
					...
					for(int i=0; i<listaGarantias.size(); i++){
						GarantiaBean garantiaGridBean = (GarantiaBean)listaGarantias.get(i);
