...
public class ConsultaSaldoAhorroBEResponse {
	...
	public String getCargoMes() {
		return cargoMes;
	}
	public void setCargoMes(String cargoMes) {
	...
	public String getVar_SumPenAct() {
		return var_SumPenAct;
	}
	public void setVar_SumPenAct(String var_SumPenAct) {
		this.var_SumPenAct = var_SumPenAct;
	}
