...
public class CreditosMayor100RepControlador extends AbstractCommandController{
	...
	public CreditosMayor100RepControlador (){
		...
		int tipoReporte =(request.getParameter("tipoReporte")!=null)?
			...
			switch(tipoReporte){
				case Enum_Con_TipRepor.ReporteExcel:
					reporteCreditosMayor100mil(tipoReporte,riesgosBean,response);
				break;
			}
			return null;
		}
	// Reporte de Créditos Mayor a $ 100,000.00
	public List reporteCreditosMayor100mil(int tipoReporte,UACIRiesgosBean riesgosBean,  HttpServletResponse response){
		List listaRepote=null;
		String nombreArchivo = "";
		nombreArchivo = "Créditos Menor Cien Mil "+riesgosBean.getFechaOperacion(); 
		listaRepote = creditosMayor100Servicio.listaReporteMayor100mil(tipoReporte, riesgosBean, response); 
