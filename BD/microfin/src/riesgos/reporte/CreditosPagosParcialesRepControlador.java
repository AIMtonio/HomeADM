...
import riesgos.servicio.CreditosPagosParcialesServicio;

public class CreditosPagosParcialesRepControlador extends AbstractCommandController{
	CreditosPagosParcialesServicio creditosPagosParcialesServicio = null;
	String successView = null;
	
	public static interface Enum_Con_TipRepor {
		  int  ReporteExcel= 1;
	}
	public CreditosPagosParcialesRepControlador (){
		setCommandClass(UACIRiesgosBean.class);
		setCommandName("pagosParciales");
	}
		...
		int tipoReporte =(request.getParameter("tipoReporte")!=null)?
			...
			switch(tipoReporte){
				case Enum_Con_TipRepor.ReporteExcel:
					reportePagosParciales(tipoReporte,riesgosBean,response);
				break;
			}
			return null;
		}
	// Reporte de Créditos Pagos Parciales
	public List reportePagosParciales(int tipoReporte,UACIRiesgosBean riesgosBean,  HttpServletResponse response){
		List listaRepote=null;
		String nombreArchivo = "";
		nombreArchivo = "Créditos Pagos Parciales"; 
		listaRepote = creditosPagosParcialesServicio.listaReportePagosParciales(tipoReporte, riesgosBean, response); 
		...
		try {
			...
			// Creacion de hoja					
			HSSFSheet hoja = libro.createSheet("Créditos Pagos Parciales");
			...
			celdaInst.setCellStyle(estiloDatosCentrado);
			  ...
			  hoja.addMergedRegion(new CellRangeAddress(//funcion para unir celdas
				...
				celdaRep.setCellValue("REPORTE DE PAGOS PARCIALES: "+riesgosBean.getFechaOperacion());
				...
				celdaMonto.setCellValue("Monto de Cartera Pagos Parciales");
				...
				celdaMonto.setCellValue("Saldo de Cartera Pagos Parciales");
				celdaMonto.setCellStyle(estilo8);
	...
	public CreditosPagosParcialesServicio getCreditosPagosParcialesServicio() {
		return creditosPagosParcialesServicio;
	}
	public void setCreditosPagosParcialesServicio(
			CreditosPagosParcialesServicio creditosPagosParcialesServicio) {
		this.creditosPagosParcialesServicio = creditosPagosParcialesServicio;
	}
