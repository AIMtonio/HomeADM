...
public class ClienteArchivosAdjuntaControlador extends SimpleFormController {
    ...
    protected ModelAndView onSubmit(HttpServletRequest request,
    	...
    	if(tipoTransaccion==7){
        	...
        	loggerSAFI.debug("archivoNombre: "+archivoNombre);
        	...
        	else return new ModelAndView(getSuccessView(), "mensaje", null);
