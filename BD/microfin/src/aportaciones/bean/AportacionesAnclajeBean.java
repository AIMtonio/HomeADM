...
public class AportacionesAnclajeBean extends BaseBean {

	private String aportAnclajeID;
	private String aportacionOriID;
	private String aportacionAncID;
	...
	public String getAportAnclajeID() {
		return aportAnclajeID;
	}

	public void setAportAnclajeID(String aportAnclajeID) {
		this.aportAnclajeID = aportAnclajeID;
	}

	public String getAportacionOriID() {
		return aportacionOriID;
	}

	public void setAportacionOriID(String aportacionOriID) {
		this.aportacionOriID = aportacionOriID;
	}

	public String getAportacionAncID() {
		return aportacionAncID;
	}

	public void setAportacionAncID(String aportacionAncID) {
		this.aportacionAncID = aportacionAncID;
	}
	...
	public Double getTasaAportOri() {
		return tasaAportOri;
	}

	public void setTasaAportOri(Double tasaAportOri) {
		this.tasaAportOri = tasaAportOri;
	}
