...
import aportaciones.dao.TipoCuentaSucursalADAO;

public class TipoCuentaSucursalAServicio extends BaseServicio{
	
	private TipoCuentaSucursalAServicio(){
		super();
	}
 
	TipoCuentaSucursalADAO tipoCuentaSucursalDAO = null;
	...
	public MensajeTransaccionBean grabaTransaccion(int tipoTransaccion, TipoCuentaSucursalABean bean){
	...
	public List lista(int tipoLista, TipoCuentaSucursalABean bean){
		List lista = null;
		switch (tipoLista) {			
	...
	public List creaListaDetalle( TipoCuentaSucursalABean bean) {		
		...
		TipoCuentaSucursalABean beanAux = null;	
		
		if(sucursales != null){
			int tamanio = sucursales.size();			
			for (int i = 0; i < tamanio; i++ ) {
				
					beanAux = new TipoCuentaSucursalABean();
	...
	public ByteArrayOutputStream reporteTipoCuentaSucursal(int tipoReporte, TipoCuentaSucursalABean bean , String nomReporte) throws Exception{
	...
	/* Getter y Setter */
	public TipoCuentaSucursalADAO getTipoCuentaSucursalDAO() {
		return tipoCuentaSucursalDAO;
	}
	public void setTipoCuentaSucursalDAO(TipoCuentaSucursalADAO tipoCuentaSucursalDAO) {
