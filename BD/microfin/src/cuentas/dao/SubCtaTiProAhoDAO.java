...
public class SubCtaTiProAhoDAO extends BaseDAO {

	public SubCtaTiProAhoDAO() {
		super();
	}

	public MensajeTransaccionBean alta(final SubCtaTiProAhoBean subCtaTiProAho) {
		...
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
				...
				try {
					...
					Object[] parametros = {
							subCtaTiProAho.getConceptoAhoID(),
							parametrosAuditoriaBean.getEmpresaID(),
							subCtaTiProAho.getTipoProductoID(),
							subCtaTiProAho.getSubCuenta(),
	...
	public MensajeTransaccionBean modifica(final SubCtaTiProAhoBean subCtaTiProAho){
		MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
		transaccionDAO.generaNumeroTransaccion();
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
	...
	public MensajeTransaccionBean baja(final SubCtaTiProAhoBean subCtaTiProAho){
		MensajeTransaccionBean mensaje = new MensajeTransaccionBean();
		transaccionDAO.generaNumeroTransaccion();
		mensaje = (MensajeTransaccionBean) ((TransactionTemplate)conexionOrigenDatosBean.getManejadorTransaccionesMapa().get(parametrosAuditoriaBean.getOrigenDatos())).execute(new TransactionCallback<Object>() {
			public Object doInTransaction(TransactionStatus transaction) {
	...
	public SubCtaTiProAhoBean consultaPrincipal(SubCtaTiProAhoBean subCtaTiProAho, int tipoConsulta){
