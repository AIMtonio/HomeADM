...
public class CastigosCarteraAgroBean extends BaseBean{
	...
	private String credCastigoID;
	private String afectaGarantia;
	private String credResidualPag;
	private String credContigentePag;
	...
	public String getCredCastigoID() {
		return credCastigoID;
	}
	public void setCredCastigoID(String credCastigoID) {
		this.credCastigoID = credCastigoID;
	}
	public String getAfectaGarantia() {
		return afectaGarantia;
	}
	public void setAfectaGarantia(String afectaGarantia) {
		this.afectaGarantia = afectaGarantia;
	}
	public String getCredResidualPag() {
		return credResidualPag;
	}
	public void setCredResidualPag(String credResidualPag) {
		this.credResidualPag = credResidualPag;
	}
	public String getCredContigentePag() {
		return credContigentePag;
	}
	public void setCredContigentePag(String credContigentePag) {
		this.credContigentePag = credContigentePag;
	}	
