...
public class CreQuitasFiraBean extends BaseBean {	
	...
	private String porceNotasCargo;
	...
	public String getPorceNotasCargo() {
		return porceNotasCargo;
	}
	public void setPorceNotasCargo(String porceNotasCargo) {
		this.porceNotasCargo = porceNotasCargo;
	}
