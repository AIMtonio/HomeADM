...
public class RepPagosAnticipadosAgroControlador extends AbstractCommandController {
	...
	public RepPagosAnticipadosAgroControlador() {
		setCommandClass(CreditosBean.class);
		setCommandName("creditosAgroBean");
	}
	...
	protected ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
		...
		case Enum_Con_TipRepor.ReporteExcel:
			List<PagosAnticipadosAgroBean> listaReportes = pagosAnticiadosAgroRep(tipoLista, creditosBean, response);
			break;
		}
	...
	public List<PagosAnticipadosAgroBean> pagosAnticiadosAgroRep(int tipoLista, CreditosBean creditosBean, HttpServletResponse response) {
		List<PagosAnticipadosAgroBean> listaCreditos = null;
		try {
			...
			int regExport = 0;
			listaCreditos = creditosAgroServicio.pagosAnticipadosAgroRep(tipoLista, creditosBean, response);
			...
			// Creacion de hoja
			Sheet hoja = null;
			hoja = libro.createSheet("ReportePagosAnticipadosAgro");

			Row fila = hoja.createRow(0);

			Cell celdaini = fila.createCell((short) 1);
			celdaini = fila.createCell((short) 19);
			celdaini.setCellValue("Usuario:");
			celdaini.setCellStyle(estiloNeg10);
			celdaini = fila.createCell((short) 20);
			...
			Cell celdafin = fila.createCell((short) 19);
			celdafin.setCellValue("Fecha:");
			celdafin.setCellStyle(estiloNeg10);
			celdafin = fila.createCell((short) 20);
			...
			Cell celdaHora = fila.createCell((short) 19);
			...
			celda.setCellValue("REPORTE DE PAGOS ANTIPADOS AGRO DEL " + creditosBean.getFechaInicio() + " AL " + creditosBean.getFechaFinal());
			...
			celda = fila.createCell((short) celd++);
			celda.setCellValue("Crédito Pasivo");
			celda.setCellStyle(estiloCentrado);
			
			celda = fila.createCell((short) celd++);
			celda.setCellValue("ID Crédito Fondeo");
			celda.setCellStyle(estiloCentrado);
			...
			celda = fila.createCell((short) celd++);
			celda.setCellValue("Fecha de Pago a Fuente de Fondeo");
			celda.setCellStyle(estiloCentrado);
			
			celda = fila.createCell((short) celd++);
			celda.setCellValue("Dias al Pago de Fondeo");
			celda.setCellStyle(estiloCentrado);
			
			celda = fila.createCell((short) celd++);
			celda.setCellValue("Monto de Pago a Fondeo");
			celda.setCellStyle(estiloCentrado);
			...
			if (listaCreditos != null) {
				...
				PagosAnticipadosAgroBean credito = null;
				for (iter = 0; iter < tamanioLista; iter++) {

					credito = (PagosAnticipadosAgroBean) listaCreditos.get(iter);
					...
					celda = fila.createCell((short) celd++);
					celda.setCellValue(credito.getCreditoFondeadorID());
					celda.setCellStyle(estilo10);
					...
					celda = fila.createCell((short) celd++);
					celda.setCellValue(credito.getFechaPagoFondeo());
					celda.setCellStyle(estiloFormatoICentrado);
					
					celda = fila.createCell((short) celd++);
					celda.setCellValue(credito.getDiasPagoAplicaFond());
					celda.setCellStyle(estiloFormatoICentrado);
					
					celda = fila.createCell((short) celd++);
					celda.setCellValue(Utileria.convierteDoble(credito.getMontoPagoFondeo()));
					celda.setCellStyle(estiloFormatoDecimal);
			...
			// Creo la cabecera
			response.addHeader("Content-Disposition", "inline; filename=ReportePagosAnticipadosAgro.xlsx");
