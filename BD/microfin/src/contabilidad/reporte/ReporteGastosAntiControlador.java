...
public class ReporteGastosAntiControlador  extends AbstractCommandController{	
	...
	public ReporteGastosAntiControlador () {
	...
	String htmlString= "";
		...
		List<RepPolizasIntersucBean> excel = reportePolizasIntersucServicio.listaReportesGastosAnticipos(tipoLista,reportePolIntersucBean, response);
