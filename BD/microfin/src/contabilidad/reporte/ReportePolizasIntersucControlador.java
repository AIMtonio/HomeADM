...
public class ReportePolizasIntersucControlador  extends AbstractCommandController{	
	...
	public ReportePolizasIntersucControlador () {
	...
	String htmlString= "";
		...
		List<RepPolizasIntersucBean> excel = reportePolizasIntersucServicio.listaReportesPolizasIntersuc(tipoLista,reportePolIntersucBean, response);
