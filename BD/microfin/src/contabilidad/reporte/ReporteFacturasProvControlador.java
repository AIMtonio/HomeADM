...
public class ReporteFacturasProvControlador  extends AbstractCommandController{	
	...
	public ReporteFacturasProvControlador () {
	...
	String htmlString= "";
		...
		List<RepPolizasIntersucBean> excel = reportePolizasIntersucServicio.listaReportesFacturasProv(tipoLista,reportePolIntersucBean, response);
