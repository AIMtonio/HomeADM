...
public class CRWFondeoMovsBean extends BaseBean {
	...
	public String getTipoMovKuboID() {
		return tipoMovKuboID;
	}

	public void setTipoMovKuboID(String tipoMovKuboID) {
		this.tipoMovKuboID = tipoMovKuboID;
	}
