...
public class CuentasMayorCRWBean {

	private String conceptoCRWID;
	...
	public String getConceptoCRWID() {
		return conceptoCRWID;
	}

	public void setConceptoCRWID(String conceptoCRWID) {
		this.conceptoCRWID = conceptoCRWID;
	}
