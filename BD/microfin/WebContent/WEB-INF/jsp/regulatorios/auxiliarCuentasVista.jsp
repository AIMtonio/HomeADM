	...
	<html>	
		<head>    
		   <script type="text/javascript" src="js/regulatorios/auxiliarCuentas.js"></script>	   
		...
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="AuxiliarCuentas"> 
					...
					<legend class="ui-widget ui-widget-header ui-corner-all">Auxiliar de Cuentas</legend> 
