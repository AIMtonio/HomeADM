	...
	<html>	
		<head>
			...
			<script type="text/javascript" src="dwr/interface/regulatorioInsServicio.js"></script>
		   	...
		   	<script type="text/javascript" src="js/regulatorios/regulatorioA1011.js"></script>      
		</head>
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatorioA1011Bean"> 
					<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Reporte A-1011 Reclasificaciones en el balance general.</legend> 
