...
<html>	
	<head>
		...
		<script type="text/javascript" src="dwr/interface/divisasServicio.js"></script> 
	   	<script type="text/javascript" src="js/regulatorios/regulatorioA2111.js"></script>	      
	</head>
	...
	<body>
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatoriosCarteraBean"> 
				...
				<legend class="ui-widget ui-widget-header ui-corner-all">Requerimientos de Capital por Riesgo (A 2111)</legend> 
