...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/paramRegulatoriosServicio.js"></script>
	 	<script type="text/javascript" src="js/regulatorios/regulatorioA1316.js"></script>
	</head>
	<body>
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatorioA1316Bean"> 
				<fieldset class="ui-widget ui-widget-content ui-corner-all">                
				<legend class="ui-widget ui-widget-header ui-corner-all">Regulatorio A-1316 Estado de flujo de efectivo.</legend> 
