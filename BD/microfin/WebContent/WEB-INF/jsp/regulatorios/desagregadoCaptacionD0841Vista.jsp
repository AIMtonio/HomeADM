...
<html>
	<head>
		...
		<script type="text/javascript" src="js/regulatorios/desagregadoCaptacionD0841.js"></script>  
	</head>
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="desagreCaptaD0841Bean">

<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Desagregado de Captaci&oacute;n (D 0841)</legend>
