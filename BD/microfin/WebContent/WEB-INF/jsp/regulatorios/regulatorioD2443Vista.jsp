	...
	<html>	
		...
		<script type="text/javascript" src="dwr/interface/paramGeneralesServicio.js"></script> 
		   ...
		   <script type="text/javascript" src="js/regulatorios/regulatorioD2443.js"></script>	      
		</head>
		<body>
			<div id="contenedorForma">
				<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="regulatorioD2443Bean"> 
				
							<fieldset class="ui-widget ui-widget-content ui-corner-all">                
							<legend class="ui-widget ui-widget-header ui-corner-all">Puntos de Transacciones de Serv. Financieros (D-2443)</legend>
