...
<head>
	...
	<script type="text/javascript" src="js/seguimiento/segtoResultadosVista.js"></script>
</head>
<body>
	<div id="contenedorForma">
		<form:form id="formaGenerica" name="formaGenerica" method="POST"
			commandName="catSegtoResultados">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Catálogo
					de Resultados</legend>
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td class="label"><label for="lblResultado">Resultado:</label>
						</td>
						<td><input type="text" id="resultadoSegtoID"
							name="resultadoSegtoID" path="resultadoSegtoID" size="6"
							tabindex="1" /></td>
					</tr>
					<tr>
