...
<head>
	...
	<script type="text/javascript" src="js/tarjetas/creaImportLoteTarjSubirArch.js"></script>
	<script type="text/javascript" src="js/tarjetas/creaImportLoteTarjetas.js"></script>
	
	<title>Creación o Importación Lotes de Tarjetas</title>
</head>
...
<body>
	...
	<div id="contenedorForma">
		<form:form method="POST" commandName="bitacoraLoteDebBean" enctype="multipart/form-data" name="formaGenerica2" id="formaGenerica2">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">			
					...
					<tr>
						<td align="right" colspan="2">									
							<input type="submit" id="procesarArchivo" name="procesarArchivo" class="submit" value="Validación" tabindex="7" />
