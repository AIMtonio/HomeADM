...
<html>
	<head>
		...
		<script type="text/javascript" src="js/tarjetas/cargaConciliaATMSubirArch.js"></script>
		<script type="text/javascript" src="js/tarjetas/cargaConciliaATM.js"></script>
		<title>Carga de Archivo de Conciliación de Transacciones ATM</title>
	</head>
	<body>
		<c:set var="varFec"  value="<%= request.getParameter(\"fecha\")  %>"/>
		<div id="contenedorForma">
			<form:form method="POST" commandName="cargaConciATM" enctype="multipart/form-data" name="formaGenerica2" id="formaGenerica2">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<legend class="ui-widget ui-widget-header ui-corner-all">Carga de Archivo de Conciliación de Transacciones ATM</legend>
