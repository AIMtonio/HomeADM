...
<head>
	...
	<script type="text/javascript" src="js/credito/repCarteraCNBV.js"></script>  

</head>

<body>   
	<div id="contenedorForma">
		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="CarteraCNBV">

		<fieldset class="ui-widget ui-widget-content ui-corner-all">                
			<legend class="ui-widget ui-widget-header ui-corner-all">Cartera CNBV</legend>
						...
						<tr>
							<td class="label" style="position:absolute;top:9%;">
								<fieldset class="ui-widget ui-widget-content ui-corner-all">                
									...
									<label> Excel </label>
									<br>
									<input type="radio" id="csv" name="generaRpt" value="csv" tabindex="12" />
									<label> Csv </label>
					...
					<table align="right" border='0'>
						<tr>
							<td align="right">
								...
								<a id="ligaGenerar" href="ReporteCarteraCNBV.htm" target="_blank" >  		 
