...
<head> 
    ...
    <script type="text/javascript" src="js/credito/creditoAdjuntaArchivoCatalogoVista.js"></script>
    <title>Adjuntar Archivos del Crédito</title>
</head>

<body>
<c:set var="varCre" value="<%= request.getParameter(\"Cre\") %>"/>
<c:set var="varTd" value="<%= request.getParameter(\"td\") %>"/>

<div id="contenedorForma">
<form method="post" id="formaGenerica" name="formaGenerica" action="/microfin/creditosAdjuntaArchivo.htm" commandName="creditosArchivoBean"
...
<table border="0" cellpadding="0" cellspacing="0" width="650px">
	<tr>
    	<td>
        	<input type="hidden" id="creditoID" name="creditoID" size="13"  iniforma='false' readOnly="readonly"  value="${varCre}"/>  
      	</td> 
     	<td> 
