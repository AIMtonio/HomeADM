...
<html>
	<head>
      ...
      <script type="text/javascript" src="js/credito/lineasCreditoRep.js"></script>  
				
	</head>
      
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="lineasCredito">

<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">L&iacute;neas de Cr&eacute;dito</legend>
          ...
          <table  border="0"  width="560px">
				...
				<tr>
				   ...
				   <td> 
				      <input id="lineaCreditoID" name="lineaCreditoID"  size="12" 
				      tabindex="3" numMax ="12" />  
				   </td>
				</tr>
					<tr>
					 <td class="label"> 
