...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/oblSoliPorSoliciServicio.js"></script>
		<script type="text/javascript" src="dwr/interface/parentescosServicio.js"></script>
		<script type="text/javascript" src="js/credito/oblSolidariosPorSolici.js"></script>
...
<body>
	...
	<div id="contenedorForma">
		<fieldset class="ui-widget ui-widget-content ui-corner-all">                
			<legend class="ui-widget ui-widget-header ui-corner-all">Obligados solidarios Por Solicitud</legend>
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="oblSolidPorSolicitud">  	
				<table border="0" width="100%">
					...
					<tr>
						<td><input type="hidden" id="oblSolidarios" name="oblSolidarios" size="100" /></td>
					</tr>
					<tr>
						<td colspan="9">
							<div id="gridOblSolid" style="display: none;"></div>							
						</td>						
					</tr>
				</table>
				<table border="0" width="100%"> 
