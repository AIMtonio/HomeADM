...
<html>
	...
	<head>	
			...
			<script type="text/javascript" src="dwr/interface/avalesServicio.js"></script> 
		 	...
		 	<script type="text/javascript" src="dwr/interface/autorizaAvalesServicio.js"></script>
		 	<script type="text/javascript" src="dwr/interface/parentescosServicio.js"></script>
			<script type="text/javascript" src="js/credito/autorizaAvales.js"></script>
	</head>
...
<div id="contenedorForma">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">                
		<legend class="ui-widget ui-widget-header ui-corner-all">Autorización de Avales por Solicitud</legend>
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="autorizaAvales">  	
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<input type="hidden" id="avales" name="avales" size="100" />	
				 	<tr>
						<td colspan="9">
							<div id="gridAvales" style="display: none;"/>							
						</td>						
					</tr>
				</table>
				<table border="0" cellpadding="0" cellspacing="0" width="100%"> 
