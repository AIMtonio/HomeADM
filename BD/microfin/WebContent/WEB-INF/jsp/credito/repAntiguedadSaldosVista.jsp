...
<html>
	<head>
     ...
     <script type="text/javascript" src="dwr/interface/municipiosServicio.js"></script>  
      ...
      <script type="text/javascript" src="js/credito/antiguedadSaldos.js"></script>  
...
<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Antiguedad de Saldos</legend>
          ...
          <table  border="0"  width="560px">
				<tr>
					...
					<td colspan="4">
						<input id="fechaInicio" name="fechaInicio" path="fechaInicio" size="12" disabled="true"
		         			tabindex="1" type="text"  esCalendario="true" />	
		         			<input type="hidden" id="fechaVencimien" name="fechaVencimien" path="fechaVencimien" value="1900-01-01" />
					</td>					
				</tr>
				<tr>		<!-- quirta 
					<td class="label">
				...
				<tr>
					...
					<td colspan="4"><select id="sucursal" name="sucursal" path="sucursal" tabindex="3" >
				...
				<tr>
					...
					<td colspan="4"><select id="producCreditoID" name="producCreditoID" path="producCreditoID"  tabindex="5" >
	...
	<tr> 
     ...
     <tr> 
	     <td class="label"> 
	         <label for="diasatrasoinicial">Días de <br>Atraso Inicial: </label> 
	     </td> 
	     <td> 
	         <form:input id="atrasoInicial" name="atrasoInicial" path="atrasoInicial" size="6" tabindex="10" maxlength="5" /> 
	     </td> 
	     <td class="separador"/>
	      <td class="label"> 
	         <label for="diasatrasofinal">Días de <br>Atraso Final: </label> 
	     </td> 
	     <td> 
	         <form:input id="atrasoFinal" name="atrasoFinal" path="atrasoFinal" size="6" tabindex="10" maxlength="5" /> 
	     </td> 
    </tr>
  </table> </fieldset>  </td>  
						...
						<td colspan="4">
							<table align="right" border='0'>
								<tr>
									...
									<a id="ligaGenerar" href="reporteAntiguedadSaldos.htm" target="_blank" >  		 
