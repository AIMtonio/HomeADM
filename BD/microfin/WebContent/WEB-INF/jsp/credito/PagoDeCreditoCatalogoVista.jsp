...
<script type="text/javascript" src="js/credito/pagoCredito.js"></script>
</head>
<body>
			...
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				...
				<table border="0" width="960px">
					...
					<tr>
						...
						<td><form:input id="tasaFija" name="tasaFija" path="tasaFija" size="12" tabindex="12" type="text" readOnly="true" style="text-align: right" /> <label>%</label></td>
					</tr>
					<tr>
					...
					<div>
						<table>
							<tr>
								...
								<td class="label"><input type="radio" id="totalAde" name="totalAde" value="T" tabindex="23" checked="checked" /> <label for="siguientetotaladeu" class="label">Total Adeudo</label> <input type="hidden" id="finiquito" name="finiquito" value="S" tabindex="22" iniForma="false" /> <input type="hidden" id="permiteFiniquito" name="permiteFiniquito" value="" tabindex="22" iniForma="false" /></td>
								<td class="separador"></td>
								<td class="label"><input type="radio" id="exigible" name="exigible" value="E" tabindex="24" /> <label for="anteriorexigi">Pago Cuota</label></td>
								<td class="separador"></td>
								<td class="label" id="tdPrepagoCredito"><input type="radio" id="prepagoCredito" name="prepagoCredito" value="P" tabindex="25" /> <label for="lblPrepagoCredito">Prepago</label></td>
								<td class="separador"></td>
								<td class="label">
								...
								<td>
									<div id="divTipoPrepago1">
										...
										<td class="label"><label for="lblCuotaProyec" id="labelCuotaProyec">Cuotas a Pagar/Adelantar:</label></td>
										<td><input id="cuotasProyectadas" name="cuotasProyectadas" size="15" tabindex="30" type="text" style="text-align: right" /></td>
									</div>
								</td>
							</tr>
						</table>
					...
					<div>
						<table border="0" width="900px">
							...
							<tr>
								...
								<td class="ocultaSeguro"><input type="text" name="saldoSeguroCuota" id="saldoSeguroCuota" size="8" readonly="true" disabled="true" tabIndex="37" esMoneda="true" style="text-align: right" /></td>
								<td class="label ocultaSeguro"><label>Seguro</label></td>
								<td class="ocultaSeguro"><input type="text" name="saldoIVASeguroCuota" id="saldoIVASeguroCuota" size="8" readonly="true" disabled="true" tabIndex="37" esMoneda="true" style="text-align: right" /></td>
							</tr>
							<tr>
				...
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="900px">
						...
						<tr>
							<td class="label"><label for="lblComAnual">Comisi&oacute;n Anual: </label></td>
							<td><input type="text" name="comAnual" id="comAnual" size="12" tabindex="" readonly="true" disabled="true" esMoneda="true" style="text-align: right;" /></td>
							<td class="separador"></td>
							<td class="label"><label for="lblIVAComAnual">IVA Comisi&oacute;n Anual: </label></td>
							<td><input type="text" name="IVAComAnual" id="IVAComAnual" size="12" tabindex="" readonly="true" disabled="true" esMoneda="true" style="text-align: right;" /></td>
						</tr>
					</table>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="right">
					<tr>
						<td align="right"><input type="button" id="amortiza" name="amortiza" class="submit" tabIndex="46" value="Consultar Amortizaciones" /> <input type="button" id="movimientos" name="movimientos" class="submit" value="Consultar Movimientos" tabIndex="47" /> <input type="submit" id="pagar"
							name="pagar" class="submit" value="Pagar" tabIndex="48" /> <input type="hidden" id="tipoTransaccion" name="tipoTransaccion" /> <a id="enlaceTicket" target="_blank">
