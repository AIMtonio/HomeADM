...
<html>
	...
	<head>	
      <script type="text/javascript" src="dwr/interface/plazosCredServicio.js"></script>                 
		...
		<script type="text/javascript" src="dwr/interface/contratoCreditoServicio.js"></script>
		<!-- Este js es el correspondiente al contrato grupal de consol -->
		<script type="text/javascript" src="js/contratos/consol.js"></script>
		<script type="text/javascript" src="js/credito/pagareCreditoGrupal.js"></script>
	</head>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td >
						...
						<input id="nombreGrupo" name="grupoID"  size="40" tabindex="2"  disabled="true" />
					</td>
					...
					<td>
						<input id="cicloActual" name="cicloActual"  size="10" tabindex="3"  disabled="true" />
					</td>				
				</tr>
				<tr>
					<td class="label">
		  			...
		  			<td >
			 			<form:input id="fechaMinistrado" name="fechaMinistrado" path="fechaMinistrado" size="12" tabindex="3" esCalendario="true" />
					</td>	
					<td class="separador"></td>
					<td class="label">
					...
					<td >
						...
						<input id="nombreProducto" name="nombreProducto"  size="40" tabindex="2" disabled="true"  />
					</td>
					...
					<div id="Integrantes" style="display: none;" >
						...
						<table align="right">
							<tr>
							<td>
									<input type="submit" id="grabar" name="grabar" class="submit" value="Grabar" tabindex="5" disabled="true"  />
								...
								<td>
 				             	...
 				             	<td>
 				             		<input type="button" id="obligaCreditoGrupal" name="obligaCreditoGrupal" class="submit" value="Obligaciones de Crédito Grupal" />
 				             	</td>
				             	<td>
