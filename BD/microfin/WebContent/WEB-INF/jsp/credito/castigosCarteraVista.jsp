...
<html>
	<head>
		...
		<script type="text/javascript" src="js/credito/castigosCartera.js"></script>  
	</head>
<body>
<div id="contenedorForma">
	<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="castigosCartera">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>					
			...
			<td >
				<input id="clienteID" name="clienteID"  size="12"  type="text" readOnly="true" />
	        			<input id="nombreCliente" name="nombreCliente"  size="45" 
	        					 type="text" readOnly="true" />							
			</td>	
			<td class="separador"></td>
			<td class="label">
		...
		<tr>
			...
			<td> 
		         <input id="totalAdeudo" name="totalAdeudo"   size="12" type="text" readOnly="true" 
			...
			<td>
		   		 <input id="diasAtraso" name="diasAtraso" size="12" type="text" readOnly="true" 
		...
		<legend>Detalle del Adeudo </legend>
			<table>
				<tr>
					...
					<td> 
				         <input id="saldoCap" name="saldoCap"   size="15" type="text" readOnly="true" 
				         		style="text-align: right" esMoneda="true"/>  
				    </td>
				    <td class="separador"></td> 
					<td class="label">
					...
					<td>
					 <input id="saldoInt" name="saldoInt" size="15" type="text" readOnly="true" 
					 		 style="text-align: right" esMoneda="true"/>  
					</td>
					<td class="separador"></td> 
					<td class="label">
						<label for="lblsaldoNotasCargo">Saldo Notas de Cargo: </label>
					</td>
					<td>
					 <input id="saldoNotasCargo" name="saldoNotasCargo" size="15" type="text" readOnly="true" 
					 		 style="text-align: right" esMoneda="true"/>  
					</td>
				</tr>
				<tr>
					...
					<td>
					 <input id="saldoMoratorios" name="saldoMoratorios" size="15" type="text" readOnly="true" 
					  style="text-align: right" esMoneda="true"/>  
					</td>
					<td class="separador"></td>
	 				<td class="label">
					...
					<td>
					 <input type="text" id="SaldoComFaltaPa" name="SaldoComFaltaPa" size="15"  readOnly="true" 
					  style="text-align: right" esMoneda="true"/>  
					</td>
				</tr>
		...
		<legend>&Uacute;ltima Estimaci&oacute;n Crediticia </legend>
			<table>
				<tr>
					...
					<td>
					 <input id="totalReserva" name="totalReserva" size="15" type="text" readOnly="true" 
					  style="text-align: right" esMoneda="true"/>  
					</td>
				</tr>
				<tr>
					...
					<td>
					 <input id="reservaCap" name="reservaCap" size="15" type="text" readOnly="true" 
					  style="text-align: right" esMoneda="true"/>  
					</td>
	 				<td class="separador"></td> 
					...
					<td>
					    <input id="reservaInt" name="reservaInt" size="15" type="text" readOnly="true" 
					     style="text-align: right" esMoneda="true"/>  
					</td>
				</tr>
			</table>
				...
				<tr>
					...
					<td>
					    <textarea id="observaciones" name="observaciones" row="4" cols="30" tabindex="23" onblur="ponerMayusculas(this);" maxlength="100" class="valid"></textarea>   
					</td>
				</tr>
			</table>
</fieldset>
	<table align="right" >
		<tr>
			<td align="right" >
				<input type="submit" id="castiga" name="castiga" class="submit" tabIndex = "23" value="Castigar" />
