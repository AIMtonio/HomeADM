...
<html>
	<head>
		...
		<script type="text/javascript" src="js/credito/repCalificacionYEstimacionesB0417.js"></script>  
	</head>
<body>
...
<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Calificaci&oacute;n y Estimaciones (B-0417) </legend>
