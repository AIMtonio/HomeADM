...
<html>
	<head>
		...
		<script type="text/javascript" src="js/credito/repEstimacionPreventiva.js"></script>  
	</head>
<body> 
...
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="creditosBean">
	...
	<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Estimación Preventiva (A-0419)</legend>
