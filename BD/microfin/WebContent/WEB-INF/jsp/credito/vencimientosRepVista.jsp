...
<html>
	<head>
     ...
     <script type="text/javascript" src="dwr/interface/paramGeneralesServicio.js"></script>
      ...
      <script type="text/javascript" src="js/credito/repVencimientos.js"></script>  
...
<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Vencimientos</legend>	
	...
	<tr> 
     ...
     <tr> 
	     ...
	     <td> 
	         <form:input id="atrasoInicial" name="atrasoInicial" path="atrasoInicial" size="6" tabindex="12" maxlength="5" /> 
	     </td> 
	     <td class="separador"/>
	      <td class="label"> 
	     ...
	     <td> 
	         <form:input id="atrasoFinal" name="atrasoFinal" path="atrasoFinal" size="6" tabindex="13" maxlength="5" /> 
	     </td> 
     </tr>
  </table> </fieldset>  </td>  
