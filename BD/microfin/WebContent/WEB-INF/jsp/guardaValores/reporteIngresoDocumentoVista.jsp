...
<html>
	<head>
		...
		<script type="text/javascript" src="js/guardaValores/reporteIngresoDocumentoVista.js"></script>
	</head>
	<body>
		<div id="contenedorForma">
			<form id="formaGenerica" name="formaGenerica" method="POST" commandName="documentosGuardaValoresBean">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Ingresos de Documentos</legend>
