...
<script type="text/javascript" src="js/soporte/archUpload.js"></script>
<title></title>
</head>
<body>
	...
	<div id="contenedorForma" style="padding: 20px">
		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="archUploadGenBean" enctype="multipart/form-data">
