...
<html>
    <head>
		...
		<script type="text/javascript" src="dwr/interface/tiposDocumentosServicio.js"></script> 
      	...
      	<script type="text/javascript" src="js/soporte/cuentasFileUploadCatalogo.js"></script>
	...
	<body>
		<div id="contenedorForma">
			<form method="post" id="formaGenerica" name="formaGenerica" action="/microfin/cuentasFileUpload.htm" enctype="multipart/form-data">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">		
					...
					<table border="0" cellpadding="0" cellspacing="0" width="950px">
						<tr>
    						<td class="label"> 
        						<label for="lblcuenta">No. de Cuenta: </label> 
     						</td>
     						<td>
        						<input type="text" id="cuentaAhoID" name="cuentaAhoID" size="13" tabindex="1" iniforma="false" />  
         						<input type="text" id="nombreCliente" name="nombreCliente" size="35" disabled= "true" readOnly="true"/>  
      						</td> 
					...
					<table align="right">
	 					<tr>
    						<td class="label">
								<a id="enlace" href="cuentasFilePDF.htm" target="_blank">
		    						<input type="button" class="submit" id="pdf" tabindex="3" value="Reporte PDF"/>
								</a>		
							</td> 
      						<td>
