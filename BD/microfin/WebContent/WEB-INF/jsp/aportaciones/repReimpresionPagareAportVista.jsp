...
<head>
	...
	<script type="text/javascript" src="js/aportaciones/reimpresionPagareAport.js"></script>
	<script type="text/javascript" src="js/contratos/reciboMexiPrevicrem.js"></script> <!-- JS del Recibo de MEXI -->

<title>Reimpresi&oacute;n de Aportaciones</title>
</head>
<body>

	<div id="contenedorForma">
	<fieldset class="ui-widget ui-widget-content ui-corner-all" >
	<legend class="ui-widget ui-widget-header ui-corner-all">Reimpresi&oacute;n de Pagar&eacute; de Aportaciones</legend>

		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="reimpPagareAportaciones" >
		...
		<legend >Datos Generales</legend>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td colspan="3">
						<form:input id="tipoAportacionID" name="tipoAportacionID" path="tipoAportacionID" size="7" autocomplete="off" readonly="true" />
