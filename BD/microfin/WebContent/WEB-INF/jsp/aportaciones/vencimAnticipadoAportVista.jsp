...
<script type="text/javascript" src="js/aportaciones/vencimAnticipadoAport.js"></script>


<title>Vencimiento Anticipado de Aportaciones</title>
</head>
<body>

<div id="contenedorForma">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">
		<legend class="ui-widget ui-widget-header ui-corner-all">Vencimiento Anticipado de Aportaciones</legend>
		<form:form id="formaGenerica" name="formaGenerica" method="POST"
			commandName="aportacionesBean">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend>Datos Generales</legend>
				<table border="0" width="100%">
					<tr>
						<td width="10%"><label>Aportaci&oacute;n: </label></td>
						<td width="30%">
					...
					<tr>
						<td><label>Tipo de Aportaci&oacute;n: &nbsp;</label></td>
						<td nowrap="nowrap">
						<form:input id="tipoAportacionID" name="tipoAportacionID" path="tipoAportacionID" size="6" autocomplete="off" readonly="true" />
							...
							<fieldset class="ui-widget ui-widget-content ui-corner-all">
								...
								<table border="0">
									...
									<tr>
										...
										<td><form:input name="plazoOriginal" id="plazoOriginal" path="plazoOriginal" size="10" autocomplete="off"
												style="text-align: right;" readonly="true" /><label> D&iacute;as</label>
										</td>
