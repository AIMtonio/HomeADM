			...
			<table border="0" cellpadding="0" cellspacing="0" width="600px">
				...
				<tr>
					...
					<td class="label">
						...
						<input type="text" id="telefonoCasa" name="telefonoCasa" size="15" tabindex="4"
								 disabled="true" readOnly="true"/>
						<label class="label">Ext.:</label>
						<input type="text" id="extTelefonoPart" name="extTelefonoPart" size="10" maxlength="6" tabindex="5" readOnly="true">
					</td>					
				</tr>								
				<tr>
					<td colspan="2">
						<table align="right">
							<tr>
								<td align="right">
									<input type="submit" id="consultarRep" name="consultarRep" class="submit" value="Pantalla" tabindex="6"/>
									<input type="hidden" id="nomEmpresa" name="nomEmpresa" />
								</td>
							</tr>
						</table>		
					</td>
