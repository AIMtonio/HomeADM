...
/* jQuery lightBox plugin - Gallery style */
	...
	<fieldset class="ui-widget ui-widget-content ui-corner-all">                
		<legend>Documentos de la CEDE</legend>	
		<table border="0" cellpadding="0" cellspacing="0" width="100%"> 		
			...
			<tr>
				...
				<td>
			  	...
			  	<td> 
					<input type="button" name="elimina" id="elimina${status.count}" class="btnElimina" onclick="eliminaArchivo(${cuentaArchi.archivoCuentaID})"/>
