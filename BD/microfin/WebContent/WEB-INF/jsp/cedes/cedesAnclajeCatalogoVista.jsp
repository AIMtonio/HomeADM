...
<head> 
	...
	<script type="text/javascript" src="js/cedes/cedesAnclaje.js"></script>
    
	    <script type="text/javascript" src="js/general.js"></script>
    <script type="text/javascript" src="js/generarRFC.js"></script>  
	
	
<title>Anclaje de CEDE</title>
</head>
<body>
 <div id="contenedorForma">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">
	<legend class="ui-widget ui-widget-header ui-corner-all">Anclaje de CEDES</legend>
		<form:form id="formaGenerica" name="formaGenerica" method="POST"   commandName="cedesAnclajeBean" >
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
			<legend >Datos Generales</legend>
				<table border="0" width="100%">
					<tr>					
						<td>
							<label for="cedeAnclajeID" >CEDE Anclar: </label>
						</td>
						
						<td>
							<form:input type="text" name="cedeAnclajeID" id="cedeAnclajeID" path="cedeAnclajeID" size="11"  autocomplete="off" tabindex="1" />

						<td class="separador"></td>	  
						
						<td>
							<label for="cedeOriID">CEDE Madre: </label>
						</td>
						
						<td>
							<form:input type="text" name="cedeOriID" id="cedeOriID" path="cedeOriID" size="11"  autocomplete="off" tabindex="2" />
					...
					<tr>
						<td colspan="5">
							...
							<tr>
								...
								<td class="separador"></td>
								<td nowrap="nowrap"><label>Última Tasa Mejorada:</label></td>
							...
							<tr>
								...
								<td nowrap="nowrap"><input type="text" name="tasaCedeOr" id="tasaCedeOr"  size="12" readonly="true" disabled="true"  esTasa = "true"  style="text-align: right;"/><label>%</label></td>
								<td class="separador"></td>
							...
							<tr>
								...
								<td nowrap="nowrap">
									<form:input id="tipoCedeID" name="tipoCedeID" path="tipoCedeID"  readonly="true" disabled="true" size="6"  autocomplete="off"/>
								...
								<tr id="trTasaVariable1">
									...
									<td>
										<label>Calculo de Interes: </label>
									</td>
							...
							<table border="0" width="100%">
								...
								<tr>
									...
									<td id="lblCalculoInteres" nowrap="nowrap">
										<label id="lblCalculoInteres">Calculo Inter&eacute;s:</label>
									</td>
