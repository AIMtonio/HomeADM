...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/montosCedesServicio.js"></script>
		...
		<script type="text/javascript" src="js/cedes/tasasCedes.js"></script>
		<script type="text/javascript" src="js/cedes/tasasCedesSucursal.js"></script>
	
		<title>Tasas de CEDES</title>
	</head>
	<body>
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="tasasBean" >
				<fieldset class="ui-widget ui-widget-content ui-corner-all" >
					<legend class="ui-widget ui-widget-header ui-corner-all">Tasas de CEDES</legend>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td>
								<label>Tipo de CEDES:</label>
							</td>
							<td>
								<input type="text" id="tipoCedeID" name="tipoCedeID"  tabIndex="1" size="10" iniForma="false"/>
						...
						<tr>
							...
							<td>
								<input type="text" id="tasaCedeID" name="tasaCedeID" tabIndex="2" size="10" iniForma="false"/>
							</td>
					...
					<table>
			 		...
			 		<div id="tasasCedesGrid" name="tasasCedesGrid" style="display: none;">
					</div>	
					<table align="right">
						<tr>
							<td align="right">
								...
								<input type="hidden" id="estatusTipoCede" name="estatusTipoCede"/>
