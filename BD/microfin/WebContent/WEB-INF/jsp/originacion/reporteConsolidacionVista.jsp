...
<html>
	<head>
		...
		<script type="text/javascript" src="js/originacion/reporteConsolidacionVistaControlador.js"></script> 
	</head>
	<body>
		<div id="contendorForma"></div>
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="repConsolidaciones">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Consolidación</legend>
									...
									<table  border="0"  width="560px">
										...
										<tr> 
					    					...
					    					<td>		         			
					         					...
					         					<input  type="text" id="nombreSucursal" name="nombreSucursal" size="45"   readOnly="true" />	 
								   			</td> 			   	
										</tr> 
										<tr> 
											<td class="label"> 
					    					...
					    					<td>		         			
					         					...
					         					<input  type="text" id="nombreProductoCredito" name="nombreProductoCredito" size="45"  readOnly="true"  />	 
