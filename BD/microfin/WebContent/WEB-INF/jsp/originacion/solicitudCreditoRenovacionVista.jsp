...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="dwr/interface/paramGeneralesServicio.js"></script>
      	<script type="text/javascript" src="js/originacion/solicitudCreditoRenovacion.js"></script>
...
<div id="contenedorForma">
	<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="solicitudCreditoBean">
		<fieldset class="ui-widget ui-widget-content ui-corner-all">
			<legend class="ui-widget ui-widget-header ui-corner-all">Solicitud Renovaci&oacute;n de Cr&eacute;dito</legend>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td>
						<input type="text" id="tipoSolCredito" name="tipoSolCredito" size="20" value="RENOVACI&Oacute;N" iniForma="false"/>
