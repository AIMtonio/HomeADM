...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/esquemaOtrosAccesoriosServicio.js"></script>
 		...
 		<script type="text/javascript" src="js/originacion/flujoIndividual.js"></script>
...
<div id="contenedorForma">
	<div id="tabs"> 
		<ul> 
			...
			<li ><a id="capacidadPag" href="#capacidadPago">Estimaci&oacute;n Previa de Capacidad de Pago <br> <br></a></li> 	
