		...
		<td>
			<fieldset class="ui-widget ui-widget-content ui-corner-all">	
				...
				<table id="tbParametrizacion" border="0" width="350px">
					...
					<tbody>
						...
						<tr id="tr${status.count}" name="trCartas">
							...
							<td nowrap="nowrap">
								<input type="button" id="cartaLiq${status.count}" class="button" tabindex="<%=counter %>" name="cartaLiq" size="15" value="Adjuntar" onclick="subirArchivos('cartaLiq',<%=numFilas %>,'1')" />
							...
							<td nowrap="nowrap">
								<input type="button" id="comproPago${status.count}" class="button" tabindex="<%=counter %>" name="comproPago" size="15" value="Adjuntar" onclick="subirArchivos('comproPago',<%=numFilas %>,'2')" />
				...
				<table align="right">
					<tr>
						<td align="right">
							<input type="submit" id="grabar2" name="grabar2" class="submit"  value="Grabar" tabindex="199"/>
