...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/opRolServicio.js"></script> 	
 		<script type="text/javascript" src="js/originacion/flujoIndividualRenovacion.js"></script>
...
<input type="hidden" id="clienteSocio" value="<s:message code="safilocale.cliente"/>" />
	...
	<div id="tabs"> 
		<ul> 
			...
			<li ><a id="obligadosSolidarios" href="#obligadosSolidarios">Obligados Solidarios<br> <br></a></li>	
		...
		<div id="obligadosSolidarios"></div>
		...
		<div id="_selecciona"> 
			<form:form id="formaMenu" name="formaMenu" method="POST" commandName="solicitudCredito">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">                
					<legend class="ui-widget ui-widget-header ui-corner-all">Flujo Individual Renovaciones</legend>
