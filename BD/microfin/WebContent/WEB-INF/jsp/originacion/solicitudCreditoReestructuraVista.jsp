...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="dwr/interface/paramGeneralesServicio.js"></script>
      	<script type="text/javascript" src="js/originacion/solicitudCreditoReestructura.js"></script>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td class="label">
			     	...
			     	<td>
			        	<form:input type="text" id="creditoID" name="relacionado" path="relacionado" size="12" />
			     	</td>
				</tr>
				<tr>
					<td>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<td class="label">
					   	...
					   	<td>
							<select id="sobreTasa" name="sobreTasa" esTasa="true" style="text-align: right;" ></select>
						</td>
						<td class="separador"></td>
						<td class="label">
				...
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<table border="0" width="100%">
						...
						<tr>
							...
							<td >
								<form:input  type="text"  id="numAmortizacion" name="numAmortizacion" path="numAmortizacion" size="8" />
