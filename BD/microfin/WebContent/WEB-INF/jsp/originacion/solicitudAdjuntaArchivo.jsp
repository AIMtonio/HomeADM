...
<html>
	<head>
		...
		<script type="text/javascript" src="js/originacion/solicitudArchivoCatalogo.js"></script>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%"></table>
						<fieldset class="ui-widget ui-widget-content ui-corner-all">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									...
									<td>
										<input type="text" id="solicitudCreditoID" name="solicitudCreditoID" size="13" tabindex="1" iniforma='false' autocomplete="off"/>
									</td>
								...
								<tr>
									...
									<td>
										<select id="tipoDocumentoID" name="tipoDocumentoID" tabindex="2">
						...
						<table align="right">
							<tr>
								...
								<td>
									<input type="submit" id="actualizar" name="actualizar" class="submit" tabindex="11" value="Actualizar"   />
								</td>
							</tr>
							<tr>
								<td>
