...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/solicitudCredServicio.js"></script>     
 		...
 		<script type="text/javascript" src="js/originacion/solicitudCreditoGrupal.js"></script>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									...
									<tr>
										<td class="label">
							  			...
							  			<td >
								 			<input type="text"  id="fechaRegistro" name="fechaRegistro" path="fechaRegistro" size="10" 
									...
									<tr>
										<td class="label">
							  			...
							  			<td >
								 			<input  type="text"  id="nombreEstatusCiclo" name="nombreEstatusCiclo" path="nombreEstatusCiclo" size="15" 
								 			readonly= "true" disabled = "true" tabindex="3" />
										</td>		
									</tr>
								</table>
