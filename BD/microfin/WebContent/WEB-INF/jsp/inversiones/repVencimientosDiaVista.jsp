...
<head>
	...
	<script type="text/javascript" src="js/inversiones/repVencimientosDia.js"></script>
</head>
<body>
...
<div id="contenedorForma">
	...
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Vencimientos del D&iacute;a</legend>
		...
		<form id="formaGenerica" name="formaGenerica" method="POST" commandName="vencimientoInv"  target="_blank">
						...
						<legend><label>Par&aacute;metros</label></legend>         
          				<table  border="0"  width="560px">
							...
							<tr>
								...
								<td><select name="estatus" id="estatus" tabindex="6" >							
