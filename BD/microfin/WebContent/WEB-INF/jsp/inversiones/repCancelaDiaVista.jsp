...
<head>
	...
	<script type="text/javascript" src="js/inversiones/repCancelacionDia.js"></script>
</head>
<body>
...
<div id="contenedorForma">
	...
	<legend class="ui-widget ui-widget-header ui-corner-all">Reporte de Cancelaciones del Día</legend>
	
		<form id="formaGenerica" name="formaGenerica" method="POST" commandName="cancelacionInv"  target="_blank">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>								
					...
					<a id="ligaImp" href="CancelacionDia.htm" target="_blank" >
