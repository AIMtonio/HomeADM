...
<head>
    ...
    <script type="text/javascript" src="js/tesoreria/archivoFacturasMasiva.js"></script> 
    
    <title>Adjuntar Archivo Carga Masiva Facturas </title>
</head>
<body>
		  <div id="contenedorForma">
		<form method="post" id="formaGenerica" name="formaGenerica" enctype="multipart/form-data">
		<fieldset class="ui-widget ui-widget-content ui-corner-all">			
		<legend class="ui-widget ui-widget-header ui-corner-all">Adjuntar Archivo Carga Masiva Facturas</legend>			
		...
		<table align="right">
			<tr>
	   			<td>
      				...
      				<input type="hidden" id="rutaArchivosFacturas" name="rutaArchivosFacturas"/>						   
      			</td> 
			</tr>
		</table>
		</fieldset>	 
