...
<html>
	<head>
 	   <script type="text/javascript" src="dwr/interface/creditosEdadMayor55Servicio.js"></script>   
      <script type="text/javascript" src="js/riesgos/creditosEdadMayor55.js"></script>  		
	</head>
      
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="creditosEdadMayor55">

<fieldset class="ui-widget ui-widget-content ui-corner-all">                
	<legend class="ui-widget ui-widget-header ui-corner-all">Cr&eacute;ditos Edad > 55</legend>
					...
					<td>
						...
						<legend>Monto de Cartera Acumulado del D&iacute;a de Ayer</legend>
							<table>
								<tr>
									<td class="label">
										<label for="">Monto de Cartera de <s:message code="safilocale.cliente"/> > 55 Años: </label>
									</td>
									<td>
										<input id="montoCarteraSocios" name="montoCarteraSocios" size="20" type="text"  readonly="true" style="text-align: right;"/>	
									</td>			
								</tr>
								<tr>
									<td class="label">
					...
					<td>
						...
						<legend>Saldo de Cartera Acumulado al D&iacute;a de Ayer</legend>
							<table>
								<tr>
									<td class="label">
										<label for="">Saldo de Cartera de <s:message code="safilocale.cliente"/> > 55 Años: </label>
									</td>
									<td>
			...
			<tr>
				<td colspan="4">
					<table align="right" border='0'>
						<tr>
							<td align="right">
							<a id="ligaGenerar" href="credEdadMayor55Rep.htm" target="_blank" >  		 
