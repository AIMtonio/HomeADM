				...
				<c:when test="${mensaje.numero == '0'}">
					<c:forEach items="${listaResultado}" var="amortizacion" varStatus="status">
						<tr id="tramor${status.count}">
							...
							<td align="center">
								<input type="text" maxlength="18" size="18" esmoneda="true" id="capital${status.count}" name="capital" tabindex="<%=numTab++%>" style="text-align: right;" value="${amortizacion.capital}" onblur="sumaCapitalesAmor()">
							</td>
							<td align="center">
