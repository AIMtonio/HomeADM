...
<script type="text/javascript" src="js/fira/repSaldosTotalesAgro.js"></script>
</head>
<body>
	<div id="contenedorForma">
		<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="creditosBean">
			<fieldset class="ui-widget ui-widget-content ui-corner-all">
				<legend class="ui-widget ui-widget-header ui-corner-all">Anal&iacute;tico Cartera Agropecuaria</legend>
							...
							<fieldset class="ui-widget ui-widget-content ui-corner-all">
								...
								<table border="0" width="560px">
									...
									<tr>
										...
										<td colspan="4">
											<input id="monedaID" name="monedaID" size="11" maxlength="11" tabindex="3" iniforma="false">
									...
									<tr>
										...
										<td colspan="4">
											<form:select id="clasificacion" name="clasificacion" path="clasificacion" tabindex="9">
												<form:option value="0">TODOS</form:option>
											</form:select>
										</td>
									</tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td colspan="4" align="right" border='0'>
							<a id="ligaGenerar" href="RepSaldosTotalesCredito.htm" target="_blank"> <input type="button" id="generar" name="generar" class="submit" tabIndex="48" value="Generar" />
							</a>
						</td>
					</tr>
				</table>
