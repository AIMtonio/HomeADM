...
<html>
	<head>
		...
		<script type="text/javascript" src="dwr/interface/opRolServicio.js"></script>
 		...
 		<script type="text/javascript" src="js/fira/flujoIndividualConsolidacionAgro.js"></script>
...
<input type="hidden" id="clienteSocio" value="<s:message code="safilocale.cliente"/>" />
	...
	<div id="tabs">
		<ul>
			...
			<li ><a id="autAval" href="#autorizaAval">Autorizacion <br>Aval</a></li>
		...
		<div id="_selecciona">
			<form:form id="formaMenu" name="formaMenu" method="POST" commandName="solicitudCredito">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<legend class="ui-widget ui-widget-header ui-corner-all">Flujo Individual Consolidación Agro</legend>
									...
									<tr>
										...
										<td >
											...
											<div id="divNuevosComentarios"  >
												<textarea id="nuevosComents" name="nuevosComents" onChange="ponerMayusculas(this); limpiarCajaTexto(this.id);" onBlur="ponerMayusculas(this); limpiarCajaTexto(this.id);"
