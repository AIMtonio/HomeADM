...
<script type="text/javascript" src="js/fira/desembolsoCreditoGrupal.js"></script>
</head>
<body>
		...
		<legend class="ui-widget ui-widget-header ui-corner-all">Desembolso de Crédito Grupal</legend>
			...
			<table  width="100%">
				<tr>
					...
					<td>
						<input  type="text" id="cicloActual" name="cicloActual"  size="10" tabindex="3" readonly="true"/>
					</td>			
				</tr>
				<tr>
					<td class="label">
					...
					<td >
						<form:input type="text" id="producCreditoID" name="producCreditoID"  path ="producCreditoID" size="12" tabindex="1" disabled="true" />
						<input type="text" id="nombreProducto" name="nombreProducto"  size="40" tabindex="2" readonly="true"/>
					</td>		
					<td class="separador"></td>
					<td class="label">
					...
					<td >
						<input type="text" id="estatus" name="estatus"  size="12" tabindex="1" readonly="true" />
