...
<script type="text/javascript" src="js/fira/creQuitasContFiraVista.js"></script>
...
<div id="contenedorForma">
	...
	<legend class="ui-widget ui-widget-header ui-corner-all">Quitas y Condonaciones de Contingentes Agro</legend>
		<fieldset class="ui-widget ui-widget-content ui-corner-all">
		<table border="0" cellpadding="0" cellspacing="0" width="90%">
			<tr>
				...
				<td colspan="3"><input id="nombreCliente" name="nombreCliente" size="30" tabindex="3" type="text" readOnly="true" disabled="disabled" /></td>
			...
			<tr>
				...
				<td colspan="3"><input id="nomCuenta" name="nomCuenta" size="30" tabindex="6" type="text" readOnly="true" disabled="disabled" /></td>
			</tr>
			<tr>
				...
				<td colspan="3"><input id="monedaDes" name="monedaDes" size="30" tabindex="10" type="text" readOnly="true" disabled="disabled" /></td>
			</tr>
			<tr>
...
<!-- 					<td class="separador"></td> -->
<!-- 					<td align="center"><input id="porceComisionesPer" name="porceComisionesPer" size="6" type="text" style="text-align: right" tabindex="1" disabled="disabled" readonly="readonly" /></td> -->
<!-- 					<td class="separador"></td> -->
<!-- 				</tr>	 -->
				<tr>
					...
					<td class="separador"></td>
					<td align="center"><input id="porceMoratoriosPer" name="porceMoratoriosPer" size="6" type="text" style="text-align: right" tabindex="1" disabled="disabled" readonly="readonly" /></td>
					<td class="separador"></td>
				</tr>
				<tr>
					...
					<td class="separador"></td>
					<td align="center"><input id="porceInteresPer" name="porceInteresPer" size="6" type="text" style="text-align: right" tabindex="1" disabled="disabled" readonly="readonly" /></td>
					<td class="separador"></td>
				</tr>
				<tr>
					...
					<td class="separador"></td>
					<td align="center"><input id="porceCapitalPer" name="porceCapitalPer" size="6" type="text" style="text-align: right" tabindex="1" disabled="disabled" readonly="readonly" /></td>
					<td class="separador"></td>
				</tr>	
				<tr>
