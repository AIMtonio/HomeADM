	...
	<table id="TablaAmortizaLibres" border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<c:forEach items="${listaResultado}" var="amortizacion" varStatus="status">
						<tr id="tramor${status.count}">
							...
							<td align="center" nowrap="nowrap">
								<input type="text" maxlength="10" size="15" disabled="disabled" id="fechaVencim${status.count}" name="fechaVencim" value="${amortizacion.fechaVencim}" tabindex="<%=numTab++%>" onchange="cambiarFechaInicioAmor(this.id);validarFechas(false);">
							</td>
							<td align="center">
		...
		<tfoot>
			...
			<tr>
				...
				<td align="center">
					<input type="text" size="18" readonly="true" style="text-align: right;" esmoneda="true" disabled="disabled" id="totalCap" name="totalCap">
				</td>
				<td align="center">
					<input id="totalInt" name="totalInt" size="18" disabled="disabled" style="text-align: right;" esMoneda="true" />
				</td>
				<td align="center">
					<input id="totalIva" name="totalIva" size="18" disabled="disabled" style="text-align: right;" esMoneda="true" />
				</td>
				<c:if test="${var_cobraSeguroCuota == 'S'}">
					<td align="center">
