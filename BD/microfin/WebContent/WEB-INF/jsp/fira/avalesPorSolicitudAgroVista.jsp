...
<html>
	<head>
		...
		<script type="text/javascript" src="js/fira/avalesSolAgro.js"></script>
...
<body>
	...
	<div id="contenedorForma">
		<fieldset class="ui-widget ui-widget-content ui-corner-all">                
			<legend class="ui-widget ui-widget-header ui-corner-all">Avales Por Solicitud de Crédito Agropecuario</legend>
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="avalesPorSolicitud">  	
				<table width="100%">
					<tr>
					    ...
					    <td> 
					   		<form:input id="solicitudCreditoID" name="soicitudCreditoID" path="solicitudCreditoID" size="10" autocomplete="off" /> 
						</td>
					    <td> 
