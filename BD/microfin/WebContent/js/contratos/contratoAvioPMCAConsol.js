...
function generarContratoAvioPMCA(creditoID, productoCreditoID,  monedaID, montoTotal, razonSocialInst,
	...
	var documento = {
		...
		header: {
		columns: [
			{ text: ['CONTRATO DE ADHESIÓN CRÉDITO AVIO',generalesAgro.nombreProd],
				alignment: 'left',
				margin: [25, 25, -35, 0]
			},
			{ stack: [
		...
		content: [
			...
			{ table: {
				...
				body: [
					...
					[
						...
						{ text:[garantiaFira(catTipoConsultaGarFIRA.avioFEGA, garantiasFira),' más I.V.A. por el monto del crédito.']},
					],
					[
			...
			},
			{
			   	columns: [
					{ stack: [
						...
						{ text: consejoAdmon[1].nombreCompleto, bold: true},
						{ text: consejoAdmon[1].nombreCargo, bold: true }
					]},
				   	{ stack: [
						'\n',
						'\n',
						'_____________________________',
						{ text: consejoAdmon[2].nombreCompleto, bold:true},
						{ text: consejoAdmon[2].nombreCargo, bold: true }
				   	]}
		   		],
		   		bold: true,
		   		alignment: 'center',
		   	...
		   	{
				stack: [
					'\n\nRESPECTIVAMENTE DEL CONSEJO DE ADMINISTRACIÓN',
			...
			{
				text: [
					'CONTRATO DE APERTURA DE CRÉDITO AGROPECUARIO DE ',
					...
					'REPRESENTADA EN ESTE ACTO POR LOS C. ',
					{ text: consejoAdmon[0].nombreCompleto, bold: true },', ',
					{ text: consejoAdmon[1].nombreCompleto, bold: true },', ',
					{ text: consejoAdmon[2].nombreCompleto, bold: true },' ',
					aliasConsejoAdmon(consejoAdmon[0].alias, consejoAdmon[1].alias, consejoAdmon[2].alias).toUpperCase().substring(1),
					{ text: ' EN SU CARÁCTER DE', bold: true },
					' PRESIDENTE, SECRETARIO Y  TESORERO, RESPECTIVAMENTE DEL ',
					{ text: ' CONSEJO DE ADMINISTRACIÓN', bold: true },
					...
					', ASÍ MISMO COMPARECE (N) EL (LOS) SEÑOR (ES): ',
						...
						{ text: [ 'Bajo protesta de conducirse con verdad Declara ', { text: '"EL ACREDITADO"', bold: true}, ':']},
						{
							...
							ol: [
								{ text: ['Que es una ',
										...
										' constituida mediante escritura número ',
										...
										', la cual se encuentra inscrita en el Registro Público de la Propiedad y de Comercio con sede en, ',
										escriturasPub.direccionNotariaPM,
										' con el folio mercantil ',
										escriturasPub.folioMercantilPM,'.'
									]},
									{ text: [
										'Las facultades con las que actúa no le han sido revocadas ni restringidas, por lo que comparece en pleno ejercicio de facultades delegadas, según consta en la Escritura Pública número ',
										escriturasPub.numEscPub,
										' que contiene la protocolización del acta de asamblea general extraordinaria donde se nombra al consejo de Administración Presidente ',
										{ text: consejoAdmon[0].nombreCompleto, bold: true},
										', Secretario ',
										{ text: consejoAdmon[1].nombreCompleto, bold: true},
										', Tesorero ',
										{ text: consejoAdmon[2].nombreCompleto, bold: true},
										' y como ',
										consejoAdmon[3].nombreCargo,
										' ',
										{ text: consejoAdmon[3].nombreCompleto, bold: true},
										' con poder para pleitos y cobranza; para actos de administración y de dominio; poder para otorgar y suscribir títulos y operaciones de crédito; de fecha',
									...
									{ text: [
										'Que cuenta con cedula de identificación fiscal ', 
										RFCInst,
									...
									{ text: [
										'Que para el fomento de sus actividades ha solicitado a "LA ACREDITANTE" el Crédito materia del presente contrato para destinarlo a los fines  previstos en el mismo. '
									]},
									{ text: [
										'Toda la documentación e información que ha entregado a la “LA ACREDITANTE” para el análisis y estudio del otorgamiento del presente contrato es correcta y verdadera. '
									]}
							]
						}
					],
					[
						{ text: [ 'Declara(n) el(los) ', { text: '"GARANTE(S) HIPOTECARIO(S), GARANTE (S) PRENDARIO (S), GARANTE (S) USUFRUCTUARIO (S) Y AVAL (ES) U OBLIGADO (S) SOLIDARIO (S)"', bold: true}, ' que:']},
						{
							type: 'lower-alpha',
							separator: ')',
							ol: [
								...
								{text: ['Que es su interés constituirse en el presente instrumento en cuanto ',{ text: '"GARANTES (S) HIPOTECARIO (S), GARANTE (S) PRENDARIO (S), GARANTE (S) USUFRUCTUARIO (S) Y AVAL (ES) U OBLIGADO(S) SOLIDARIO(S)"', bold: true},' de la "PARTE ACREDITADA" adquiriendo los derechos y obligaciones que del mismo se deriva.\n\n\n']}
							]
						}
					],
					[
			...
			{ // Clausula Segunda
				text: [
					...
					'no incluyen las comisiones previstas en este contrato, los intereses más I.V.A., y gastos que deba de cubrir ',
					{ text: '"EL ACREDITADO"', bold: true },
					', con motivo de las obligaciones contraídas y que se estipulan en el presente instrumento.\n',
			...
			},
			{
				...
				separator: ')',
				ol: [
					{text: [{ text: 'PARA CRÉDITOS DE HABILITACIÓN O AVÍO, ', bold: true},'Intereses ordinarios sobre saldo insoluto a una ',{ text: 'tasa fija de ', bold: true},{ text: generales.tasaOrdinaria, bold: true},' de acuerdo a lo previsto en los Artículos 9 de la Ley para la Transparencia y Ordenamiento de los Servicios Financieros y 5, fracción V, inciso b) de las Disposiciones de Carácter General en Materia de Transparencia aplicables Sociedades Financieras de Objeto Múltiple, Entidades no Reguladas.\n\n']},

					{text: [{ text: 'PARA CRÉDITOS REFACCIONARIOS, ', bold: true},'Intereses ordinarios sobre saldo insoluto a una tasa de 0.0% (Cero punto cero) Por Ciento Anual más I.V.A.\n\n']}
				]
			},
			{
				text: [
			...
			},
			{
				text: [
					...
					'se obliga a pagar a ',
					{ text: '"LA ACREDITANTE" ', bold: true },
					'por única vez mientras dure la vigencia de este crédito equivalente al ',
			...
			},
			{
				text: [
					...
					'está de acuerdo en pagar el costo por concepto de GARANTÍA FEGA que otorga FIRA, el cual representa el ',
					garantiaFira(catTipoConsultaGarFIRA.refaccionarioFEGA, garantiasFira),
					' anual más I.V.A. para créditos de ',
					{ text: 'HABILITACIÓN O AVÍO ', bold: true },
					'y el 0.0% (Cero punto cero) por ciento anual más I.V.A. para créditos refaccionarios, multiplicados por el monto del crédito, multiplicados por el periodo de vigencia de cada amortización.\n\n'
			...
			{ // Clausula Sexta
				text: [
					...
					{ text: '"LA ACREDITANTE"', bold: true },
					'el importe del Crédito dispuesto, los intereses estipulados y las demás sumas que resulten a su cargo derivadas del presente contrato, en un plazo de ',
			...
			{ 
				text: [
					...
					{ text: '"EL ACREDITADO"', bold: true },
					', se aplicará en el siguiente orden: Gastos, Impuestos, honorarios, derechos de registro, cuotas de seguro de vida, intereses moratorios, intereses ordinarios, financiamientos adicionales, impuestos y por último capital.\n\n',
			...
			{
				text: [
					'\nLo anterior en el entendido de que en todo caso, las cantidades correspondientes deberán quedar perfecta y absolutamente liberadas y disponibles a satisfacción de CONSOL en su cuenta bancaria, a más tardar a las 12:00 (doce) horas (hora de la Ciudad de México, Distrito Federal) del día en que deba hacerse el pago correspondiente, pues de lo contrario, aquellos pagos que efectivamente se hayan acreditado fuera de dicho horario, se considerarán hechos el Día Hábil siguiente, con la consecuente generación de intereses moratorios más I.V.A., en su caso.\n\n',
				]
			},
			{ // Clausula Octava
				text: [
			...
			},
			{
				...
				ol: [
					...
					{ text: [
						'Entregar a ',{ text: '"LA ACREDITANTE" ', bold: true },'y satisfacción de la misma, en forma trimestral a más tardar dentro de la última semana del tercer mes correspondiente, en el domicilio señalado en la cláusula ',
						{ text: '"TRIGÉSIMA TERCERA" ', bold: true },
						' del presente contrato, la siguiente información: \n',
					...
					{ text: 
						[
							'Garantía hipotecaria.- Si ',{ text: '"EL ACREDITADO"', bold: true },':\n',
								...
								'Si no paga durante dos bimestres consecutivos, las contribuciones correspondientes a impuesto predial, derechos por servicio de agua, o cualquier otro impuesto o derecho aplicable por las autoridades al(los) inmueble(s) hipotecado(s).\n',
								'Si no comprueba a ',{ text: '"LA ACREDITANTE" ', bold: true },' cuando éste así lo solicite, estar al corriente en el pago de los impuestos y derechos mencionados en el inciso precedente.\n'
						] 
					},
			...
			{ // Clausula Vigesima Novena.
				text: [
					...
					{ text: '"EL CRÉDITO"', bold: true },
					', el Costo Anual Total (CAT) y demás requisitos en términos del citado artículo.\n\n'
				]
			},
			{ // Clausula Trigesima.
				text: [
			...
			},
			{
				...
				ol: [
					...
					{ text: ['El dictamen se formulará por escrito y será suscrito por algún funcionario facultado. En el caso de que, conforme al dictamen que emita',{ text: '"LA ACREDITANTE"', bold: true },', resulte procedente el cobro del monto respectivo, ',{ text: '"EL ACREDITADO" ', bold: true },'deberá hacer el pago de la cantidad a su cargo, incluyendo los intereses ordinarios más I.V.A. conforme a lo pactado, sin que proceda el cobro de intereses moratorios y otros accesorios generados por la suspensión del pago.']},
			...
			{ // Clausula Trigesima Tercera.
				text: [
					...
					{ text: '"ADMINISTRADOR GENERAL ÚNICO. ": ', bold: true },consejoAdmon[0].nombreCompleto+' .- '+consejoAdmon[0].direccion,'\n\n',
					{ text: '"CONSEJO DE ADMINISTRACCIÓN.-": ', bold: true },'\n\n',
...
function aliasConsejoAdmon(parAliasPresi, parAliasSecre, parAliasTeso){
	var texto = '';

	if(parAliasPresi != '' || parAliasSecre != '' || parAliasTeso != ''){
		texto = '\nTambién conocidos (as) indistintamente con el (los) nombre (s) de ';
		if(parAliasPresi != ''){
			texto += ', '+parAliasPresi;
		}
