...
function generarContrato(grupoID, productoCreditoID, cicloGrupo, monedaID, montoTotal, razonSocialInst,
						RFCInst, direccionInst, telefonoInst, repLegalInstitucion,
						calcInteres, fechaEmision) {

	var grupo = {
		'grupoID': grupoID
	};
	contratoCreditoServicio.consulta(contratoGrupal, parseInt(cicloGrupo), listaIntegrantes, grupo,{ async: false, callback:function(contrato){
		generales = contrato[0];
		integrantes = contrato[1];
		amortizaciones = contrato[2];
	}});
		...
		content: [
			{ columns: [
					...
					{ text: [
								...
								'SINTESIS DEL CONTRATO DE ADHESION EN CUADRO INFORMATIVO\n',
			...
			{ table: {
				...
				body: [
					[
						{ text: 'CAT a la fecha de contratación, tasa fija, para fines informativos y de comparación exclusivamente:', bold: true },
						{ text: generales.CAT, bold: true },
					],
					[
						'Bonificación por pago puntual:',
						{ text: [generales.porcBonif, ' del crédito equivalente a ', generales.montoBonif]},
					],
					[
					...
					[
						{ text:'Tasa de interés ordinaria:', bold: true },
						{ text:generales.tasaOrdinaria, bold: true },
					],
					[
						{ text:'Tasa de interés moratoria:', bold: true },
					...
					[
						...
						{ stack: [
                            ...
                            'No aplica.'
							/*'Cuatro meses a partir de la contratación.'*/ /*RLAVIDA_ T_11797 */
						  ]
						}
					],
					[
					...
					[
						'Datos de la unidad Especializada de atención a usuarios:',
						generales.datosUEAU,
					]
				]
				},
			...
			{ text: '\n'},
			{
				table: {
					...
					body: [
						[
							{ stack: [
								{ text: 'GARANTÍAS SOLIDARIAS: ', bold: true},
								'Para garantizar el pago de este crédito, el Cliente deja en garantía el bien que se describe a continuación:'
							]}
						],
						[
							{ text: [
								'- Garantía líquida SOLIDARIA por el ',
								generales.porcGarLiquida,
								' del monto del crédito equivalente a ',
			...
			{ text: '\n\n'},
			{ text:  'POR "EL ACREDITADO"\n\n', bold: true, style: 'header' },
			{
				stack: firmantes(integrantes),
				alignment: 'center',
				pageBreak: 'after'
			},
			{
				text: [
					...
					', CON GARANTÍA SOLIDARIA, PRENDARIA, HIPOTECARIA, GARANTÍA LÍQUIDA Y/O AVAL QUE CELEBRAN POR UNA PARTE LA EMPRESA DENOMINADA "',
					...
					repLegalInstitucion,
					', EN SU CARÁCTER DE REPRESENTANTE LEGAL; Y POR LA OTRA PARTE Y POR SU PROPIO DERECHO EL (LA, LOS, LAS) SEÑOR (ES, AS):',
					cadenaIntegrantes(integrantes),
			...
			{ text: '\n\n' },
			{
				...
				ol: [
					[
						{ text: ['Bajo protesta de decir verdad declara ',
						{ text: 'CONSOL NEGOCIOS SOCIEDAD ANÓNIMA DE CAPITAL VARIABLE SOCIEDAD FINANCIERA DE OBJETO MÚLTIPLE ENTIDAD NO REGULADA (SOFOM ENR)', bold: false },
						' por conducto de su representante legal:'] },
						{
							...
							ol: [
							    ...
							    'La personalidad con la que se actúa se acredita mediante la Escritura Pública número 29,529 (veintinueve mil quinientos veintinueve) de fecha 05 de Marzo de 2020 otorgada ante la Fe del Notario Público Número 3 (Tres) de la Ciudad de Tlajomulco de Zúñiga, Jalisco, Lic. Edmundo Márquez Hernández, inscrita en el Registro Público de la Propiedad y de Comercio con el Folio Mercantil Electrónico No. 23674 de fecha 05 de de Marzo del 2020, en el cual se otorga al ',
								 { text: 'C. ' + repLegalInstitucion, bold: true },
					...
					[
						{ text: [ 'Bajo protesta de conducirse con verdad Declara ', { text: '"EL ACREDITADO"', bold: true}, ':']},
						{
							...
							separator: ')',
							ol: [
								{ text: ['Es (son) persona(s) física(s), mayor(es) de edad, que cuenta(n) con la debida capacidad y facultades legales necesarias para obligarse en términos del presente contrato; y para recibir cualquier notificación el acreditado señala el siguiente domicilio: ', generales.direccionPresidenta] },
			...
			},
			{
				text: [
					...
					{ text: '"EL ACREDITADO"', bold: true },
					' por montos y destinos que se describen la tabla "A".',
				]
			},
			{
				text:'\n\n'
			...
			{
				table: {
					body: crearTablaBeneficiarios(tablaBeneficiarios, integrantes)
				}
			},
			{
				text:'\n\n'
			...
			},
			{
				text: [
					...
					'se obliga a destinar el importe de las disposiciones de crédito concedido para capital de trabajo, para los conceptos de inversión que son objeto del crédito y que fueron los señalados en su solicitud de crédito, los cuales son:',
					cadenaDestinos(integrantes),
					'; Obligándose ',
					{ text: '“EL ACREDITADO”', bold: true },
				...
				ol: [
					...
					},
					{
						table: {
							headerRows : 1,
							body: [
									[ { rowSpan: 2, text: '\n                  Interés = \n'} ,{ text: '((Monto de Credito) (Tasa de Interés Ordinaria) (Días transcurridos en el periodo))', alignment: 'center' }],
					...
					}],
					{
						text: [
							...
							'Se establece una comisión por apertura de crédito por única vez mientras dure la vigencia de este crédito equivalente al ',
							generales.comisionAdmon,
							' del monto de crédito equivalente a ',
							generales.montoComAdm,
							'. Para obtener el monto de la comisión a pagar debe multiplicarse el crédito otorgado señalado en la cláusula primera de este contrato por el porcentaje de comisión establecido.'
						],
					},
					{
						text: [
							...
							{ text: '"EL ACREDITADO"', bold: true },
							' sea aceptado por la aseguradora para ser asegurado, se contratará un seguro de vida con cobertura suficiente para cubrir el monto del crédito cuyo costo de prima por cuatrimestre será de ',
							generales.primaSeguro,
							' para una suma asegurada de ',
							generales.coberturaSeguro,
                            ' renovable al vencimiento No aplica. Los detalles del aseguramiento se establecerán en la póliza correspondiente.' /* RLAVIDA_ TICKET_11592*/
							/*', renovable al vencimiento cada cuatro meses durante un año. Los detalles del aseguramiento se establecerán en la póliza correspondiente.'*/
						],
					},
					{
						text: [
					...
					},
					{
						text: [
							...
							{ text: '"EL ACREDITADO"', bold: true },
							' incurriese en mora en el cumplimiento oportuno de sus obligaciones de pago contraídas en el presente contrato, pagará los intereses moratorios que resulten de multiplicar por dos la tasa de interés ordinaria pactada mas I.V.A. por el monto del saldo vencido por el número de días que tarde en regularizar su pago, todo esto dividido entre 360 días. Dichos intereses causarán desde la fecha en que incurra en el incumplimiento hasta la regularización de los pagos. Lo anterior será sin perjuicio de que ',
							{ text: '"LA ACREDITANTE"', bold: true },
					...
					{
						text: [
							'BONIFICACIONES. Si en la duración del crédito no hay retraso alguno en sus pagos, se bonificará el ',
							generales.porcBonif,
							' del crédito total equivalente a ',
							generales.montoBonif,
							'. Esta bonificación se realizará al final del crédito cotejando los recibos de pago y verificando cero días de atraso, además de cotejar que las ',
							generales.plazo,
							' se hayan pagado completas con todo el interés pactado.'
						],
						bold: true,
					}
				]
			...
			{ text: 'TERCERA.- PLAZO Y FORMA DE PAGO:', bold: true },
			{
				text: [
					...
					generales.plazo,
					', contados a partir de la fecha de disposición del crédito. Tanto de pago de intereses más I.V.A., como de capital se realizarán abonos semanales según se indica en la tabla siguiente:'
				],
			},
			{ text: '\nTABLA "B" PLAZOS', bold: true },
			{
				text:'\n'
			},
			{
			...
			},
			{
				text: [
					...
					{ text:'"LA ACREDITANTE"', bold: true },
					' y solo en aquellos casos en que la sucursal bancaria se encuentre a una distancia considerable de la comunidad, el importe del pago semanal podrá ser entregado al asesor respectivo contra la entrega rigurosa del recibo correspondiente, en los días y horas establecidas sin necesidad de requerimiento o cobro previos.'
				]
			},
			{
				text:'\n\n'
			...
			},
			{
				text: [
					...
					'Juárez Norte No. 6, Col. Centro, C.P. 45640, Tlajomulco de Zúñiga, Jalisco, Tel (33) 379 82000, 379 80766, Fax. 379 80237.',
				]
			},
			{
				text:'\n\n'
			...
			{
				text: [
					{ text: 'SÉPTIMA.- PAGOS ANTICIPADOS.- “EL ACREDITADO”', bold: true },
					' podrá hacer pagos anticipados a cuenta de capital e intereses más I.V.A., o bien podrá liquidarlo íntegramente antes de su vencimiento, siempre y cuando dicho pago anticipado se presente con un mínimo de un mes de anticipación y sea equivalente a la totalidad de refinanciamientos e intereses normales del último período, entendiéndose por éste, los días transcurridos entre la última amortización realizada y la fecha en que ocurra dicho pago anticipado.',
				]
			},
			{
				text:'\n\n'
			...
			},
			{
				...
				ol: [
					{ text: [
						...
						{ text: '"LA ACREDITANTE"', bold: true },
						' garantía en primer lugar sobre los bienes descritos a continuación:\n'
					]
					},
					{ text: [
			...
			},
			{
				text: [
					...
					' El presente contrato se encuentra registrado ante la Comisión Nacional para la Protección y Defensa de los Usuarios de Servicios Financieros (CONDUSEF) con el número de registro 1737-439-014800/01-22943-1113, misma que cuenta con el siguiente número telefónico de atención a usuarios (0155-53400999 o LADA sin costo 01800-9998080), dirección en Internet (www.condusef.gob.mx) y correo electrónico (opinion@condusef.gob.mx).'
				]
			},
			{
				text:'\n\n'
...
function cadenaIntegrantes(integrantes) {
	var cadenaIntegrantes = '';
	var len = integrantes.length;
	for(var i=0; i < len - 1; i++){
		cadenaIntegrantes = cadenaIntegrantes + integrantes[i].nombre + ', ';
	}
	cadenaIntegrantes = cadenaIntegrantes + integrantes[len - 1].nombre;
	return cadenaIntegrantes;
}

function cadenaDestinos(integrantes) {
	var cadenaDestinos = '';
	var len = integrantes.length;
	for(var i=0; i < len - 1; i++){
		cadenaDestinos = cadenaDestinos + integrantes[i].destinoCredito + ', ';
	}
	cadenaDestinos = cadenaDestinos + integrantes[len - 1].destinoCredito;
	return cadenaDestinos;
};

function firmantes(integrantes) {
	var firmas = [];
...
function crearTabla(amortizaciones) {
	...
	amortizaciones.forEach(function(amortizacion) {
		tablaAmortizaciones.push([amortizacion.amortizacionID,
...
function crearTablaBeneficiarios(tablaBeneficiarios, beneficiarios) {
	tablaBeneficiarios = [
		[ { text: 'No.', bold: true }, { text: 'NOMBRE', bold: true }, { text: 'MONTO', bold: true }, { text: 'DESTINO', bold: true }],
	];
	var i = 1;
	beneficiarios.forEach(function(beneficiario) {
		tablaBeneficiarios.push([
			i,
			beneficiario.nombre,
			'$ ' + beneficiario.montoAu,
			beneficiario.destinoCredito
		]);
		i++;
	});
...
function crearTablaIntegrantes(tablaIntegrantes, integrantes) {
	...
	integrantes.forEach(function(integrante) {
		tablaIntegrantes.push([
			...
			integrante.folioIdentificacion
		]);
	});
