$(document).ready(function() {
    ...
    $('#fechaOperacion').change(function() {
		...
		if(esFechaValida(Xfecha)){
			...
			if ( mayor(Xfecha, Yfecha) ){
				...
				consultaCreditosMenor100(this.id);
			}
		}
	}); 
	...
	function generaExcel() {	
		...
		$('#ligaGenerar').attr('href','credMenor100Rep.htm?fechaOperacion='+fechaOperacion+'&tipoReporte='+tr+
				'&nombreInstitucion='+nombreInstitucion+'&nomUsuario='+nomUsuario);
	}
	
	// Función para consultar Créditos menor a $ 100,000.00
	function consultaCreditosMenor100(idControl){
		esTab = true;
		...
		creditosMenor100Servicio.consulta(catTipoConsulta.menorCienMil,conMenorCienMilBean,function(consulta) {
			if(consulta!=null){
