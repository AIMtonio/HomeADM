$(document).ready(function() {
	...
	// Funcion para generar en EXCEL información de créditos con Pagos Únicos
	function generaExcel() {	
		...
		$('#ligaGenerar').attr('href','credPagosUnicosRep.htm?fechaOperacion='+fechaOperacion+'&tipoReporte='+tr+
				'&nombreInstitucion='+nombreInstitucion+'&nomUsuario='+nomUsuario);
	}

	// Función para consultar Créditos Pagos Únicos
	function consultaPagosUnicos(idControl){
		...
		if(fecha != ''){	
			...
			creditosPagosUnicosServicio.consulta(catTipoConsulta.pagoUnico,conPagosParcBean,function(pagos) {
			if(pagos!=null){
