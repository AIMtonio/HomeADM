...
function imprimirTicketPagCredGrupal(impresionPagoCredGrupal,numeroTicket,garantiaLiquida){
	...
	agregaLinea("CONCEPTO       CANTIDAD   "    );	
	agregaLinea("----------------------------" );
	agregaLinea("Capital:   "+alinearDato(impresionPagoCredGrupal.capital,16,'$'));
	agregaLinea("Interes:   "+alinearDato(impresionPagoCredGrupal.interes,16,'$'));
	agregaLinea("Moratorios:"+alinearDato(impresionPagoCredGrupal.moratorios,16,'$'));
	agregaLinea("Comision:  "+alinearDato(impresionPagoCredGrupal.comision,16,'$'));
	agregaLinea("Com.Admon: "+alinearDato(impresionPagoCredGrupal.comisionAdmon,16,'$'));
	agregaLinea("I.V.A:     "+alinearDato(impresionPagoCredGrupal.iva,16,'$'));
	if(garantiaLiquida == 'S'){
		agregaLinea("Ahorro Voluntario: "+alinearDato(impresionPagoCredGrupal.montoGarantia,8,'$'));
	}
	...
	agregaLinea("----------------------------" );
	agregaLinea("TOTAL:     "+alinearDato(cantidadFormatoMoneda(montoTotal,''),16,'$'));
...
function imprimeTicketTransferencia(impresionTransfCuenta){
	...
	agregaLinea(tituloOperacion);
	agregaSaltoLinea(1);
	agregaLinea("Socio: "+impresionTransfCuenta.clienteID);
