$(document).ready(function() {
	...
	$('#imprimirDetalle').click(function() {	
		...
		$('#ligaPDF').attr('href','RepPDFCreditoAsig.htm?institutFondeoID='+i+'&nombreInstitFon='+n+'&lineaFondeoID='+lf+'&descripLinFon='+dl+
			'&creditoFondeoID='+cf+'&saldoCreditoFon='+sc+'&fechaIniCredFon='+fi+'&usuarioAsigna='+usuario+'&fechaAsignacion='+fas+'&tipoReporte='+tipoReporte);
		agregaFormatoControles('formaGenerica');
		agregaFormatoControles('gridCredFonAsig');
	});
