$(document).ready(function(){
	...
	function generaExcel() {
		...
		if($('#excel').is(':checked')){	
			...
			$('#ligaGenerar').attr('href','segtoCampoRep.htm?fechaInicio='+fechaInicio+'&fechaFin='+fechaFin
				  +'&categoriaID='+categoria+'&plazaID='+plaza+'&sucursalID='+sucursal+'&prodCreditoID='+prodCred+'&ejecutorID='+gestor
				  +'&supervisorID='+supervisor+'&resultadoID='+resultado+'&recomendacionID='+recomendacion+'&municipioID='+municipio
				  +'&nomInstitucion='+nomInstitucion+'&fechaEmision='+fechaEmision+'&nomUsuario='+nomUsuario+'&tipoReporte='+tipoReporte
				  +'&tipoLista='+tipoLista+'&categoriaDesc='+categoriaDesc+'&plazaDesc='+plazaDesc+'&sucursalDesc='+sucursalDesc 
				  +'&prodCreditoDesc='+prodCreditoDesc+'&gestorDesc='+gestorDesc+'&supervisorDesc='+supervisorDesc+'&resultadoDesc='+resultadoDesc
	...
	function generaPDF() {
		if($('#pdf').is(':checked')){	
			...
			$('#ligaGenerar').attr('href','segtoCampoRep.htm?fechaInicio='+fechaInicio+'&fechaFin='+fechaFin+'&categoriaID='
					  +categoria+'&plazaID='+plaza+'&sucursalID='+sucursal+'&prodCreditoID='+prodCred+'&ejecutorID='+gestor
					  +'&supervisorID='+supervisor+'&resultadoID='+resultado+'&recomendacionID='+recomendacion+'&municipioID='+municipio
					  +'&nomInstitucion='+nomInstitucion+'&fechaEmision='+fechaEmision+'&nomUsuario='+nomUsuario+'&tipoReporte='
					  +tipoReporte+'&numeroReporte='+numeroReporte +'&categoriaDesc='+categoriaDesc+'&plazaDesc='+plazaDesc+'&sucursalDesc='
					  +sucursalDesc+'&prodCreditoDesc='+prodCreditoDesc+'&gestorDesc='+gestorDesc+'&supervisorDesc='+supervisorDesc+'&resultadoDesc='
					  +resultadoDesc+'&recomendaDesc='+recomendaDesc);
					}
				}
