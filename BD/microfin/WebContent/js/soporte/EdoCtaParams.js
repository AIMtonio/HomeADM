...
$(document).ready(function() {
	...
	var Enum_Tran_EdoCtaParams={			  
			  'modificar':1			  
	};
	var Enum_Con_EdoCtaParams={
		'consultaPrincipal':1
	};

	$('#rutaCBB').attr('maxlength',100);
	$('#rutaCFDI').attr('maxlength',100);
	$('#rutaExpPDF').attr('maxlength',250);	
	$('#rutaReporte').attr('maxlength',250);
	$('#direccionUEAU').attr('maxlength',500);
	$('#horarioUEAU').attr('maxlength',300);
	$('#rutaLogo').attr('maxlength',100);
	...
	$('#modifica').click(function() {		
		$('#tipoTransaccion').val(Enum_Tran_EdoCtaParams.modificar);
	});
...
function cargaAutomatica(){	
	edoCtaParamsServicio.consulta(1,function (EdoCta){
			if(EdoCta!=null){						
