...
-- ---------------------------------------------------------------------------------
-- FNGENNOMBRECOMPCARGALIS
DELIMITER ;
DROP FUNCTION IF EXISTS `FNGENNOMBRECOMPCARGALIS`;DELIMITER $$

CREATE FUNCTION `FNGENNOMBRECOMPCARGALIS`(
/*Funcion que genera el nombre completo*/
	Par_PrimerNombre			VARCHAR(100),		# Primer nombre de la persona
	Par_SegundoNombre			VARCHAR(100),		# Segundo nombre de la persona
	Par_TercerNombre			VARCHAR(100),		# Tercer nombre de la persona
	Par_ApellidoPaterno			VARCHAR(100),		# Apellido paterno de la persona
	Par_ApellidoMaterno			VARCHAR(100)		# Apellido materno de la persona
...
BEGIN
	...
	DECLARE Var_NomCompleto			VARCHAR(500);		# Nombre completo
