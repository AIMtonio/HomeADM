...
-- FNAPORTMONTOGLOBAL
DELIMITER ;
DROP FUNCTION IF EXISTS `FNAPORTMONTOGLOBAL`;DELIMITER $$

CREATE FUNCTION `FNAPORTMONTOGLOBAL`(
/* CALCULA EL MONTO GLOBAL DE LOS PRODUCTOS VIGENTES Y/O DEL GPO. FAMILIAR DE UN CLIENTE. */
