...
-- ---------------------------------------------------------------------------------
-- FNCOMISIONANUALCREDCONT
DELIMITER ;
DROP FUNCTION IF EXISTS `FNCOMISIONANUALCREDCONT`;DELIMITER $$

CREATE FUNCTION `FNCOMISIONANUALCREDCONT`(
	/*Funcion para calcula el monto de comisión por anualidad contingentes*/
