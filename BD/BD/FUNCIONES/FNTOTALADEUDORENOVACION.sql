DELIMITER ;
DROP FUNCTION IF EXISTS `FNTOTALADEUDORENOVACION`;
DELIMITER $$

CREATE FUNCTION `FNTOTALADEUDORENOVACION`(
-- ===================================================================================
-- FUNCION PARA EL CALCULO DEL TOTAL DE LA DEUDA DEL CREDITO QUE SE ESTA RENOVANDO
-- ===================================================================================
    Par_CreditoID   BIGINT(12)    -- CREDITO QUE SE ESTA RENOVANDO
