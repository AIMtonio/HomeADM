-- INDICENAPRECONSMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `INDICENAPRECONSMOD`;
DELIMITER $$

CREATE PROCEDURE `INDICENAPRECONSMOD`(
# ============================================================================
...
# ============================================================================
	...
	ManejoErrores: BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al
						concretar la operacion. Disculpe las molestias que ', 'esto le ocasiona. Ref: SP-INDICENAPRECONSMOD');
		...
		-- Se actualizan los campos de la tabla INDICENAPRECONS
		UPDATE INDICENAPRECONS SET
			ValorINPC		= Par_ValorINPC,
			FechaFinMes		= Var_FecFinal,
