...
-- BALANZACONTA017REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA017REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA017REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: DESARROLLOS ORIENTADOS A EFICIENCIA SA DE CV
...
TerminaStore: BEGIN
	...
	CREATE TEMPORARY TABLE TMPCUENTASMAYOR(
		...
		KEY `INDEX_TMPCUENTASMAYOR_1` (`CuentaCompleta`)); -- IALDANA
	...
	SELECT Aud_NumTransaccion, Cue.CuentaCompleta,
		   ...
		   CASE WHEN Cue.Grupo = Tip_Encabezado AND Var_NumSegConta = 1
					 AND Cue.CuentaCompleta NOT IN ('100110000000', '400103100000',
					 								'400201100000', '400201200000',
					 								'21000000000',  '1800000000',
					 								'1700000000',   '1100000000') THEN
	...
	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '100110'
	WHERE CuentaCompleta = '100110000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '40010310'
	WHERE CuentaCompleta = '400103100000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '40020110'
	WHERE CuentaCompleta = '400201100000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '40020120'
	WHERE CuentaCompleta = '400201200000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '540010'
	WHERE CuentaCompleta = '21000000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '1800'
	WHERE CuentaCompleta = '1800000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '1700'
	WHERE CuentaCompleta = '1700000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '1100'
	WHERE CuentaCompleta = '1100000000'
	  AND NumTransaccion = Aud_NumTransaccion;
