...
-- INVERCANCELADIAREP
DELIMITER ;
DROP PROCEDURE IF EXISTS `INVERCANCELADIAREP`;DELIMITER $$

CREATE PROCEDURE `INVERCANCELADIAREP`(
...
Set Estatus_Cancelado		:='C';
    ...
    set Var_Sentencia :=  CONCAT(Var_Sentencia, ' where I.FechaInicio = ? and I.Estatus ="',Estatus_Cancelado,'" order by S.SucursalID, I.TipoInversionID, P.PromotorID, C.ClienteID,I.InversionID  ;');
   ...
   SET @Sentencia	= (Var_Sentencia);
	SET @Fecha	= Par_FechaInicio;
      ...
      PREPARE SINVERCANCELADIAREP FROM @Sentencia;
      EXECUTE SINVERCANCELADIAREP USING @Fecha;
      DEALLOCATE PREPARE SINVERCANCELADIAREP;
