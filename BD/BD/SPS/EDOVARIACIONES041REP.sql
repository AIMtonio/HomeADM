...
-- ---------------------------------------------------------------------------------
-- EDOVARIACIONES041REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOVARIACIONES041REP`;

DELIMITER $$
CREATE PROCEDURE `EDOVARIACIONES041REP`(
	-- SP para generar el Estado de Variacion de Capital MEXI - MAAKELAR
