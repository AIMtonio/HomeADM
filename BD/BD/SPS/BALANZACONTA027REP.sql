...
-- BALANZACONTA027REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA027REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA027REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: TERNA DE REYES SCAP. DE RL DE C.V.
