...
-- ---------------------------------------------------------------------------------
-- CRCBCLIENTESWSALTCARGAMASIVA
DELIMITER ;
DROP PROCEDURE IF EXISTS `CRCBCLIENTESWSALTCARGAMASIVA`;

DELIMITER $$
CREATE PROCEDURE `CRCBCLIENTESWSALTCARGAMASIVA`(
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-CRCBCLIENTESWSALTCARGAMASIVA');
			END;
			...
			SET Par_NumClien := Var_ClienteID;
