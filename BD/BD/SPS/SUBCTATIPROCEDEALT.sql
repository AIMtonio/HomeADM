...
-- SUBCTATIPROCEDEALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTATIPROCEDEALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTATIPROCEDEALT`(
# ===============================================================
# ------ SP PARA REGISTRAR LAS SUBCUENTAS DE TIPOS DE CEDES------
# ===============================================================
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
										'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTATIPROCEDEALT');
			END;
		...
		INSERT INTO SUBCTATIPROCEDE(
			ConceptoCedeID,		TipoCedeID,		SubCuenta,		EmpresaID,		Usuario,
            FechaActual,		DireccionIP,	ProgramaID,		Sucursal,		NumTransaccion)
		VALUES (
			Par_ConceptoCedeID,	Par_TipoCedeID,	Par_SubCuenta,	Aud_EmpresaID,	Aud_Usuario,
