...
-- PARAMETROSESCALAMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `PARAMETROSESCALAMOD`;DELIMITER $$

CREATE PROCEDURE `PARAMETROSESCALAMOD`(
...
ManejoErrores:BEGIN
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
            ...
            SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-PARAMETROSESCALAMOD');
    ...
    CALL HISPARAMETROSESCALAALT(
		Par_FolioID,		Par_TipoPersona,	Par_TipoInstrumento,	Par_NacMoneda,		SalidaNO,
    ...
    UPDATE PARAMETROSESCALA SET
		TipoPersona 	= Par_TipoPersona,
        TipoInstrumento	= Par_TipoInstrumento,
        NacMoneda		= Par_NacMoneda,
        LimiteInferior	= Par_LimiteInferior,
		MonedaComp		= Par_MonedaComp,

        RolTitular		= Par_RolTitular,
        RolSuplente		= Par_RolSuplente,
