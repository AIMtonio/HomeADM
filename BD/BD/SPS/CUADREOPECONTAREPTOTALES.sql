...
-- ---------------------------------------------------------------------------------
-- CUADREOPECONTAREPTOTALES
DELIMITER ;
DROP PROCEDURE IF EXISTS `CUADREOPECONTAREPTOTALES`;DELIMITER $$

CREATE PROCEDURE `CUADREOPECONTAREPTOTALES`(
    Par_Fecha           DATE,
    Par_TipoReporte     INT,
...
IF(Par_TipoReporte = Tipo_Inversiones) THEN
    ...
    ELSE
        ...
        SELECT var_SalTotalInvOpera,var_SalTotalInvConta;
...
IF(Par_TipoReporte = Tipo_InvEnGarantia) THEN
    ...
    ELSE
        ...
        IF(IFNULL(var_Operativo_InvGarantia,Entero_Cero) <> IFNULL(var_Conta_InvGarantia,Entero_Cero)) THEN
            ...
            SELECT var_Operativo_InvGarantia, var_Operativo_InvGarantia;
        END IF;
    ...
    ELSE
        ...
        IF(IFNULL(var_Ope_SinGravamen,Entero_Cero) <> IFNULL(Var_Conta_SinGravamen,Entero_Cero) OR
            ...
            ELSE
                ...
                SELECT var_Ope_SinGravamen,Var_Conta_SinGravamen,var_Ope_ConGravamen,var_Conta_ConGravamen;
        END IF;
