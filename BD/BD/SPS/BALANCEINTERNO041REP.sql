...
-- ---------------------------------------------------------------------------------
-- BALANCEINTERNO041REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANCEINTERNO041REP`;

DELIMITER $$
CREATE PROCEDURE `BALANCEINTERNO041REP`(
	-- SP para generar el Balance General MEXI - MAAKELAR
