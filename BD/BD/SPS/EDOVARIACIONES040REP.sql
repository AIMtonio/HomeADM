...
-- ---------------------------------------------------------------------------------
-- EDOVARIACIONES040REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOVARIACIONES040REP`;

DELIMITER $$
CREATE PROCEDURE `EDOVARIACIONES040REP`(
	-- SP para generar el Estado de Variacion de Capital MEXI - PREVICREM
