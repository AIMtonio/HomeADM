...
-- ---------------------------------------------------------------------------------
-- CUENTASMAYORARRENDABAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `CUENTASMAYORARRENDABAJ`;DELIMITER $$

CREATE PROCEDURE `CUENTASMAYORARRENDABAJ`(
    ...
    ManejoErrores:BEGIN
        DECLARE EXIT HANDLER FOR SQLEXCEPTION
            BEGIN
                ...
                SET Par_ErrMen  = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
                                                        'Disculpe las molestias que esto le ocasiona. Ref: SP-CUENTASMAYORARRENDABAJ');
        ...
        DELETE FROM  CUENTASMAYORARRENDA WHERE ConceptoArrendaID = Par_ConceptoArrendaID;

        SET Par_NumErr      := 000;
        SET Var_Control     := 'conceptoArrendaID';
        SET Par_ErrMen      := CONCAT('Cuenta Mayor Eliminada Exitosamente: ',Par_ConceptoArrendaID);
