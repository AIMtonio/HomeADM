...
-- ---------------------------------------------------------------------------------
-- EDOFLUJOEFECTIVO038REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOFLUJOEFECTIVO038REP`;

DELIMITER $$
CREATE PROCEDURE `EDOFLUJOEFECTIVO038REP`(
	-- SP para generar el Flujo de Efectivo MEXI - VIGUA
	-- Modulo Contabilidad
