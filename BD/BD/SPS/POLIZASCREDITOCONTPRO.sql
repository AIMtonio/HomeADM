...
-- ---------------------------------------------------------------------------------
-- POLIZASCREDITOCONTPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `POLIZASCREDITOCONTPRO`;
DELIMITER $$

CREATE PROCEDURE `POLIZASCREDITOCONTPRO`(
# ==================================================================
# --SP para alta de poliza contable de los creditos contingentes ---
# ==================================================================
	...
	ManejoErrores:
		BEGIN
			DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
				...
				SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
					'Disculpe las molestias que esto le ocasiona. Ref: SP-POLIZASCREDITOCONTPRO');
		...
		ELSE
			...
			IF LOCATE(For_Fondeador, Var_Cuenta) > 0 THEN
				...
				SELECT InstitFondeoID INTO Var_InstitFondeoID FROM CREDITOSCONT WHERE CreditoID	= Par_CreditoID;
