...
-- PROYECCIONINDICAMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `PROYECCIONINDICAMOD`;DELIMITER $$

CREATE PROCEDURE `PROYECCIONINDICAMOD`(
# =====================================================================================
# ------- STORED PARA LA MODIFICACION DE LOS INDICADORES DE PROYECCION
# =====================================================================================
	...
	ManejoErrores:BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
							'esto le ocasiona. Ref: SP-PROYECCIONINDICAMOD');
        ...
        UPDATE PROYECCIONINDICA SET
			SaldoTotal 		= Par_SaldoTotal,
            SaldoFira 		= Par_SaldoFira,
            GastosAdmin 	= Par_GastosAdmin,
            CapitalConta 	= Par_CapitalConta,
            UtilidadNeta 	= Par_UtilidadNeta,
            ActivoTotal 	= Par_ActivoTotal,
            SaldoVencido	= Par_SaldoVencido
