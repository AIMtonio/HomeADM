...
-- BALANZACONTA006REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA006REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA006REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: VAMOS CON LA BOLSA, S.C. de A.P. de R.L. DE C.V.
