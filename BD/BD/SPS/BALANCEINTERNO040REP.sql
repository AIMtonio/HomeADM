...
-- ---------------------------------------------------------------------------------
-- BALANCEINTERNO040REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANCEINTERNO040REP`;

DELIMITER $$
CREATE PROCEDURE `BALANCEINTERNO040REP`(
	-- SP para generar el Balance General MEXI - PREVICREM
