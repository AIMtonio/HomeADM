...
-- SUBCTASUCURSDIVALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTASUCURSDIVALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTASUCURSDIVALT`(
...
if(ifnull(Par_SubCuenta, Entero_Cero))= Entero_Cero then
	...
	insert into SUBCTASUCURSDIV (
				ConceptoMonID,		SucursalID, 	SubCuenta,		EmpresaID,		Usuario,
				FechaActual,		DireccionIP,	ProgramaID,		Sucursal,		NumTransaccion)
		values	(Par_ConceptoMonID,	Par_SucursalID,	Par_SubCuenta,	Par_EmpresaID,	Aud_Usuario,
