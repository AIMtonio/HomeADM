...
-- PAGCRECOMFALPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `PAGCRECOMFALPRO`;
DELIMITER $$

CREATE PROCEDURE `PAGCRECOMFALPRO`(
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
	               			 'Disculpe las molestias que esto le ocasiona. Ref: SP-PAGCRECOMFALPRO');
