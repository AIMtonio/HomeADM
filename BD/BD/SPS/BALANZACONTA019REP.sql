...
-- BALANZACONTA019REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA019REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA019REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: TMF BUSINESS PROCESS OUTSOURCING. S. de R.L. DE C.V.
