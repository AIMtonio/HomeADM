...
-- BALANZACONTA008REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA008REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA008REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: KIWI CAPITAL SAPI DE C.V.
