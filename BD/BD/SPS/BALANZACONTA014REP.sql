...
-- BALANZACONTA014REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA014REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA014REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: TU LANITA RAPIDA S.A. DE C.V. SOFOM ENR.
