...
-- SUBCTAPLAZOCEDEMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAPLAZOCEDEMOD`;DELIMITER $$

CREATE PROCEDURE `SUBCTAPLAZOCEDEMOD`(
# ===============================================================
# ------ SP PARA MODIFICAR LAS SUBCUENTAS DE PLAZOS DE CEDES-----
# ===============================================================
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
										'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTAPLAZOCEDEMOD');
			END;
