...
-- SUBCTAINSTINVBANALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAINSTINVBANALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTAINSTINVBANALT`(
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTAINSTINVBANALT');
		...
		INSERT INTO SUBCTAINSTINVBAN(
			ConceptoInvBanID,		InstitucionID, 	SubCuenta,			EmpresaID,		Usuario,
			FechaActual,			DireccionIP,	ProgramaID,			Sucursal,		NumTransaccion)
		VALUES(
			Par_ConceptoInvBanID,	Par_InstitucionID, 		Par_SubCuenta,	Aud_EmpresaID,		Aud_Usuario,
