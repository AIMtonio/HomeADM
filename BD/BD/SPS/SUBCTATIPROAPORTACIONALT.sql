...
-- ---------------------------------------------------------------------------------
-- SUBCTATIPROAPORTACIONALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTATIPROAPORTACIONALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTATIPROAPORTACIONALT`(
# =======================================================================
# ------ SP PARA REGISTRAR LAS SUBCUENTAS DE TIPOS DE APORTACIONES ------
# =======================================================================
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
										'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTATIPROAPORTACIONALT');
			END;
		...
		INSERT INTO SUBCTATIPROAPORTACION(
			ConceptoAportID,	TipoAportacionID,	SubCuenta,		EmpresaID,		Usuario,
            FechaActual,			DireccionIP,		ProgramaID,		Sucursal,		NumTransaccion)
		VALUES (
			Par_ConceptoAportacionID,	Par_TipoAportacionID,	Par_SubCuenta,	Aud_EmpresaID,	Aud_Usuario,
