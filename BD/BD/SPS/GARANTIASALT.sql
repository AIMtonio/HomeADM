...
-- GARANTIASALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `GARANTIASALT`;

DELIMITER $$
CREATE PROCEDURE `GARANTIASALT`(
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al
									concretar la operacion. Disculpe las molestias que ', 'esto le ocasiona. Ref: SP-GARANTIASALT');
