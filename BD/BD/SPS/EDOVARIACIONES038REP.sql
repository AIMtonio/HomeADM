...
-- ---------------------------------------------------------------------------------
-- EDOVARIACIONES038REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOVARIACIONES038REP`;

DELIMITER $$
CREATE PROCEDURE `EDOVARIACIONES038REP`(
	-- SP para generar el Estado de Variacion de Capital MEXI - VIGUA
