...
-- BALANZACONTA011REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA011REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA011REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: MAS ALTERNATIVA MEXICO S.A. DE C.V. SOFOM ENR.
