...
-- SUBCTARESTINVBANBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTARESTINVBANBAJ`;DELIMITER $$

CREATE PROCEDURE `SUBCTARESTINVBANBAJ`(
    ...
    ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTARESTINVBANBAJ');
		...
		IF NOT EXISTS( SELECT ConceptoInvBanID FROM SUBCTARESTINVBAN 	WHERE ConceptoInvBanID=Par_ConceptoInvBanID) THEN
				Set Par_NumErr	:= '002';
