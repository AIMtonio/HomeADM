...
-- REGULATORIOB1523REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOB1523REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOB1523REP`(
	/* Genera la llamada al regulatorio B1523 para Sofipo o Socap */
	...
	SET NumReporte			:= 'B1523';				-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
