...
-- CINTAINTFMENSUALSUSP024PRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `CINTAINTFMENSUALSUSP024PRO`;
DELIMITER $$


CREATE PROCEDURE `CINTAINTFMENSUALSUSP024PRO`(
...
TerminaStore: BEGIN
  ...
  CREATE TABLE TMPDATOSCTESCREDPAG(
    ...
    FechaDefuncion CHAR(8), IndicadorDefuncion CHAR(1),  CalleNumero     VARCHAR(100), Colonia     VARCHAR(200),
  ...
  INDEX TMPDATOSCTESCREDPAG3 (CreditoIDSAFI));
    ...
    Cadena_Vacia AS FechaDefuncion,     Cadena_Vacia AS IndicadorDef,
  ...
  INSERT INTO TMPFECHACIERREBC
    ...
    UPDATE TMPDATOSCTESCREDPAG TMPD, CARCREDITOSUSPENDIDO CC
    ...
    UPDATE TMPDATOSCTESCREDPAG Dat SET
		Cinta = CONCAT_WS(Separador,
            ...
            IFNULL(Dat.Sexo,Cadena_Vacia),					IFNULL(Dat.FechaDefuncion,Cadena_Vacia),        IFNULL(Dat.IndicadorDefuncion,Cadena_Vacia),	IFNULL(Dat.CalleNumero,Cadena_Vacia),			IFNULL(Dat.DirComplemento,Cadena_Vacia),
