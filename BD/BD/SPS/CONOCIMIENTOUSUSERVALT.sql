-- SP CONOCIMIENTOUSUSERVALT

DELIMITER ;
DROP PROCEDURE IF EXISTS `CONOCIMIENTOUSUSERVALT`;

DELIMITER $$
CREATE PROCEDURE `CONOCIMIENTOUSUSERVALT`(
    -- Stored procedure para dar de alta conocimientos del usuario de servicios.
    ...
    ManejoErrores: BEGIN
        ...
        DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen := LEFT(CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
				'esto le ocasiona. Ref: SP-CONOCIMIENTOUSUSERVALT','[',@Var_SQLState,'-' , @Var_SQLMessage,']'), 400);
        ...
        IF(IFNULL(Var_UsuarioID, Entero_Cero) > Entero_Cero) THEN
            SET Par_NumErr  := 3;
            SET Par_ErrMen  := 'Los conocimientos del usuario de servicios ya estaban registrados.';
            SET Var_Control := 'UsuarioID';
            LEAVE ManejoErrores;
        END IF;
        ...
        INSERT INTO CONOCIMIENTOUSUSERV (
            ...
            Par_UsuarioServicioID,      Par_NombreGrupo,         Par_RFC,                    Par_Participacion,       Par_Nacionalidad,
            Par_RazonSocial,            Par_Giro,                Par_AniosOperacion,         Par_AniosGiro,           Par_PEPs,
            Par_FuncionID,              Par_FechaNombramiento,   Par_PorcentajeAcciones,     Par_PeriodoCargo,        Par_MontoAcciones,
            Par_ParentescoPEP,          Par_NombreFamiliar,      Par_APaternoFamiliar,       Par_AMaternoFamiliar,    Par_NumeroEmpleados,
            Par_ServiciosProductos,     Par_CoberturaGeografica, Par_EstadosPresencia,       Par_ImporteVentas,       Par_Activos,

            Par_Pasivos,                Par_CapitalContable,     Par_CapitalNeto,            Par_Importa,             Par_DolaresImporta,
            Par_PaisesImporta1,         Par_PaisesImporta2,      Par_PaisesImporta3,         Par_Exporta,             Par_DolaresExporta,
            Par_PaisesExporta1,         Par_PaisesExporta2,      Par_PaisesExporta3,         Par_TiposClientes,       Par_InstrMonetarios,
            Par_NombreRefCom1,          Par_NoCuentaRefCom1,     Par_DireccionRefCom1,       Par_TelefonoRefCom1,     Par_ExtTelefonoRefCom1,
            Par_NombreRefCom2,          Par_NoCuentaRefCom2,     Par_DireccionRefCom2,       Par_TelefonoRefCom2,     Par_ExtTelefonoRefCom2,

            Par_BancoRefBanc1,          Par_TipoCuentaRefBanc1,  Par_NoCuentaRefBanc1,       Par_SucursalRefBanc1,    Par_NoTarjetaRefBanc1,
            Par_InstitucionRefBanc1,    Par_CredOtraEntRefBanc1, Par_InstitucionEntRefBanc1, Par_BancoRefBanc2,       Par_TipoCuentaRefBanc2,
            Par_NoCuentaRefBanc2,       Par_SucursalRefBanc2,    Par_NoTarjetaRefBanc2,      Par_InstitucionRefBanc2, Par_CredOtraEntRefBanc2,
            Par_InstitucionEntRefBanc2, Par_NombreRefPers1,      Par_DomicilioRefPers1,      Par_TelefonoRefPers1,    Par_ExtTelefonoRefPers1,
            Par_TipoRelacionRefPers1,   Par_NombreRefPers2,      Par_DomicilioRefPers2,      Par_TelefonoRefPers2,    Par_ExtTelefonoRefPers2,

            Par_TipoRelacionRefPers2,   Par_PreguntaUsuario1,    Par_RespuestaUsuario1,      Par_PreguntaUsuario2,    Par_RespuestaUsuario2,
            Par_PreguntaUsuario3,       Par_RespuestaUsuario3,   Par_PreguntaUsuario4,       Par_RespuestaUsuario4,   Par_PrincipalFuenteIng,
            Par_IngAproxPorMes,         Cons_Si,                 Cadena_Vacia,               Aud_EmpresaID,           Aud_Usuario,
        ...
        SET Par_NumErr  := 0;
	    SET Par_ErrMen  := CONCAT("Conocimiento del usuario de servicios agregado exitosamente: ", CONVERT(Par_UsuarioServicioID, CHAR));
	    SET Var_Control := 'usuarioID';
