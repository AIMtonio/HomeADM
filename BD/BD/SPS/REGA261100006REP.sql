...
-- REGA261100006REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGA261100006REP`;DELIMITER $$

CREATE PROCEDURE `REGA261100006REP`(
	/* Genera el regulatorio A2611 para Socap */
...
IF Par_NumRep = Rep_Excel THEN
	...
	RFCCOmisionista,				PersJuridicaComi,					ActividadComision,	OperaContratadas,	CausaBaja
