...
-- ---------------------------------------------------------------------------------
-- PAGCRECOMANUALCONTPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `PAGCRECOMANUALCONTPRO`;DELIMITER $$

CREATE PROCEDURE `PAGCRECOMANUALCONTPRO`(
/*SP para realizar las afectaciones contables de comision por anualidad de credito contingente*/
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-PAGCRECOMANUALCONTPRO');
