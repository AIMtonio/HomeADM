...
-- ---------------------------------------------------------------------------------
-- INFORMACIONADICACREDALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `INFORMACIONADICACREDALT`;
DELIMITER $$


CREATE PROCEDURE `INFORMACIONADICACREDALT`(
	/*SP para dar de alta la informacion adicional de los clientes acreditados*/
	...
	ManejoErrores: BEGIN
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen		:= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-INFORMACIONADICACREDALT');
		...
		SET Par_FechEdoFinanVentNet := IFNULL(Par_FechEdoFinanVentNet,Entero_Cero);
		...
		IF(Var_MostrarPantalla = 1) THEN
			INSERT INTO INFORMACIONADICFIRA (
				Activocirc,					Activosprod,			Asrtot,						Anioingresobruto,		Carteracredito,
				Carteraneta,				Carteravenc,			Clientes,					Compaccion,				Competencia,
				Consejoadmon,				Contaguber,				Depbienes,					Emisiontit,				Entregulada,
				Estrucorganiz,				Fechaedosfin,			Fechaedosfinvn,				Fondeotot,				Gastosadmon,
				Gastosfin,					Ingresobruto,			Ingresostotales,			Margenfin,				Nivelpoliticas,
				Numempleados,				Numlineas,				Pasivocirc,					Pasivoexigible,			Pasivolargo,
				Edosfinaud,					Gobiernocorp,			Proveedores,				Roe,					Retlab1,
				Retlab2,					Retlab3,				Tipoentidad,				Uafir,					Utilidadneta,
				Califexterna,				ClienteID,				Eprc,						NumFuentes,				SaldoAcreditados,
				NumConsejerosInd,			NumConsejerosTot,		PorcParticipacionAcc,		Capitalcontableagd,
				Aniosexp,		EmpresaID,					Usuario,				FechaActual,
				DireccionIP,				ProgramaID,				Sucursal,					NumTransaccion)
			VALUES (
				Par_ActivoCirculante,		Par_ActivoProductivos,	Par_ActivoSujetosRiesgo,	Par_AnioIngresosBruto,		Par_CarteraCredito,
				Par_CarteraNeta,			Par_CarteraVencida,		Par_Clientes,				Par_CompAccionaria,			Par_Competencia,
				Par_ConsejoAdmin,			Par_CumpleContaGuberna,	Par_DepositoDeBienes,		Par_EmisionTitulos,			Par_EntidadRegulada,
				Par_EstructOrgan,			Par_FechaEdoFinan,		Par_FechEdoFinanVentNet,	Par_FondeoTotal,			Par_GastosAdmin,
				Par_GastosFinan,			Par_IngresosBrutos,		Par_IngresosTotales,		Par_MargenFinan,			Par_NivelPoliticas,
				Par_NumeroEmpleados,		Par_NumeroLineasNeg,	Par_PasivoCirculante,		Par_PasivoExigible,			Par_PasivoLargoPlazo,
				Par_PeriodoAudEdos,			Par_ProcesoAuditoria,	Par_Proveedores,			Par_ROE,					Par_TasaRetLaboral1,
				Par_TasaRetLaboral2,		Par_TasaRetLaboral3,	Par_TipoEntidad,			Par_UtilAntGastImpues,		Par_UtilidaNeta,
				Par_CalificacionExterna,	Par_Acreditado,			Par_EPRC,					Par_NumFuentes,				Par_SaldosAcreditados,
				Par_NumConsejerosInd,		Par_NumConsejerosTot,	Par_PorcParticipacionAcc,	Par_CapitalContable,
				Par_ExpLaboral,	 	Aud_EmpresaID,				Aud_Usuario,				Aud_FechaActual,
		  ...
		  ELSEIF(Var_MostrarPantalla = 2) THEN
			INSERT INTO INFORMACIONADICFIRA (
				Activocirc,					Activosprod,				Asrtot,						Anioingresobruto,			Carteracredito,
				Carteraneta,				Carteravenc,				Clientes,					Compaccion,					Competencia,
				Consejoadmon,				Contaguber,					Depbienes,					Emisiontitagd,				Entregulada,
				Estrucorganiz,				Fechaedosfinagd,			Fechaedosfinvn,				Fondeotot,					Gastosadmonagd,
				Gastosfin,					Ingresostotagd,				Ingresostotales,			Margenfin,					Nivelpoliticas,
				Numempleados,				Numlineas,					Pasivocirc,					Pasivoexigible,				Pasivolargo,
				Edosfinaud,					Gobiernocorp,				Proveedores,				Roeagd,						Retlab1,
				Retlab2,					Retlab3,					Tipoentidad,				Uafir,						Utilidadnetaagd,
				Califexterna,				ClienteID,					Eprc,						NumFuentes,					SaldoAcreditados,
				NumConsejerosInd,			NumConsejerosTot,			PorcParticipacionAcc,		Capitalcontableagd,
				Aniosexp,		EmpresaID,					Usuario,				FechaActual,
				DireccionIP,				ProgramaID,					Sucursal,					NumTransaccion
		  ...
		  ELSEIF(Var_MostrarPantalla = 3) THEN
			INSERT INTO INFORMACIONADICFIRA (
				Activocirc,						Activosprod,				Asrtot,						Anioingresobrutom,		Carteracredito,
				Carteraneta,					Carteravenc,				Clientes,					Compaccion,				Competencia,
				Consejoadmon,					Contaguber,					Depbienes,					Emisiontitagd,			Entregulada,
				Estrucorganiz,					Fechaedosfinm,				Fechaedosfinvn,				Fondeotot,				Gastosadmonagd,
				Gastosfin,						Ingresobrutom,				Ingresostotales,			Margenfin,				Nivelpoliticas,
				Numempleadosm,					Numlineas,					Pasivocirc,					Pasivoexigible,			Pasivolargo,
				Edosfinaudm,					Gobiernocorp,				Proveedores,				Roem,					Retlab1m,
				Retlab2m,						Retlab3m,					Tipoentidad,				Uafir,					Utilidadnetam,
				Califexterna,					ClienteID,					Eprc,						NumFuentes,				SaldoAcreditados,
				NumConsejerosInd,				NumConsejerosTot,			PorcParticipacionAcc,		Capitalcontableagd,
				Aniosexp,		EmpresaID,					Usuario,				FechaActual,
				DireccionIP,					ProgramaID,					Sucursal,					NumTransaccion
		...
		SET	Par_NumErr		:= 000;
		SET	Par_ErrMen		:= CONCAT('Informaci&oacute;n Adicional Agregada Exitosamente.');
