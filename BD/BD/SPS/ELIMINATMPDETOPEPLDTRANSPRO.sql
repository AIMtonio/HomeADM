-- ELIMINATMPDETOPEPLDTRANSPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `ELIMINATMPDETOPEPLDTRANSPRO`;
DELIMITER $$

CREATE PROCEDURE `ELIMINATMPDETOPEPLDTRANSPRO`(
-- ================================================================================================================
-- ---- STORED ELIMINA REGISTROS DE TABLAS TEMPORALES DE DETECCION DE OPERACIONES INUSUALES PLD POR TRANSACCION ---
-- ================================================================================================================
	...
	ManejoErrores:BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
							'esto le ocasiona. Ref: SP-ELIMINATMPDETOPEPLDTRANSPRO');
			SET Var_Control = 'sqlException';
		END;
        
		-- ELIMINA REGISTROS TEMPORALES QUE QUEDARAN DEL PROCESO PLDOPEREELEVANTRANSPRO
		...
		DELETE FROM TMPPLDDEPEFETRANRESUL;
  		...
  		-- ELIMINA REGISTROS TEMPORALES QUE QUEDARAN DEL PROCESO PLDOPEINUSALERTTRANSPRO
		...
		SET Par_NumErr 		:= 0;
		SET Par_ErrMen 		:= 'Eliminacion de Registros Realizada Exitosamente.';
		SET Var_Control		:= '';
