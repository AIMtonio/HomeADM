...
-- ---------------------------------------------------------------------------------
-- CONTACAMBIOSUCURSALPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `CONTACAMBIOSUCURSALPRO`;
DELIMITER $$


CREATE PROCEDURE `CONTACAMBIOSUCURSALPRO`(
...
TerminaStore:BEGIN
    ...
    DECLARE Var_SaldoIntAtrasa      DECIMAL(14,2);
    ...
    DECLARE DescripcionCred         VARCHAR(500);
    DECLARE DescripCredVen          VARCHAR(500);
    ...
    SET Con_ContaRecla        := 17;
    SET Con_InvCapGrava       := 6;
    SET Mov_AhorroNO          := 'N';
    ...
    INSERT INTO TMPCREDITOS (CreditoID,ClienteID,Estatus, ProductoCredito,Clasificacion,
        ...
        SELECT  Cre.CreditoID,Cre.ClienteID,Cre.Estatus,Cre.ProductoCreditoID,
            ...
            WHERE Cre.ClienteID=Par_ClienteID
                AND Cre.Estatus IN(Est_Vigente,Est_Pagado,Est_Cancelado,Est_Castigado,Est_Vencido)
    ...
    IF(Var_InversionIDPol <= Entero_Cero)THEN
        SELECT  IFNULL(CreditoID,Entero_Cero) INTO Var_CreditoIDPol
                    FROM TMPCREDITOS
                    WHERE Estatus IN (Est_Vigente, Est_Castigado, Est_Vencido)
                     LIMIT 1;
    END IF;
    ...
    BEGIN
        ...
        IF Var_MontoAmparado!=Entero_Cero THEN
            IF Par_NatMovimiento=NatCargo THEN
                    ...
                    CALL CONTAINVERSIONPRO(
                        Var_InversionID,    Aud_EmpresaID,      Var_Fecha,          Var_MontoAmparado,  Cadena_Vacia,
                        Con_ContaRecla,     Con_InvCapGrava,    Entero_Cero,        NatCargo,           AltaEncPolNO,
                        Mov_AhorroNO,       Par_PolizaID,       Entero_Cero,        Var_ClienteID,      Var_MonedaBaseID,
                        Aud_Usuario,        Aud_FechaActual,    Aud_DireccionIP,    Aud_ProgramaID,     Aud_Sucursal,
                        Aud_NumTransaccion);
            ELSE
                    ...
                    CALL CONTAINVERSIONPRO(
                        Var_InversionID,    Aud_EmpresaID,      Var_Fecha,          Var_MontoAmparado,  Cadena_Vacia,
                        Con_ContaRecla,     Con_InvCapGrava,    Entero_Cero,        NatAbono,           AltaEncPolNO,
                        Mov_AhorroNO,       Par_PolizaID,       Entero_Cero,        Var_ClienteID,      Var_MonedaBaseID,
                        Aud_Usuario,        Aud_FechaActual,    Aud_DireccionIP,    Aud_ProgramaID,     Aud_Sucursal,
                        Aud_NumTransaccion);
            END IF;
    ...
    BEGIN
        ...
        IF (Var_CreditoID > Entero_Cero) THEN
            IF (Var_EstatusCre  = Est_Vigente) THEN
                ...
                SET Var_SaldoIntAtrasa := (SELECT IFNULL(Cre.SaldoInterAtras,Decimal_Cero)
                                     FROM  CREDITOS  Cre
                                     LEFT JOIN CALRESCREDITOS Cal
                                        ON Cal.CreditoID=Cre.CreditoID
                                        AND Cal.Fecha=Var_FechaEstimacion
                ...
                IF Var_SaldoCapVigente > Decimal_Cero THEN
                    SET DescripcionCred:=CONCAT("CREDITOS CAPITAL VIGENTE - ",Var_CreditoID);
                    ...
                    CALL POLIZACREDITOPRO(
                        ...
                        Var_Abonos,         Var_MonedaBaseID,   DescripcionCred,        ReferenciaCredito,  Par_NumErr,
                        Par_ErrMen,         Entero_Cero,        Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                        Aud_ProgramaID,     Aud_Sucursal,       Aud_NumTransaccion);
                END IF;
                ...
                IF Var_SaldoInterProvi>Decimal_Cero THEN
                        ...
                        CALL POLIZACREDITOPRO(
                            ...
                            Decimal_Cero,       Var_MonedaBaseID,       DescripcionCred,        ReferenciaCredito,  Par_NumErr,
                            Par_ErrMen,         Entero_Cero,            Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                            Aud_ProgramaID,     Aud_Sucursal,           Aud_NumTransaccion);
                        ...
                        CALL POLIZACREDITOPRO(
                            ...
                            Var_SaldoInterProvi,Var_MonedaBaseID,       DescripcionCred,        ReferenciaCredito,  Par_NumErr,
                            Par_ErrMen,         Entero_Cero,            Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                            Aud_ProgramaID,     Aud_Sucursal,           Aud_NumTransaccion);

                END IF;

                IF Var_SaldoIntAtrasa>Decimal_Cero THEN
                    IF Par_NatMovimiento=NatCargo THEN
                        SET Var_Cargos  :=Decimal_Cero;
                        SET Var_Abonos  :=Var_SaldoIntAtrasa;

                    ELSE
                        SET Var_Abonos  :=Decimal_Cero;
                        SET Var_Cargos  :=Var_SaldoIntAtrasa;
                    END IF;
                ...
                IF Var_SaldoResCapital>Decimal_Cero THEN
                        SET DescripcionCred:=CONCAT("EPRC - ",Var_CreditoID);
                        SET ReferenciaCredito:= CONCAT("Cred.",CONVERT(Var_CreditoID, CHAR));
                        CALL POLIZACREDITOPRO(
                            Par_PolizaID,       Aud_EmpresaID,      Var_Fecha,              Var_CreditoID,      Var_ProdCreditoID,
                        ...
                        CALL POLIZACREDITOPRO(
                            ...
                            Var_SaldoResCapital,Var_MonedaBaseID,   DescripcionCred,        ReferenciaCredito,  Par_NumErr,
                            Par_ErrMen,         Entero_Cero,        Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                            Aud_ProgramaID,     Aud_Sucursal,       Aud_NumTransaccion);
                ...
                IF Var_SaldoResInteres>Decimal_Cero THEN
                        ...
                        CALL POLIZACREDITOPRO(
                            ...
                            Var_SaldoResInteres,Var_MonedaBaseID,       DescripcionCred,        ReferenciaCredito,  Par_NumErr,
                            Par_ErrMen,         Entero_Cero,            Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                            Aud_ProgramaID,     Aud_Sucursal,           Aud_NumTransaccion);
                        END IF;
                    END IF;
            ...
            IF (Var_EstatusCre = Est_Vencido) THEN
               ...
               SET Var_SaldoMoratorio :=  (SELECT IFNULL(SaldoMoraVencido,Decimal_Cero)
                ...
                IF (Var_SaldoCapVencido>Decimal_Cero) THEN
                        ...
                        SET DescripCredVen:=CONCAT("CREDITOS CAPITAL VENCIDO - ",Var_CreditoID);
                        SET ReferenciaCredito:=CONCAT("Cred.",CONVERT(Var_CreditoID, CHAR));

                        CALL POLIZACREDITOPRO(
                            Par_PolizaID,       Aud_EmpresaID,      Var_Fecha,              Var_CreditoID,      Var_ProdCreditoID,
                            Par_SucursalOrigen, ConceptoCarCapVen,  Var_Clasificacion,      Var_SubClasifica,   Var_Cargos,
                            Var_Abonos,         Var_MonedaBaseID,   DescripCredVen,         ReferenciaCredito,  Par_NumErr,
                            Par_ErrMen,         Entero_Cero,        Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                            Aud_ProgramaID,     Aud_Sucursal,       Aud_NumTransaccion);
                END IF;
                ...
                IF Var_SaldoResCapital>Decimal_Cero THEN
                        ...
                        END IF;
                            ...
                            CALL POLIZACREDITOPRO(
                                ...
                                Var_Cargos,         Var_MonedaBaseID,   DescripcionCred,        ReferenciaCredito,  Par_NumErr,
                                Par_ErrMen,         Entero_Cero,        Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                                Aud_ProgramaID,     Aud_Sucursal,       Aud_NumTransaccion);
                    ...
                    IF (Var_SaldoIntVencido>Decimal_Cero) THEN
                            ...
                            CALL POLIZACREDITOPRO(
                                ...
                                Var_Cargos,         Var_MonedaBaseID,       DescripCredVen,     ReferenciaCredito,  Par_NumErr,
                                Par_ErrMen,         Entero_Cero,            Aud_Usuario,        Aud_FechaActual,    Aud_DireccionIP,
                                Aud_ProgramaID,     Aud_Sucursal,           Aud_NumTransaccion);
                    ...
                    END IF;
                     ...
                     IF (Var_SaldoMoratorio > Decimal_Cero) THEN
                        IF Par_NatMovimiento=NatCargo THEN
                            SET Var_Cargos  :=Decimal_Cero;
            ...
            IF (Var_EstatusCre = Est_Castigado) THEN
                ...
                SET Var_SaldoCapVencido := (SELECT IFNULL(SaldoCapital,Decimal_Cero) FROM CRECASTIGOS WHERE CreditoID =  Var_CreditoID);


                SET Var_SaldoIntVencido := (SELECT IFNULL(SaldoInteres,Decimal_Cero) FROM CRECASTIGOS WHERE CreditoID =  Var_CreditoID);


                SET Var_SaldoMoraVen    := (SELECT IFNULL(SaldoMoratorio,Decimal_Cero) FROM CRECASTIGOS WHERE CreditoID =  Var_CreditoID);
               ...
               END IF;
                ...
                IF (Var_SaldoMoraVen>Decimal_Cero) THEN
                    ...
                    SET ReferenciaCredito:=CONCAT("Cred.",CONVERT(Var_CreditoID, CHAR));
                        ...
                        CALL POLIZACREDITOPRO(
                            Par_PolizaID,       Aud_EmpresaID,              Var_Fecha,              Var_CreditoID,      Var_ProdCreditoID,
                            Par_SucursalOrigen, ConceptoCastigoIntMoraCorr, Var_Clasificacion,      Var_SubClasifica,   Var_Cargos,
                            Var_Abonos,         Var_MonedaBaseID,           DescripCredVen,         ReferenciaCredito,  Par_NumErr,
                            Par_ErrMen,         Entero_Cero,                Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
                            Aud_ProgramaID,     Aud_Sucursal,               Aud_NumTransaccion);
                        ...
                        CALL POLIZACREDITOPRO(
                            Par_PolizaID,       Aud_EmpresaID,          Var_Fecha,              Var_CreditoID,          Var_ProdCreditoID,
                            Par_SucursalOrigen, ConceptoCastigoIntMora, Var_Clasificacion,      Var_SubClasifica,       Var_Abonos,
                            Var_Cargos,         Var_MonedaBaseID,       DescripCredVen,         ReferenciaCredito,      Par_NumErr,
                            Par_ErrMen,         Entero_Cero,            Aud_Usuario,            Aud_FechaActual,        Aud_DireccionIP,
                            Aud_ProgramaID,     Aud_Sucursal,           Aud_NumTransaccion);
               END IF;
