...
-- ESCPUBAVALESALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `ESCPUBAVALESALT`;DELIMITER $$

CREATE PROCEDURE `ESCPUBAVALESALT`(
    ...
    DECLARE Var_NumRegAval	INT(11);
    DECLARE Var_NumRegEsc	INT(11);
...
ManejoErrores: BEGIN
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
							'esto le ocasiona. Ref: SP-ESCPUBAVALESALT');
	...
	INSERT INTO ESCPUBAVALES VALUES (Par_AvalID,		Par_Esc_Tipo,		Par_NomApoder,		Par_RFC_Apoder,		Par_EscriPub,
	...
	IF(Par_LLamado = Tipo_Agregar) THEN
		SET Par_NumErr 		:= '000';
		SET Par_ErrMen 		:= CONCAT('Aval Agregado Exitosamente: ',Par_AvalID);
