...
-- ---------------------------------------------------------------------------------
-- CALENDARIOMINISTRAMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `CALENDARIOMINISTRAMOD`;DELIMITER $$

CREATE PROCEDURE `CALENDARIOMINISTRAMOD`(
...
ManejoErrores: BEGIN
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-CALENDARIOMINISTRAMOD');
	...
	UPDATE CALENDARIOMINISTRA SET
		TomaFechaInhabil 			= Par_TomaFechaInhabil,
		PermiteCalIrregular 		= Par_PermiteCalIrregular,
		DiasCancelacion 			= Par_DiasCancelacion,
		DiasMaxMinistraPosterior 	= Par_DiasMaxMinistraPosterior,

		Frecuencias 				= Par_Frecuencias,
		Plazos 						= Par_Plazos,
		TipoCancelacion				= Par_TipoCancelacion,
	...
	SET	Par_ErrMen := 'Calendario de Ministraciones Modificado Exitosamente.';
	SET Var_Control:= 'productoCreditoID' ;
