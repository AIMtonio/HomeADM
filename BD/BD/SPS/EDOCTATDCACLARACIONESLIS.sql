...
-- ---------------------------------------------------------------------------------
-- EDOCTATDCACLARACIONESLIS
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOCTATDCACLARACIONESLIS`;DELIMITER $$

CREATE PROCEDURE `EDOCTATDCACLARACIONESLIS`( 
-- Storer PROCEDURE que realiza la consulta para los cargos objetados
...
-- Asignacion de Constantes
	...
	IF(Par_NumLis = Lis_Principal) THEN 
		SELECT	TarjetaDebID,	Fecha,	Descripcion,	FolioAclaracion,	FechaApertura,
				Importe
		FROM EDOCTATDCACLARACIONES
