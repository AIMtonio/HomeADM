...
-- BALANZACONTA003REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA003REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA003REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: Yanga
...
TerminaStore: BEGIN
	...
	SELECT Aud_NumTransaccion, Cue.CuentaCompleta,
		   ...
		   CASE WHEN Cue.Grupo = Tip_Encabezado AND Var_NumSegConta = 1
					 AND Cue.CuentaCompleta NOT IN ('140307100000000000', '230710000000000000',
													'560110000000000000', '110101100000000000',
													'110103100000000000', '550410000000000000',
													'321000000000000000') THEN
	...
	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '14030710'
	WHERE CuentaCompleta = '140307100000000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '230710'
	WHERE CuentaCompleta = '230710000000000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '560110'
	WHERE CuentaCompleta = '560110000000000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '11010110'
	WHERE CuentaCompleta = '110101100000000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '11010310'
	WHERE CuentaCompleta = '110103100000000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '550410'
	WHERE CuentaCompleta = '550410000000000000'
	  AND NumTransaccion = Aud_NumTransaccion;

	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '3210'
	WHERE CuentaCompleta = '321000000000000000'
	  AND NumTransaccion = Aud_NumTransaccion;
