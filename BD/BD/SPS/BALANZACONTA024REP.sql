...
-- BALANZACONTA024REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA024REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA024REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: CREDICLUB, SA. DE CV.
