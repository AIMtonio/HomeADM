...
-- ---------------------------------------------------------------------------------
-- BALANCEINTERNO012REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANCEINTERNO012REP`;
DELIMITER $$


CREATE PROCEDURE `BALANCEINTERNO012REP`(
# ===================================================
# -------- SP PARA GENERAR EL BALANCE GENERAL--------
# ===================================================
...
TerminaStore: BEGIN
	...
	DECLARE For_CredConsVig 	VARCHAR(500);
	DECLARE Des_CredConsVig 	VARCHAR(500);
	DECLARE For_CredComVig 		VARCHAR(500);
	DECLARE Des_CredComVig		VARCHAR(500);
	DECLARE For_CredVivVig  	VARCHAR(500);
	DECLARE Des_CredVivVig  	VARCHAR(500);
	...
	-- CREDITOS COMERCIALES VIGENTE
	SELECT CuentaContable, Desplegado  INTO For_CredComVig, Des_CredComVig
		FROM CONCEPESTADOSFIN
		WHERE EstadoFinanID = Tif_Balance
		  AND ConceptoFinanID = 7
			AND NumClien = NumCliente;

	-- CREDITOS DE CONSUMO VIGENTE
	SELECT CuentaContable, Desplegado  INTO For_CredConsVig, Des_CredConsVig
		FROM CONCEPESTADOSFIN
		WHERE EstadoFinanID = Tif_Balance
		  AND ConceptoFinanID = 8
			AND NumClien = NumCliente;

	-- CREDITOS DE VIVIENDA VIGENTE
	SELECT CuentaContable, Desplegado  INTO For_CredVivVig, Des_CredVivVig
		FROM CONCEPESTADOSFIN
		WHERE EstadoFinanID = Tif_Balance
		  AND ConceptoFinanID = 9
			AND NumClien = NumCliente;
	...
	IF (Par_TipoConsulta = Por_Fecha) THEN
		...
		IF (Var_FechaSaldos = Fecha_Vacia) THEN
			...
			IF(For_CredConsVig != Cadena_Vacia) THEN

				CALL `EVALFORMULACONTAPRO`(
					For_CredConsVig,      Ubi_Actual,		Por_Fecha,          Par_Fecha,      	Var_UltEjercicioCie,
					Var_UltPeriodoCie,  Par_Fecha,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
				...
				INSERT INTO TMPBALANZACONTA	(
						...
						CuentaMayor,					CentroCosto)
				VALUES(
						Aud_NumTransaccion, "ActCredConsVig",       Cadena_Vacia,   	Entero_Cero,    Entero_Cero,
						Entero_Cero, 		Entero_Cero,        Par_AcumuladoCta,   Entero_Cero,    Des_ResulNeto,
						Cadena_Vacia, Cadena_Vacia);

			END IF;

		IF(For_CredComVig != Cadena_Vacia) THEN

				CALL `EVALFORMULACONTAPRO`(
					For_CredComVig,      Ubi_Actual,		Por_Fecha,          Par_Fecha,      	Var_UltEjercicioCie,
					Var_UltPeriodoCie,  Par_Fecha,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
				...
				INSERT INTO TMPBALANZACONTA	(
						...
						CuentaMayor,					CentroCosto)
				VALUES(
						Aud_NumTransaccion, "ActCredComVig",       Cadena_Vacia,   	Entero_Cero,    Entero_Cero,
						Entero_Cero, 		Entero_Cero,        Par_AcumuladoCta,   Entero_Cero,    Des_ResulNeto,
						Cadena_Vacia, Cadena_Vacia);

			END IF;

		IF(For_CredVivVig != Cadena_Vacia) THEN
				CALL `EVALFORMULACONTAPRO`(
					For_CredVivVig,      Ubi_Actual,		Por_Fecha,          Par_Fecha,      	Var_UltEjercicioCie,
					Var_UltPeriodoCie,  Par_Fecha,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
				...
				INSERT INTO TMPBALANZACONTA	(
						...
						CuentaMayor,					CentroCosto)
				VALUES(
						Aud_NumTransaccion, "ActCredVivVig",       Cadena_Vacia,   	Entero_Cero,    Entero_Cero,
						Entero_Cero, 		Entero_Cero,        Par_AcumuladoCta,   Entero_Cero,    Des_ResulNeto,
						Cadena_Vacia, Cadena_Vacia);
		...
		ELSE
			...
			IF(For_CredConsVig != Cadena_Vacia) THEN
				...
				CALL `EVALFORMULACONTAPRO`(
					For_CredConsVig,      Var_Ubicacion,		Por_Fecha,          Par_Fecha,      	Var_UltEjercicioCie,
					Var_UltPeriodoCie,  Var_FecIniPer,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
		...
		IF(For_CredComVig != Cadena_Vacia) THEN
				...
				CALL `EVALFORMULACONTAPRO`(
					For_CredComVig,      Var_Ubicacion,		Por_Fecha,          Par_Fecha,      	Var_UltEjercicioCie,
					Var_UltPeriodoCie,  Var_FecIniPer,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
		...
		IF(For_CredVivVig != Cadena_Vacia) THEN
				CALL `EVALFORMULACONTAPRO`(
					For_CredVivVig,      Var_Ubicacion,		Por_Fecha,          Par_Fecha,      	Var_UltEjercicioCie,
					Var_UltPeriodoCie,  Var_FecIniPer,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
	...
	ELSEIF(Par_TipoConsulta = Por_Peridodo) THEN
		...
		INSERT INTO TMPBALANZACONTA	(
			...
			IF(For_CredConsVig != Cadena_Vacia) THEN
				...
				CALL `EVALFORMULACONTAPRO`(
					For_CredConsVig,     Cadena_Vacia,	Por_Peridodo,       Par_Fecha,			Par_Ejercicio,
					Par_Periodo,		Par_Fecha,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
		...
		IF(For_CredComVig != Cadena_Vacia) THEN
				...
				CALL `EVALFORMULACONTAPRO`(
					For_CredComVig,    Cadena_Vacia,	Por_Peridodo,       Par_Fecha,			Par_Ejercicio,
					Par_Periodo,		Par_Fecha,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
		...
		IF(For_CredVivVig != Cadena_Vacia) THEN
				CALL `EVALFORMULACONTAPRO`(
					For_CredVivVig,      Cadena_Vacia,	Por_Peridodo,       Par_Fecha,			Par_Ejercicio,
					Par_Periodo,		Par_Fecha,		Par_AcumuladoCta,	Par_CCInicial,		Par_CCFinal,
					Par_EmpresaID,		Aud_Usuario,	Aud_FechaActual,    Aud_DireccionIP,	Aud_ProgramaID,
					Aud_Sucursal,   	Aud_NumTransaccion);
	...
	IF(Par_TipoConsulta = Por_FinPeriodo) THEN
		...
		INSERT INTO TMPBALANZACONTA	(
			...
			IF(For_CredConsVig != Cadena_Vacia) THEN
				CALL EVALFORMULAPERIFINPRO(Par_AcumuladoCta,  For_CredConsVig,  'H',  'F',  Var_FecConsulta);
			...
			IF(For_CredComVig != Cadena_Vacia) THEN
				CALL EVALFORMULAPERIFINPRO(Par_AcumuladoCta,  For_CredComVig,  'H',  'F',  Var_FecConsulta);
			...
			IF(For_CredVivVig != Cadena_Vacia) THEN
				CALL EVALFORMULAPERIFINPRO(Par_AcumuladoCta,  For_CredVivVig,  'H',  'F',  Var_FecConsulta);
