-- TD_ASIGNAOPERACIONCAL
DELIMITER ;
DROP PROCEDURE IF EXISTS `TD_ASIGNAOPERACIONCAL`;

DELIMITER $$
CREATE PROCEDURE `TD_ASIGNAOPERACIONCAL`(
	-- Store Procedure para la asignacion de Operaciones del Web Service
	-- Modulo Tarjetas Debito --> Web Service
...
TerminaStore: BEGIN
	...
	SET Con_SI					:= 'S';
	SET Con_NO 					:= 'N';
	SET Con_SiEsCheckIn			:= '1';

	SET Con_NoEsCheckIn			:= '0';
	SET Prod_ATM				:= '01';
	SET Prod_POS				:= '02';
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-TD_ASIGNAOPERACIONCAL');
