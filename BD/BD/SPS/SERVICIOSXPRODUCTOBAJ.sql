-- SP SERVICIOSXPRODUCTOBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS SERVICIOSXPRODUCTOBAJ;
DELIMITER $$

CREATE PROCEDURE SERVICIOSXPRODUCTOBAJ(
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
										'esto le ocasiona. Ref: SP-SERVICIOSXPRODUCTOBAJ');
				SET Var_Control :='SQLEXCEPTION';
			END;

		DELETE FROM SERVICIOSXPRODUCTO
