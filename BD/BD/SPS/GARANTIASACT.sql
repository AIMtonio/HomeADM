...
-- GARANTIASACT
DELIMITER ;
DROP PROCEDURE IF EXISTS `GARANTIASACT`;

DELIMITER $$
CREATE PROCEDURE `GARANTIASACT`(
	...
	ManejoErrores: BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									 'Disculpe las molestias que esto le ocasiona. Ref: SP-GARANTIASACT');
		...
		UPDATE	GARANTIAS	SET
			...
			Proporcion				= Entero_Cero,
			Usufructuaria			= Con_NO,
