...
-- ---------------------------------------------------------------------------------
-- SUBCTAPLAZOARRENDAALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAPLAZOARRENDAALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTAPLAZOARRENDAALT`(
	...
	Par_Plazo				CHAR(1),		-- Indica Valor del plazo L = largo plazo, C Corto Plazo
	...
	ManejoErrores:BEGIN
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET	Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
														'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTAPLAZOARRENDAALT');
		...
		INSERT	INTO	SUBCTAPLAZOARRENDA(
			ConceptoArrendaID,		Plazo,				SubCuenta,		EmpresaID,		Usuario,
			FechaActual,			DireccionIP,		ProgramaID,		Sucursal,		NumTransaccion
		) VALUES (
			Par_ConceptoArrendaID,	Par_Plazo,			Par_SubCuenta,	Aud_EmpresaID,	Aud_Usuario,
		...
		SET	Par_NumErr	:= 000;
		SET	Var_Control	:= 'conceptoArrendaID';
		SET	Par_ErrMen	:= CONCAT('SubCuenta Plazo Agregada Exitosamente: ',Par_SubCuenta);
