...
-- PAGOVERINTVENCREPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `PAGOVERINTVENCREPRO`;
DELIMITER $$

CREATE PROCEDURE `PAGOVERINTVENCREPRO`(
...
TerminaStore: BEGIN
    ...
    DECLARE CURSORAMORTIZACIONES CURSOR FOR
		SELECT  Amo.AmortizacionID, 	Amo.SaldoInteresVen, 	Amo.FechaInicio,		Amo.FechaVencim
    ...
    OPEN CURSORAMORTIZACIONES;
			BEGIN
				...
				FETCH CURSORAMORTIZACIONES INTO
					Var_AmortizacionID,		Var_SaldoInteresVen, 	Var_FechaInicio,	Var_FechaVencim;
