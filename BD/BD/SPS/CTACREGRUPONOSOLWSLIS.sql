...
-- ---------------------------------------------------------------------------------
-- CTACREGRUPONOSOLWSLIS
DELIMITER ;
DROP PROCEDURE IF EXISTS `CTACREGRUPONOSOLWSLIS`;DELIMITER $$

CREATE PROCEDURE `CTACREGRUPONOSOLWSLIS`(
        ...
        IF(Par_NumLis = Lis_Principal) THEN
            (SELECT Tip.TipoCuentaID     AS Id_Cuenta,
                ...
                FROM
                     TIPOSCUENTAS Tip,
                     PARAMETROSCAJA Par
                WHERE Tip.TipoCuentaID = Par.CtaOrdinaria
                    OR Tip.TipoCuentaID = Par.CuentaVista
