...
-- BALANZACONTA007REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA007REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA007REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: SANA TUS FINANZAS S.A. DE C.V. SOFOM ENR.
