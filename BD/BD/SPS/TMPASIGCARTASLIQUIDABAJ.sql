...
-- ---------------------------------------------------------------------------------
-- TMPASIGCARTASLIQUIDABAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS TMPASIGCARTASLIQUIDABAJ;
DELIMITER $$

CREATE PROCEDURE TMPASIGCARTASLIQUIDABAJ(
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-TMPASIGCARTASLIQUIDABAJ');
