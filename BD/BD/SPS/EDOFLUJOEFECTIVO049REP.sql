...
-- ---------------------------------------------------------------------------------
-- EDOFLUJOEFECTIVO049REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOFLUJOEFECTIVO049REP`;

DELIMITER $$
CREATE PROCEDURE `EDOFLUJOEFECTIVO049REP`(
	-- SP para generar el Flujo de Efectivo del Cliente: ATE
