...
-- CRCBCLIENTESWSALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `CRCBPMCLIENTESMOD`;
DELIMITER $$

CREATE PROCEDURE `CRCBPMCLIENTESMOD`(
...
TerminaStore: BEGIN
	...
	ManejoErrores:BEGIN
		...
		CALL PLDDETECCIONPRO(
			...
			EsCliente,          Str_SI,             Str_SI,             Str_SI,             Salida_NO,
		...
		SET Var_SoloApellidos		:= FNGENNOMBRECOMPCARGALIS(Cadena_Vacia,Cadena_Vacia,Cadena_Vacia,Par_ApellidoPat,Par_ApellidoMat);
