...
-- BALANZACONTA030REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA030REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA030REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: COOPERATIVA LOS TRES REYES S.C. DE A.P. DE R.L. DE C.V.
