...
-- ---------------------------------------------------------------------------------
-- SUBCTAMONEDAINVBANALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAMONEDAINVBANALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTAMONEDAINVBANALT`(
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTAMONEDAINVBANALT');
		...
		INSERT INTO `SUBCTAMONEDAINVBAN`(
			`ConceptoInvBanID`,	`MonedaID`,		`SubCuenta`,	`EmpresaID`,	`Usuario`,
			`FechaActual`,		`DireccionIP`,	`ProgramaID`,	`Sucursal`,		`NumTransaccion`)
		VALUES(
			Par_ConceptoInvBanID,	Par_MonedaID,		Par_SubCuenta,	Aud_EmpresaID,	Aud_Usuario,
