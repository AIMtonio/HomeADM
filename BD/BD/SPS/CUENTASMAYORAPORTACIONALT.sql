...
-- ---------------------------------------------------------------------------------
-- CUENTASMAYORAPORTACIONALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `CUENTASMAYORAPORTACIONALT`;DELIMITER $$

CREATE PROCEDURE `CUENTASMAYORAPORTACIONALT`(
# ==================================================================
# ----- SP PARA REGISTRAR LAS CUENTAS DE MAYOR DE APORTACIONES -----
# ==================================================================
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
										'Disculpe las molestias que esto le ocasiona. Ref: SP-CUENTASMAYORAPORTACIONALT');
			END;
		...
		INSERT INTO CUENTASMAYORAPORT(
			ConceptoAportID,	Cuenta,			Nomenclatura,		NomenclaturaCR,		EmpresaID,
			Usuario,				FechaActual,	DireccionIP,		ProgramaID,			Sucursal,
            NumTransaccion)
		VALUES(
			Par_ConceptoAportacionID,	Par_Cuenta,		Par_Nomenclatura,	Par_NomenclaturaCR,	Aud_EmpresaID,
            Aud_Usuario,				Aud_FechaActual,Aud_DireccionIP,	Aud_ProgramaID,		Aud_Sucursal,
			Aud_NumTransaccion);

		SET	Par_NumErr 	:= 000;
		SET	Par_ErrMen	:= CONCAT('Cuenta Agregada Exitosamente: ',CONVERT(Par_ConceptoAportacionID,CHAR));
		SET Var_Control	:= 'conceptoAportacionID';
