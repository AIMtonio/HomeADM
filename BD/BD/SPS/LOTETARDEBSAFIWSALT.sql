...
-- LOTETARDEBSAFIWSALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `LOTETARDEBSAFIWSALT`;
DELIMITER $$

CREATE PROCEDURE `LOTETARDEBSAFIWSALT`(

	INOUT Par_LoteDebitoSAFIID	INT(11),
...
ManejoErrores:BEGIN
    ...
    BEGIN
        ...
        SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
						'esto le ocasiona. Ref: SP-LOTETARDEBSAFIWSALT');
    END;
	...
	INSERT INTO LOTETARJETADEBSAFI (
		...
		NumTarjetas,	Estatus,			EsAdicional,	EsPersonalizado,	RutaNomArch,		FolioInicial,
		FolioFinal,		BitCargaSAFIID,		ServiceCode,	EmpresaID,			Usuario,
		FechaActual,	DireccionIP,		ProgramaID,		Sucursal,			NumTransaccion)

	VALUES(
		Var_LoteDebitoSAFIID,	Par_TipoTarjetaDebID,	Par_FechaRegistro,		Par_SucursalSolicita,	Par_UsuarioID,
		Par_NumTarjetas,		Par_Estatus, 			Par_EsAdicional,		Par_EsPersonaliz,		Par_NomArchiGen,		Par_FolioInicial,
		Par_FolioFinal,			Par_BitCargaID,			Par_ServiceCode,		Par_EmpresaID,			Aud_Usuario,
	    ...
	    SET Par_LoteDebitoSAFIID := Var_LoteDebitoSAFIID;
