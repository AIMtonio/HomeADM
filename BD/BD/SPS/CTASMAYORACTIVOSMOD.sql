...
-- CTASMAYORACTIVOSMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `CTASMAYORACTIVOSMOD`;DELIMITER $$

CREATE PROCEDURE `CTASMAYORACTIVOSMOD`(
# =====================================================================================
# ------- STORED PARA MODIFICACION DE CUENTAS DE MAYOR DE ACTIVOS---------
# =====================================================================================
	...
	ManejoErrores:BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
							'esto le ocasiona. Ref: SP-CTASMAYORACTIVOSMOD');
		...
		SET Par_NumErr 		:= 0;
		SET Par_ErrMen 		:= CONCAT('Registro Modificado Exitosamente: ',CAST(Par_ConceptoActivoID AS CHAR) );
		SET Var_Control		:= 'conceptoActivoID';
