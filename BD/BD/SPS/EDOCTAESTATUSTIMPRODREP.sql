...
-- ---------------------------------------------------------------------------------
-- EDOCTAESTATUSTIMPRODREP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOCTAESTATUSTIMPRODREP`;
DELIMITER $$


CREATE PROCEDURE `EDOCTAESTATUSTIMPRODREP`(
-- SP DE ESTATUS DEL TIMBRADO DE CUENTA
	Par_Anio         		INT(12),	  		-- AÑO      
...
TerminaStore: BEGIN
	...
	IF(Par_TipoReporte = EstatusTimbrado) THEN		               
