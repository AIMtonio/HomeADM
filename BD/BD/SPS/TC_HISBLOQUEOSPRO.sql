...
-- TC_HISBLOQUEOSPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `TC_HISBLOQUEOSPRO`;

DELIMITER $$
CREATE PROCEDURE `TC_HISBLOQUEOSPRO`(
	-- SP para el pase a Historico de un bloqueo o desbloqueo automatico de una tarjeta de credito
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-TC_HISBLOQUEOSPRO');
		...
		DELETE FROM TC_BLOQUEOS WHERE BloqueoID = Par_BloqueoID;
