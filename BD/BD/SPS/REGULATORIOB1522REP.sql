...
-- REGULATORIOB1522REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOB1522REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOB1522REP`(
	/* Genera la llamada al regulatorio B1522 para Sofipo o Socap */
	...
	SET NumReporte			:= 'B1522';				-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
