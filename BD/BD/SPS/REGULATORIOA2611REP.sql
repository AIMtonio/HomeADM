...
-- REGULATORIOA2611REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOA2611REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOA2611REP`(
	/* Genera la llamada al regulatorio A2611 para Sofipo o Socap */
...
-- Variables
	...
	SET NumReporte			:= 'A2611';					-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
