...
-- ---------------------------------------------------------------------------------
-- CEDEMASIVOCONDICIONESPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `CEDEMASIVOCONDICIONESPRO`;
DELIMITER $$


CREATE PROCEDURE `CEDEMASIVOCONDICIONESPRO`(
# ===============================================================================================
# ---- SP QUE SE ENCARGA DE REALIZAR EL CALCULO DE CONDICIONES DE REINVERSION MASIVA DE CEDES----
# ===============================================================================================
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen  = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
										 'esto le ocasiona. Ref: SP-CEDEMASIVOCONDICIONESPRO');
			END;
		...
		IF(Var_FechaBatch = FechaVacia OR Aud_ProgramaID = ProgramaVencMasivo) THEN
			...
			UPDATE TEMPCEDES temp
				SET temp.NuevoIntGenerado	=	ROUND(((temp.MontoReinvertir * temp.NuevaTasa * temp.NuevoPlazo)/(Cons360 * ConstanteCien)),2),
					...
					temp.NuevoValorGat		=	FUNCIONCALCTAGATCEDE(FechaVencimiento,FechaInicio,temp.NuevaTasa);
