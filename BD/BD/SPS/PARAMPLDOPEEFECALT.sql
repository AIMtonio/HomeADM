...
-- PARAMPLDOPEEFECALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `PARAMPLDOPEEFECALT`;DELIMITER $$

CREATE PROCEDURE `PARAMPLDOPEEFECALT`(
...
ManejoErrores: BEGIN
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-PARAMPLDOPEEFECALT');
	...
	CALL FOLIOSAPLICAACT('PARAMPLDOPEEFEC', Var_Consecutivo);

    INSERT INTO PARAMPLDOPEEFEC (
        ...
        Estatus,					FechaVigencia,	   	EmpresaID,				Usuario,	 			FechaActual,
        DireccionIP,				ProgramaID,			Sucursal,				NumTransaccion
	) VALUES (
		Var_Consecutivo,		Par_MontoRemesaUno,		Par_MontoRemesaDos,		Par_MontoRemesaTres,	Decimal_Cero,
        Par_RemesaMonedaID,		Par_MontoLimEfecF,      Par_MontoLimEfecM,		Par_MontoLimEfecMes,	Par_MontoLimMonedaID,
        EstatusVigente,			Var_FechaVigencia,      Aud_EmpresaID,			Aud_Usuario,			Aud_FechaActual,
