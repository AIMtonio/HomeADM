...
-- CATTIPOEGRESOSLIS
DELIMITER ;
DROP PROCEDURE IF EXISTS `CATTIPOEGRESOSLIS`;DELIMITER $$

CREATE PROCEDURE `CATTIPOEGRESOSLIS`(
	/*SP para Listar el catalogo de Egresos  */
	...
	IF(Par_NumLis = Lista_Principal) THEN
		SELECT Numero,Descripcion FROM CATTIPOEGRESOS
