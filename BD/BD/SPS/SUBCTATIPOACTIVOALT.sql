...
-- SUBCTATIPOACTIVOALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTATIPOACTIVOALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTATIPOACTIVOALT`(
# =====================================================================================
# ------- STORED PARA ALTA DE SUBCUENTAS DE TIPO DE ACTIVOS---------
# =====================================================================================
	...
	ManejoErrores:BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
							'esto le ocasiona. Ref: SP-SUBCTATIPOACTIVOALT');
