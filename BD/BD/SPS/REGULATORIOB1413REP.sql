...
-- REGULATORIOB1413REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOB1413REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOB1413REP`(
# ==================================================================
# -- Genera la llamada al regulatorio B1413 para Sofipo o Socap ----
# ==================================================================
	...
	SET NumReporte			:= 'B1413';				-- Clave del reporte
	...
	SET Resp_SI				:= 'S';					-- Variable Si
	SET Resp_SI				:= 'N';					-- Variable No
