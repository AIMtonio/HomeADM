...
-- HIS-DETALLEPOLALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `HIS-DETALLEPOLALT`;DELIMITER $$

CREATE PROCEDURE `HIS-DETALLEPOLALT`(
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-HIS-DETALLEPOLALT');
			END;
	...
	SELECT Fin, Inicio INTO Var_FechaFinPer, Var_FechaIniPer
		...
		SET Par_ErrMen	:= 'Detalle Poliza Contable Agregado Exitosamente';
