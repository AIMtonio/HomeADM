...
-- SUBCTAMONEDACEDEBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAMONEDACEDEBAJ`;DELIMITER $$

CREATE PROCEDURE `SUBCTAMONEDACEDEBAJ`(
# =================================================================
# ------ SP PARA ELIMINAR LAS SUBCUENTAS DE MONEDAS DE CEDES------
# =================================================================
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
										'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTAMONEDACEDEBAJ');
			END;
