...
-- ---------------------------------------------------------------------------------
-- BANTRANSFEREXTERNAPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `BANTRANSFEREXTERNAPRO`;
DELIMITER $$

CREATE PROCEDURE `BANTRANSFEREXTERNAPRO`(
	...
	Par_Salida				CHAR(1),				-- parametros que indica la salida S =Si N = No
	INOUT Par_NumErr		INT(11),				-- parametros numero de error
	INOUT Par_ErrMen		VARCHAR(400),			-- parametros mensaje de error
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
			   ...
			   SET Par_ErrMen  = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
						  			'Disculpe las molestias que esto le ocasiona. Ref: SP-BANTRANSFEREXTERNAPRO');
