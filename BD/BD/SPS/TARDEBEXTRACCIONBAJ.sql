-- TARDEBEXTRACCIONBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS TARDEBEXTRACCIONBAJ;
DELIMITER $$

CREATE PROCEDURE TARDEBEXTRACCIONBAJ(
	...
	ManejoErrores:BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al
							  concretar la operacion.Disculpe las molestias que', 'esto le ocasiona. Ref: SP-TARDEBEXTRACCIONBAJ');
