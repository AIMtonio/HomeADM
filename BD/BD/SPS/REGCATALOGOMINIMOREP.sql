...
-- ---------------------------------------------------------------------------------
-- REGCATALOGOMINIMOREP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGCATALOGOMINIMOREP`;DELIMITER $$

CREATE PROCEDURE `REGCATALOGOMINIMOREP`(
	...
	SET NumReporte			:= 'A0111';				-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
	...
	SET Var_Llamada := CONCAT(' CALL ',Var_NombreReporte,
		'(',Par_Anio,',',Par_Mes,',',Par_NumRep,',',Par_Version,',',Par_EmpresaID,',',Aud_Usuario,',',"'",Aud_FechaActual,"'",',',"'",Aud_DireccionIP,"'",',',"'",Aud_ProgramaID,"'",',',Aud_Sucursal,',',Aud_NumTransaccion,');');
