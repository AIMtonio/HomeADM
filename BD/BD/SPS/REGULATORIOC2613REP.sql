...
-- REGULATORIOC2613REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOC2613REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOC2613REP`(
	/* Genera la llamada al regulatorio C2613 para Sofipo o Socap */
...
-- Variables
	...
	SET NumReporte			:= 'C2613';		-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
