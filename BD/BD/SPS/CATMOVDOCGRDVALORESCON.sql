...
-- ---------------------------------------------------------------------------------
-- CATMOVDOCGRDVALORESCON
DELIMITER ;
DROP PROCEDURE IF EXISTS CATMOVDOCGRDVALORESCON;

DELIMITER $$
CREATE PROCEDURE `CATMOVDOCGRDVALORESCON`(
	-- Store Procedure: Que Consulta Los Tipos de Movimientos de Guarda Valores
...
TerminaStore: BEGIN
	...
	IF( Par_NumConsulta = Con_Principal ) THEN
		...
		SELECT	CatMovimientoID,	ValorCaracter,	NombreMovimiento,	Descripcion	,	Estatus
