...
-- SUBCTAMONEDACEDEMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAMONEDACEDEMOD`;DELIMITER $$

CREATE PROCEDURE `SUBCTAMONEDACEDEMOD`(
# =================================================================
# ------ SP PARA MODIFICAR LAS SUBCUENTAS DE MONEDAS DE CEDES------
# =================================================================
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTAMONEDACEDEMOD');
		END;
