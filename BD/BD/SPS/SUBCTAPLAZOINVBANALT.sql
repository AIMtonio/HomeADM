...
-- ---------------------------------------------------------------------------------
-- SUBCTAPLAZOINVBANALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAPLAZOINVBANALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTAPLAZOINVBANALT`(


	Par_ConceptoInvBanID	int(11),
	Par_Plazo				int(11),
	Par_SubPlazoMayor		varchar(6),
	Par_SubPlazoMenor		varchar(6),
	Par_Salida				char(1),
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTAPLAZOINVBANALT');
		...
		if(ifnull(Aud_EmpresaID, Entero_Cero))= Entero_Cero then
				...
				SET Var_Consecutivo:= Par_Plazo;
		end if;


		INSERT INTO SUBCTAPLAZOINVBAN(
			ConceptoInvBanID,		Plazo,		SubPlazoMayor,		SubPlazoMenor,		EmpresaID,
			Usuario,	FechaActual,	DireccionIP,	ProgramaID,				Sucursal,
			NumTransaccion)
		VALUES(
			Par_ConceptoInvBanID,	Par_Plazo, 		Par_SubPlazoMayor, 	Par_SubPlazoMenor, Aud_EmpresaID,
