...
-- ---------------------------------------------------------------------------------
-- SUBCTAPLAZOARRENDAMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAPLAZOARRENDAMOD`;DELIMITER $$

CREATE PROCEDURE `SUBCTAPLAZOARRENDAMOD`(
	...
	Par_Plazo				CHAR(1),		-- "Indica la Plazo de arrendamiento
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET	Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
														'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTAPLAZOARRENDAMOD');
