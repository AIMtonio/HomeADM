...
-- ---------------------------------------------------------------------------------
-- SUBCTAPLAZOINVBANMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAPLAZOINVBANMOD`;DELIMITER $$

CREATE PROCEDURE `SUBCTAPLAZOINVBANMOD`(
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTAPLAZOINVBANMOD');
		...
		UPDATE SUBCTAPLAZOINVBAN
		SET
		ConceptoInvBanID	= Par_ConceptoInvBanID,
		Plazo				= Par_Plazo,
		SubPlazoMenor 		= Par_SubPlazoMenor,
		SubPlazoMayor 		= Par_SubPlazoMayor,
