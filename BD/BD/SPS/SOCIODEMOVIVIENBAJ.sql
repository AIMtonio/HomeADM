...
-- SOCIODEMOVIVIENBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SOCIODEMOVIVIENBAJ`;DELIMITER $$

CREATE PROCEDURE `SOCIODEMOVIVIENBAJ`(
...
if Par_TipoBaja = Baj_PorCliProspe then
    ...
    Set Par_ErrMen  := 'Datos de la vivienda eliminados con Exito';
