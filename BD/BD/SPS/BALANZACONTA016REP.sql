...
-- BALANZACONTA016REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA016REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA016REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: FOCREEC, S.A. DE C.V. SOFOM ENR.
