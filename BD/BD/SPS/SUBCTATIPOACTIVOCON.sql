...
-- SUBCTATIPOACTIVOCON
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTATIPOACTIVOCON`;DELIMITER $$

CREATE PROCEDURE `SUBCTATIPOACTIVOCON`(
# =====================================================================================
# ------- STORED PARA CONSULTA DE SUB CUENTA DE ACTIVOS ---------
# =====================================================================================
    ...
    DECLARE Con_SubCta			INT(11);			-- Lista 1 : Conceptos contables activos
