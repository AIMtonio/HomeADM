...
-- ---------------------------------------------------------------------------------
-- SUBCTAMONEDAINVBANBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAMONEDAINVBANBAJ`;DELIMITER $$

CREATE PROCEDURE `SUBCTAMONEDAINVBANBAJ`(
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTAMONEDAINVBANBAJ');
