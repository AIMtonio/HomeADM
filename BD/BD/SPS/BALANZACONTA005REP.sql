...
-- BALANZACONTA005REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA005REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA005REP`(
...
TerminaStore: BEGIN
	...
	SELECT Aud_NumTransaccion, Cue.CuentaCompleta,
		   ...
		   CASE WHEN Cue.Grupo = Tip_Encabezado AND Var_NumSegConta = 1
					 AND Cue.CuentaCompleta NOT IN ('54001000000000', '24000710000000',
													'60000000000000') THEN
	...
	UPDATE TMPBALCUENTACONTABLE SET
		CuentaMayor = '6000'
	WHERE CuentaCompleta = '60000000000000'
	  AND NumTransaccion = Aud_NumTransaccion;
