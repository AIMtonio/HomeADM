-- TMPTARDEBEXTRACCIONBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS TMPTARDEBEXTRACCIONBAJ;
DELIMITER $$

CREATE PROCEDURE TMPTARDEBEXTRACCIONBAJ(
	...
	ManejoErrores:BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al
							  concretar la operacion.Disculpe las molestias que', 'esto le ocasiona. Ref: SP-TMPTARDEBEXTRACCIONBAJ');
		...
		DELETE FROM TMPTARDEBEXTRACCION
