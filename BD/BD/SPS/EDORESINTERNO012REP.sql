...
-- EDORESINTERNO012REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDORESINTERNO012REP`;
DELIMITER $$


CREATE PROCEDURE `EDORESINTERNO012REP`(
/* REPORTE FINANCIERO ESTADO DE RESULTADOS PARA TRES REYES */
