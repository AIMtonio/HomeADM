...
-- SEGUROVIDAALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SEGUROVIDAALT`;DELIMITER $$

CREATE PROCEDURE `SEGUROVIDAALT`(
...
INSERT INTO SEGUROVIDA  (
    ...
    Var_SeguroVidaID,   Par_ClienteID,      Par_CuentaID,           Par_CreditoID,      Par_SolCreditoID,
...
SET Par_Consecutivo := Var_SeguroVidaID;
SET Par_NumErr := Entero_Cero;
SET Par_ErrMen := "Seguro de Vida Agregado Exitosamente.";
