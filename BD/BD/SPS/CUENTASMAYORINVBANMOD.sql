...
-- ---------------------------------------------------------------------------------
-- CUENTASMAYORINVBANMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `CUENTASMAYORINVBANMOD`;DELIMITER $$

CREATE PROCEDURE `CUENTASMAYORINVBANMOD`(
	...
	DECLARE 	Var_Consecutivo		char(4);
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-CUENTASMAYORINVBANMOD');
