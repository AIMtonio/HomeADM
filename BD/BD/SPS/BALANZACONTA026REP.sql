...
-- BALANZACONTA026REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA026REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA026REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: TRES REYES AHORRO SEGURO SCAP. DE RL. DE C.V.
...
TerminaStore: BEGIN
	...
	SELECT Aud_NumTransaccion, Cue.CuentaCompleta,
		   ...
		   CASE WHEN Cue.Grupo = Tip_Encabezado AND Var_NumSegConta = 1
					 AND Cue.CuentaCompleta NOT IN ('649000000000', '240120000000', '505090000000') THEN
