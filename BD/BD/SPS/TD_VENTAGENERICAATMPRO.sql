-- TD_VENTAGENERICAATMPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `TD_VENTAGENERICAATMPRO`;

DELIMITER $$
CREATE PROCEDURE `TD_VENTAGENERICAATMPRO`(
	-- Store Procedure de Venta Generica de ATM Para tarjetas de debito por medio de Web Service
...
TerminaStore: BEGIN
	...
	DECLARE Var_MontoDisponible		DECIMAL(12,2);		-- Monto Disponible de la Cuenta Aho
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
					 				'esto le ocasiona. Ref: SP-TD_VENTAGENERICAATMPRO');
		...
		CALL TD_CONTACTAAHORROPRO (
			...
			Var_TotalCompra,		Par_MonedaID,				Var_DesPoliza,			Var_Referencia,			Alta_Enc_Pol_SI,
