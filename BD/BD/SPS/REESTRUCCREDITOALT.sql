...
-- REESTRUCCREDITOALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `REESTRUCCREDITOALT`;
DELIMITER $$

CREATE PROCEDURE `REESTRUCCREDITOALT`(
	# ==================================================================================================================
...
-- Ivett
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
			   ...
			   SET Par_ErrMen  = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
						  'Disculpe las molestias que esto le ocasiona. Ref: SP-REESTRUCCREDITOALT','[',@Var_SQLState,'-' , @Var_SQLMessage,']');
	...
	SELECT  Cli.SucursalOrigen,		Cli.PagaIVA,			Pro.CobraIVAInteres,    Pro.CobraIVAMora,		Cre.Estatus,
            ...
            Des.SubClasifID,		Cre.ComAperCont,		Cre.IVAComAperCont
	INTO	Var_SucursalCte,		Var_CliPagIVA,      	Var_IVAIntOrd,      	Var_IVAIntMor,			Var_EstRelacionado,
            ...
            Var_SubClasifID,		Var_MontoConta ,		Var_MontoIVAComCont
	FROM CREDITOS Cre
    ...
    SET Var_Consecutivo := Entero_Cero;
        ...
        SET Var_FolioConsultaCC := IFNULL(Var_FolioConsultaCC,Cadena_Vacia);
			...
			IF(Var_TotalAdeudoInt > Entero_Cero) THEN
				...
				LEAVE TerminaStore;
			END IF;
			IF(Var_TotalAdeudoCap != Par_SaldoCredAnteri) THEN
				SET Par_NumErr := 205;
		...
		CALL CONTACREDITOSPRO (
			...
			Cadena_Vacia,		SalidaNO,			Par_NumErr, 		Par_ErrMen, 		Var_Consecutivo,
