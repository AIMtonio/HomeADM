...
-- SUBCTARESTINVBANALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTARESTINVBANALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTARESTINVBANALT`(



	Par_ConceptoInvBanID	int(11),
	Par_RestricionCon		varchar(6),
	Par_RestricionSin		varchar(6),
	Par_Salida				char(1),
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTARESTINVBANALT');
		...
		if(ifnull(Aud_EmpresaID, Entero_Cero))= Entero_Cero then
				...
				Set Var_Control	:= 'RestricionCon';
				SET Var_Consecutivo := Par_RestricionCon;
		end if;


		INSERT INTO SUBCTARESTINVBAN(
			ConceptoInvBanID,		RestricionCon,			RestricionSin,		EmpresaID,			Usuario,
			FechaActual,			DireccionIP,			ProgramaID,				Sucursal,		NumTransaccion)
		VALUES(
			Par_ConceptoInvBanID,	Par_RestricionCon, 		Par_RestricionSin, 		Aud_EmpresaID,	Aud_Usuario,
