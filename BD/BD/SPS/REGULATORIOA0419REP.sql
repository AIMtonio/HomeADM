...
-- REGULATORIOA0419REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOA0419REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOA0419REP`(
-- ============================================================================================================
-- ------------------ SP PARA OBTENER DATOS PARA EL REPORTE DE R0419 ------------------------------------------
-- ============================================================================================================
	...
	SET NumReporte			:= 'A0419';				-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
	...
	SET Var_Llamada := CONCAT(' CALL ',Var_NombreReporte,
		'("',Par_Fecha,'",',Par_NumReporte,',',Par_NumDecimales,',',Par_EmpresaID,',',Aud_Usuario,',',"'",Aud_FechaActual,"'",',',"'",Aud_DireccionIP,"'",',',"'",IFNULL(Aud_ProgramaID,''),"'",',',Aud_Sucursal,',',Aud_NumTransaccion,');');
