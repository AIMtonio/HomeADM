...
-- SEGTOALCANCESUCALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SEGTOALCANCESUCALT`;DELIMITER $$

CREATE PROCEDURE `SEGTOALCANCESUCALT`(
    ...
    DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
        ...
        concretar la operacion. Disculpe las molestias que ', 'esto le ocasiona. Ref: SP-SEGTOALCANCESUCALT');
        SET Var_Control = 'sqlException' ;
    END;


    INSERT INTO `SEGTOXSUCURSAL`
        (`SeguimientoID`,   `SucursalID`,   `EmpresaID`,    `Usuario`,  `FechaActual`,
        `DireccionIP`,      `ProgramaID`,   `Sucursal`,     `NumTransaccion`)
    VALUES (
        Par_SeguimientoID,  Par_SucursalID, Aud_EmpresaID,  Aud_Usuario,  Aud_FechaActual,
