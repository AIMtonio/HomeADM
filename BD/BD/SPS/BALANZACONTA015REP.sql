...
-- BALANZACONTA015REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA015REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA015REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: JP SOFIEXPRESS S.A. DE C.V. S.F.P.
...
TerminaStore: BEGIN
	...
	('130000000000','1301'),
	('130000000000','1311'),
	('130000000000','1316'), -- T_15391 by hussein Chan
	('135000000000','1351'),
	('135000000000','1361'),
