...
-- BALANZACONTA018REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA018REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA018REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: BANCOOP S.C. DE A.P. DE R.L. DE C.V.
