...
-- ---------------------------------------------------------------------------------
-- EDOFLUJOEFECTIVO040REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOFLUJOEFECTIVO040REP`;

DELIMITER $$
CREATE PROCEDURE `EDOFLUJOEFECTIVO040REP`(
	-- SP para generar el Flujo de Efectivo MEXI - PREVICREM
	-- Modulo Contabilidad
