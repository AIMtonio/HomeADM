...
-- ASIGNACARTALIQBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `ASIGNACARTALIQBAJ`;
DELIMITER $$

CREATE PROCEDURE `ASIGNACARTALIQBAJ`(
/* SP DE BAJA PARA LAS CARTAS DE LIQUIDACION */
	Par_SolicitudCreditoID		INT(11), 		-- ID de Solicitud de Credito
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-ASIGNACARTALIQBAJ');
