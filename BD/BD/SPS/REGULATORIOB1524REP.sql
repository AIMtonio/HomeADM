...
-- REGULATORIOB1524REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOB1524REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOB1524REP`(
	/* Genera la llamada al regulatorio B1524 para Sofipo o Socap */
	...
	SET NumReporte			:= 'B1524';				-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
