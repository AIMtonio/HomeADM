...
-- CINTAINTFSEMANALSUSP000PRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `CINTAINTFSEMANALSUSP000PRO`;
DELIMITER $$

CREATE PROCEDURE `CINTAINTFSEMANALSUSP000PRO`(
/* SP PARA CINTA DE BURO DE CREDITO SEMANAL FORMATO CSV QUE CONTEMPLA FECHA DEFUNCION E INDICADOR DEFUNCION */
