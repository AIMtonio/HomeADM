...
-- EDORESINTERNO004REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDORESINTERNO004REP`;
DELIMITER $$


CREATE PROCEDURE `EDORESINTERNO004REP`(
  Par_Ejercicio       INT,
  Par_Periodo         INT,
  Par_Fecha           DATE,
        ...
        INSERT INTO TMPCONTABLEBALANCE
            ...
            SELECT  Aud_NumTransaccion, Fin.NombreCampo, Cadena_Vacia,  Entero_Cero,
              ...
              WHERE Fin.EstadoFinanID = Tif_EdoResul
                AND Fin.EsCalculado = 'N'
              AND NumClien = NumCliente
              GROUP BY Fin.ConceptoFinanID, Fin.NombreCampo, Cue.Naturaleza, Fin.Descripcion;
