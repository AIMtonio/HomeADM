...
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOCTAV2TIMBRADOCFDI`;
DELIMITER $$


CREATE PROCEDURE `EDOCTAV2TIMBRADOCFDI`(
...
TerminaStore:BEGIN
	...
	IF (Var_TipoInstitID != TipoInstSOFOM) THEN
        ...
        IF (Var_TipoInstitID = TipoInstSOFOM) THEN
				IF (Var_Total > Decimal_Cero) THEN
					SET Var_CadenaCFDI = CONCAT('[ComprobanteFiscalDigital]', VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Version=3.3',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Fecha=asignarFecha',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'FormaPago=', CAST(FormaPagoEfectivo AS CHAR), VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI,	'NoCertificado=',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI,	'CondicionesDePago=CONTADO',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'SubTotal=', CAST(Var_Subtotal AS CHAR), VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Moneda=MXN',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Total=', CAST(Var_Total AS CHAR), VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'TipoDeComprobante=', CAST(ComprobanteIngreso AS CHAR), VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'MetodoPago=', CAST(MetodoPagoPUE AS CHAR), VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'LugarExpedicion=',CAST(Par_ExpCP AS CHAR),VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);

					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, '[DatosAdicionales]',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'tipoDocumento=Factura',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);

					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, '[Emisor]',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Rfc=',CAST(Par_RFCEmisor AS CHAR),VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Nombre=',CAST(Par_RazonSocial AS CHAR),VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'RegimenFiscal=', CAST(RegFiscalPerMora AS CHAR), VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);

					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, '[Receptor]',VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Rfc=',CAST(Par_RFC AS CHAR),VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Nombre=',CAST(Par_NombreComple AS CHAR),VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'UsoCFDI=', CAST(PorDefininir AS CHAR), VAR_SALTO_LINEA);
					SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
					...
					IF (IFNULL(Var_IntCredito, Decimal_Cero) > Decimal_Cero) THEN
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, '[',CAST(Var_NumConcepto AS CHAR), ']',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ClaveProdServ=', CAST(ClaveProdServCat AS CHAR), VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Cantidad=1',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ClaveUnidad=', CAST(Actividad AS CHAR), VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Unidad=No Aplica',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Descripcion=INTERES DE CREDITO',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ValorUnitario=', Var_IntCredito, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Importe=', Var_IntCredito, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);

						IF(Var_ImporteIntCredito > Decimal_Cero)THEN
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Base=[', Var_IntCredito, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Impuesto=[',CAST(ImpuestoIVA AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TipoFactor=[',CAST(FactorTasa AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TasaOCuota=[',Var_ValorTasa, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Importe=[', CAST(Var_ImporteIntCredito AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
						END IF;
					END IF;
					...
					IF (IFNULL(Var_ComMoratorio, Decimal_Cero) > Decimal_Cero) THEN
						...
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ClaveUnidad=', CAST(Actividad AS CHAR), VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Unidad=No Aplica',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Descripcion=INTERES MORATORIO',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ValorUnitario=', Var_ComMoratorio, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Importe=',Var_ComMoratorio,VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);

						IF(Var_ImporteComMoratorio > Decimal_Cero)THEN
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Base=[', Var_ComMoratorio, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Impuesto=[',CAST(ImpuestoIVA AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TipoFactor=[',CAST(FactorTasa AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TasaOCuota=[',Var_ValorTasa, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Importe=[', CAST(Var_ImporteComMoratorio AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
						END IF;
					END IF;
					...
					IF (IFNULL(Var_ComFaltaPago, Decimal_Cero) > Decimal_Cero) THEN
						...
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ClaveUnidad=', CAST(Actividad AS CHAR), VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Unidad=No Aplica',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Descripcion=COMISION FALTA DE PAGO',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ValorUnitario=', Var_ComFaltaPago, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Importe=',Var_ComFaltaPago,VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);

						IF(Var_ImporteComFaltaPago > Decimal_Cero)THEN
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Base=[', Var_ComFaltaPago, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Impuesto=[',CAST(ImpuestoIVA AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TipoFactor=[',CAST(FactorTasa AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TasaOCuota=[',Var_ValorTasa, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Importe=[', CAST(Var_ImporteComFaltaPago AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
						END IF;
					END IF;
					...
					IF (IFNULL(Var_OtrasCom, Decimal_Cero) > Decimal_Cero) THEN
						...
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ClaveUnidad=', CAST(Actividad AS CHAR), VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Unidad=No Aplica',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Descripcion=OTRAS COMISIONES DE CREDITO',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ValorUnitario=', Var_OtrasCom, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Importe=', Var_OtrasCom,VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);

						IF(Var_ImporteOtrasCom > Decimal_Cero)THEN
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Base=[', Var_OtrasCom, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Impuesto=[',CAST(ImpuestoIVA AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TipoFactor=[',CAST(FactorTasa AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.TasaOCuota=[',Var_ValorTasa, ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuestos.Traslados.Importe=[', CAST(Var_ImporteOtrasCom AS CHAR), ']',VAR_SALTO_LINEA);
							SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
						END IF;
					END IF;
					...
					IF (IFNULL(Var_TotalAhorro, Decimal_Cero) > Decimal_Cero) THEN
						...
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ClaveUnidad=', CAST(Actividad AS CHAR), VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Unidad=No Aplica',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Descripcion=OTRAS COMISIONES',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'ValorUnitario=', Var_TotalAhorro, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Importe=', Var_TotalAhorro,VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
					END IF;

					IF(Var_TotalIVA > Decimal_Cero) THEN
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, '[Traslados]',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'TotalImpuestosTrasladados=', Var_TotalIVA, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuesto=[',CAST(ImpuestoIVA AS CHAR), ']',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'TipoFactor=[',CAST(FactorTasa AS CHAR), ']',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'TasaOCuota=[',Var_ValorTasa, ']',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Importe=[', CAST(Var_TotalIVA AS CHAR), ']',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, VAR_SALTO_LINEA);
					END IF;
    ...
    IF(Var_ProveedorTimbrado = Con_ProveFM) THEN
			...
			IF (Var_TipoInstitID != TipoInstSOFOM) THEN
				IF (Var_Total > Decimal_Cero) THEN
					...
					IF(Var_TotalISR > Decimal_Cero) THEN
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, '[Retenciones]',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'TotalImpuestosRetenidos=',Var_TotalISR, VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Impuesto=[',CAST(ImpuestoISR AS CHAR), ']',VAR_SALTO_LINEA);
						SET Var_CadenaCFDI = CONCAT(Var_CadenaCFDI, 'Importe=[', CAST(Var_TotalISR AS CHAR),']',VAR_SALTO_LINEA);
					END IF;
