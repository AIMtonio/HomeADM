...
-- TC_BITACORARESPALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `TC_BITACORARESPALT`;DELIMITER $$

CREATE PROCEDURE `TC_BITACORARESPALT`(
-- ---------------------------------------------------------------------------------
-- GUARDA LA RESPUESTA DE LA TRANSACCION DE TARJETA DE CREDITO
-- ---------------------------------------------------------------------------------
...
ManejoErrores:BEGIN
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
							'esto le ocasiona. Ref: SP-TC_BITACORARESPALT');
		END;
	...
	INSERT INTO TC_BITACORARESP(
		RespID, 				TarjetaCredID, 			TipoMensaje, 		TipoOperacionID, 		FechaOperacion,
	...
	VALUES
	(	Var_RespID, 				Par_TarjetaCredID, 			Par_TipoMensaje, 		Par_TipoOperacionID, 		Par_FechaOperacion,
