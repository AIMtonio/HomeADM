...
-- SUBCTAPLAZOKUBOALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAPLAZOKUBOALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTAPLAZOKUBOALT`(
...
insert into SUBCTAPLAZOKUBO
			values (  	Par_ConceptoKuboID,	 	Par_NumRetiros,		Par_SubCuenta,
