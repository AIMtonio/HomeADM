...
-- ---------------------------------------------------------------------------------
-- EDOVARIACIONES048REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOVARIACIONES048REP`;

DELIMITER $$
CREATE PROCEDURE `EDOVARIACIONES048REP`(
	-- SP para generar el Estado de Variacion de Capital del Cliente: NATGAS
