...
-- ---------------------------------------------------------------------------------
-- SUBCTACLASIFACTIVOMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTACLASIFACTIVOMOD`;

DELIMITER $$
CREATE PROCEDURE `SUBCTACLASIFACTIVOMOD`(
	-- Store Procedure para la Modificacion de SubCuentas por Clasificacion de Activos
	...
	ManejoErrores:BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
									'esto le ocasiona. Ref: SP-SUBCTACLASIFACTIVOMOD');
		...
		UPDATE SUBCTACLASIFACTIVO SET
			SubCuenta			= IFNULL(Par_SubCuenta, Cadena_Vacia),
