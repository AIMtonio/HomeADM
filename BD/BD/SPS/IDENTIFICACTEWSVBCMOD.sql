...
DECLARE Var_MensajeResp		VARCHAR(150);	-- MENSAJE REPS
...
DECLARE NombMunicipio		VARCHAR(50);	-- NOMB MUNICIPIO
...
DECLARE MinLicencia			INT(11);		-- MIN LICENCIA
...
ManejoErrores: BEGIN
	...
	BEGIN
		...
		SET Par_ErrMen := CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
								'Disculpe las molestias que esto le ocasiona. Ref: SP-IDENTIFICACTEWSVBCMOD');
	END;
	...
	END IF;
   	...
   	IF(IFNULL(Par_IdentificaID, Entero_Cero)) = Entero_Cero THEN
        SET Par_NumErr		:= '02';
	...
	CALL IDENTIFICACIONCTEMOD(
    	Par_ClienteID,			Par_IdentificaID, 		Par_TipoIdentiID,	Var_SI,			Par_NumIdentifica,
        Par_FechaExpedicion,	Par_FechaVencimiento,	Salida_No, 			Var_NumErr,		Var_MenErr,
        Var_IdentificaID, 		Par_EmpresaID, 			Aud_Usuario,		Aud_FechaActual,Aud_DireccionIP,
