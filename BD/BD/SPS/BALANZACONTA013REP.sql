...
-- BALANZACONTA013REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA013REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA013REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: ILAN PODLIPSKY GALICOT
