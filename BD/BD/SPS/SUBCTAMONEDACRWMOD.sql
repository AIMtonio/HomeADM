...
-- SUBCTAMONEDACRWMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAMONEDACRWMOD`;
DELIMITER $$

CREATE PROCEDURE `SUBCTAMONEDACRWMOD`(
...
ManejoErrores: BEGIN
	...
	SET	Par_ErrMen := CONCAT("Subcuenta Modificada Exitosamente. Moneda: ", CONVERT(Par_MonedaID, CHAR));
	SET Var_Control:= 'monedaID';
