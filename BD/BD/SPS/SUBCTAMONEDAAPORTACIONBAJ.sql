...
-- ---------------------------------------------------------------------------------
-- SUBCTAMONEDAAPORTACIONBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAMONEDAAPORTACIONBAJ`;DELIMITER $$

CREATE PROCEDURE `SUBCTAMONEDAAPORTACIONBAJ`(
# ========================================================================
# ------ SP PARA ELIMINAR LAS SUBCUENTAS DE MONEDAS DE APORTACIONES ------
# ========================================================================
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
										'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTAMONEDAAPORTACIONBAJ');
			END;

		DELETE
			FROM 	SUBCTAMONEDAAPORT
