...
-- SUBCTATITUINVBANBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTATITUINVBANBAJ`;DELIMITER $$

CREATE PROCEDURE `SUBCTATITUINVBANBAJ`(
    ...
    ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTATITUINVBANBAJ');
		...
		IF NOT EXISTS( SELECT ConceptoInvBanID FROM SUBCTATITUINVBAN 	WHERE ConceptoInvBanID=Par_ConceptoInvBanID) THEN
				Set Par_NumErr	:= '002';
