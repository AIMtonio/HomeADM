...
-- SUBCTARESTINVBANMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTARESTINVBANMOD`;DELIMITER $$

CREATE PROCEDURE `SUBCTARESTINVBANMOD`(
	...
	ManejoErrores: BEGIN
		...
		BEGIN
			...
			SET Par_ErrMen = concat('Estimado Usuario(a), Ha ocurrido una falla en el sistema, ' ,
									 ...
									 'esto le ocasiona. Ref: SP-SUBCTARESTINVBANMOD');
		...
		UPDATE SUBCTARESTINVBAN
		SET
		ConceptoInvBanID 		= Par_ConceptoInvBanID,
		RestricionCon 			= Par_RestricionCon,
		RestricionSin 			= Par_RestricionSin,
