...
-- PLAZOSCEDESALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `PLAZOSCEDESALT`;
DELIMITER $$


CREATE PROCEDURE `PLAZOSCEDESALT`(
# ===========================================================
# ----------- SP PARA REGISTRAR LOS PLAZOS DE CEDES----------
# ===========================================================
	Par_TipoCedeID			INT(11),
	Par_PlazosInferior		INT(11),
	Par_PlazosSuperior		INT(11),
...
TerminaStore: BEGIN
	...
	ManejoErrores:BEGIN
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET Par_ErrMen = CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
										'Disculpe las molestias que esto le ocasiona. Ref: SP-PLAZOSCEDESALT');
			END;
		...
		INSERT PLAZOSCEDES VALUES (
			Par_TipoCedeID, 	Par_PlazosInferior,		Par_PlazosSuperior,	Par_Empresa	,	Aud_Usuario,
