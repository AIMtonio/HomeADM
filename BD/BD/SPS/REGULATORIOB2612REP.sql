...
-- REGULATORIOB2612REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOB2612REP`;DELIMITER $$

CREATE PROCEDURE `REGULATORIOB2612REP`(
	/* Genera la llamada al regulatorio B2612 para Sofipo o Socap */
...
-- Variables
	...
	SET NumReporte			:= 'B2612';		-- Clave del reporte
	SET Entero_Cero			:= 0;
	SET Cadena_Vacia 		:= '';
