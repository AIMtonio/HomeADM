...
-- ---------------------------------------------------------------------------------
-- SUBCTASUCURARRENDABAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTASUCURARRENDABAJ`;DELIMITER $$

CREATE PROCEDURE `SUBCTASUCURARRENDABAJ`(
	...
	Par_SucursalID			INT(11),		-- Indica la sucursal de arrendamiento
	...
	ManejoErrores:BEGIN
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET	Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
														'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTASUCURARRENDABAJ');
		...
		DELETE 	FROM	SUBCTASUCURARRENDA
