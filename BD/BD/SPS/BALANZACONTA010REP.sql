...
-- BALANZACONTA010REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA010REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA010REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: CONSOL NEGOCIOS SA DE CV SOFOM ENR.
