...
-- SUBCTAMONEDADIVALT
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTAMONEDADIVALT`;DELIMITER $$

CREATE PROCEDURE `SUBCTAMONEDADIVALT`(
...
insert into SUBCTAMONEDADIV
			values (  	Par_ConceptoMonID,	 	Par_MonedaID,		Par_SubCuenta,
