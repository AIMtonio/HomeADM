...
-- ---------------------------------------------------------------------------------
-- EDOFLUJOEFECTIVO041REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOFLUJOEFECTIVO041REP`;

DELIMITER $$
CREATE PROCEDURE `EDOFLUJOEFECTIVO041REP`(
	-- SP para generar el Flujo de Efectivo MEXI - MAAKELAR
	-- Modulo Contabilidad
