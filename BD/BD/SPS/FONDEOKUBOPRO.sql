...
-- FONDEOKUBOPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `FONDEOKUBOPRO`;
DELIMITER $$


CREATE PROCEDURE `FONDEOKUBOPRO`(
...
BEGIN
	...
	FETCH CURSORSOLICIFON into
		...
		call  FONDEOKUBOALT (
        Var_ClienteID,          Par_CreditoID,          Var_CuentaAhoID,    Par_SolicitudCredID,
        Var_Consecutivo,        Var_FolioKubo,          For_TasaFija,       Tas_BaseVacia,
        Tas_SobTasCero,         Var_TasaPasiva,         Tas_PisoCero,       Tas_TechoCero,
        Var_MontoFondeo,        Var_PorcentajeFondeo,   Var_MonedaID,       Par_FechaInicio,
        Par_FechaVencimiento,   Var_TipoFondeadorID,    Par_NumCuotas,      Par_NumRetMes,
        Var_PorcentajeMora,     Var_PorcentajeComisi,	Aud_EmpresaID,      Var_SucCliente,
        Par_FechaOperacion,     Par_FechaAplicacion,    Var_Referencia,     Par_NumRetMes,
        Par_Poliza,             Salida_NO,              Par_NumErr,         Par_ErrMen,
        Par_Consecutivo,        Aud_Usuario,            Aud_FechaActual,    Aud_DireccionIP,
        Aud_ProgramaID,         Aud_Sucursal,           Aud_NumTransaccion  );
