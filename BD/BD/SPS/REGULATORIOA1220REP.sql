...
-- REGULATORIOA1220REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `REGULATORIOA1220REP`;
DELIMITER $$

CREATE PROCEDURE `REGULATORIOA1220REP`(
	/* Genera el regulatorio A1220 para Sofipo */
...
TerminaStore:BEGIN
	...
	SET NumReporte			:= '1220';		-- Clave del reporte
	SET CveTipoSaldo		:= '130';		-- Clave del Tipo de saldo
	SET CveTipoSaldo135		:= '135';		-- Clave del Tipo de saldo
	SET CveTipoSaldo136		:= '136';		-- Clave del Tipo de saldo
	SET Rep_Excel 			:= 1 ;
	SET Rep_Csv	  			:= 2;
	SET Entero_Uno 			:= 1;
	SET Entero_Cero			:= 0;
	...
	DROP TABLE IF EXISTS TMPREGULATORIOA1220;
	DROP TABLE IF EXISTS TMPREGULATORIOA;
	DROP TABLE IF EXISTS TMPREGULATORIOB;

	CREATE TEMPORARY TABLE TMPREGULATORIOA1220(
	...
	INSERT INTO  TMPREGULATORIOA1220
    ...
    CREATE TEMPORARY TABLE TMPREGULATORIOA SELECT * FROM TMPREGULATORIOA1220;
    CREATE TEMPORARY TABLE TMPREGULATORIOB SELECT * FROM TMPREGULATORIOA1220;
	...
	IF Par_NumRep = Rep_Excel THEN
		...
		FROM TMPREGULATORIOA1220 ORDER BY ClaveEntidad;
