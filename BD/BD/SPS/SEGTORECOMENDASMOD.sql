...
-- SEGTORECOMENDASMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `SEGTORECOMENDASMOD`;DELIMITER $$

CREATE PROCEDURE `SEGTORECOMENDASMOD`(

    Par_RecomendacionSegtoID    INT(11),
    ...
    DECLARE Var_RecomedacionSegtoID     INT(11);
    ...
    ManejoErrores:BEGIN
        ...
        DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
            ...
            concretar la operacion. Disculpe las molestias que ', 'esto le ocasiona. Ref: SP-SEGTORECOMENDASMOD');
        ...
        WHERE `RecomendacionSegtoID`= Par_RecomendacionSegtoID;

        SET Par_NumErr      := '000';
        SET Par_ErrMen      := CONCAT('Recomendacion Modificada Exitosamente: ', Par_RecomendacionSegtoID);
        SET Var_Control     := 'recomendacionSegtoID';
        SET Var_Consecutivo := Par_RecomendacionSegtoID;
