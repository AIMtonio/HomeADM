...
-- ---------------------------------------------------------------------------------
-- BITACORADOCGRDVALORESBAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS BITACORADOCGRDVALORESBAJ;

DELIMITER $$
CREATE PROCEDURE `BITACORADOCGRDVALORESBAJ`(
	-- Store Procedure: De Baja en la Bitacora los cambios de Estatus de los Documentos de Guarda Valores
	-- Modulo Guarda Valores
	Par_FechaCorte					DATE,			-- Fecha de Baja
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
									'Disculpe las molestias que esto le ocasiona. Ref: SP-BITACORADOCGRDVALORESBAJ');
		...
		DELETE FROM BITACORADOCGRDVALORES
		...
		SET Par_ErrMen	:= 'Documento Registrado Correctamente.';
		SET Var_Control	:= Cadena_Vacia;
