...
-- ---------------------------------------------------------------------------------
-- EDOFLUJOEFECTIVO039REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOFLUJOEFECTIVO039REP`;

DELIMITER $$
CREATE PROCEDURE `EDOFLUJOEFECTIVO039REP`(
	-- SP para generar el Flujo de Efectivo MEXI - REGIO
	-- Modulo Contabilidad
