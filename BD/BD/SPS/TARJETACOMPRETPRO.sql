...
-- TARJETACOMPRETPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `TARJETACOMPRETPRO`;
DELIMITER $$


CREATE PROCEDURE `TARJETACOMPRETPRO`(
...
DECLARE Var_MontoRetiro decimal(12,2);
...
if(Par_MontoAdicio != Entero_Cero) then
    set Var_MontoCompra := (Par_MontoTran - Par_MontoAdicio);
else
    set Var_MontoCompra := Par_MontoTran;
end if;
...
INSERT INTO CUENTASAHOMOV	(
	...
	VALUES	(
    Var_CuentaAhoID,    Aud_NumTransaccion, Var_FechaSis,       Nat_Cargo,      Var_MontoCompra,
...
if(Par_MontoAdicio != Entero_Cero) then
	...
	INSERT INTO CUENTASAHOMOV	(
                    ...
                    Sucursal,						NumTransaccion)
	VALUES	(
        Var_CuentaAhoID,    Aud_NumTransaccion, Var_FechaSis,       Nat_Cargo,      Par_MontoAdicio,
