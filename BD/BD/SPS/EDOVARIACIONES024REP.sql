...
-- ---------------------------------------------------------------------------------
-- EDOVARIACIONES024REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `EDOVARIACIONES024REP`;
DELIMITER $$

CREATE PROCEDURE `EDOVARIACIONES024REP`(
	-- Genera el reporte Contable de Estado de Variacion de Capital
	-- Modulo Contabilidad
...
TerminaStore: BEGIN
	...
	SET Var_FecConsultaAnterior := DATE_FORMAT(DATE_SUB(Par_FechaActual, INTERVAL Entero_Uno YEAR),'%Y-12-31');
	...
	IF IFNULL(Var_FechaCorte,Fecha_Vacia) !=   Fecha_Vacia  THEN
		...
		SET Var_FechaIniEjerAnt := DATE_ADD(Var_FechaCorte, INTERVAL Entero_Uno DAY);
	...
	IF IFNULL(Var_FechaCorte,Fecha_Vacia) !=   Fecha_Vacia  THEN
		...
		SET Var_FechaIniEjerAct := DATE_ADD(Var_FechaCorte, INTERVAL Entero_Uno DAY);
