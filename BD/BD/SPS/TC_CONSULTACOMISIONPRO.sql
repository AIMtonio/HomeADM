...
-- ---------------------------------------------------------------------------------
-- TC_CONSULTACOMISIONPRO
DELIMITER ;
DROP PROCEDURE IF EXISTS `TC_CONSULTACOMISIONPRO`;

DELIMITER $$
CREATE PROCEDURE `TC_CONSULTACOMISIONPRO`(
	...
	ManejoErrores:BEGIN
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
			...
			SET Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. Disculpe las molestias que ',
					 				'esto le ocasiona. Ref: SP-TC_CONSULTACOMISIONPRO');
		...
		SELECT 	LineaTarCredID,		ClienteID,		TarjetaCredID,			Estatus,
		...
		INTO 	Var_LineaTarCredID,	Var_ClienteID,	Var_TarjetaCreditoID,	Var_EstatusTarjeta,
				Var_BloquearATM,
		...
		CALL TC_CONTALINEAPRO (
			...
			Par_SurchargeAmounts,	Par_MonedaID,			Var_ProductoCreditoID,		Var_Clasificacion,		Con_SubClasificacion,
			...
			Mov_ComisionDisp,		Nat_Cargo,				Par_CodigoTransaccionID,	AltaMovBitacoraNO,		Cadena_Vacia,
			Par_TranCode,
