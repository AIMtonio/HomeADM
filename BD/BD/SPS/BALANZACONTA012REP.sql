...
-- BALANZACONTA012REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA012REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA012REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: CAJA SOLIDARIA LOS TRES REYES S.C. de A.P. de R.L. de C.V.
