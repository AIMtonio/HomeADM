...
-- ---------------------------------------------------------------------------------
-- SUBCTATIPOARRENDABAJ
DELIMITER ;
DROP PROCEDURE IF EXISTS `SUBCTATIPOARRENDABAJ`;DELIMITER $$

CREATE PROCEDURE `SUBCTATIPOARRENDABAJ`(
		...
		DECLARE EXIT HANDLER FOR SQLEXCEPTION
			BEGIN
				...
				SET	Par_ErrMen	= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
														'Disculpe las molestias que esto le ocasiona. Ref: SP-SUBCTATIPOARRENDABAJ');
