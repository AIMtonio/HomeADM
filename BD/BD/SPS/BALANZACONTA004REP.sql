...
-- BALANZACONTA004REP
DELIMITER ;
DROP PROCEDURE IF EXISTS `BALANZACONTA004REP`;

DELIMITER $$
CREATE PROCEDURE `BALANZACONTA004REP`(
	-- Store Procedure: Para generar la Balanza Contable del Cliente: CONCREEC S.A. DE C.V. SOFOM ENR.
	...
	SELECT Aud_NumTransaccion, Cue.CuentaCompleta,
		   ...
		   CASE WHEN Cue.Grupo = Tip_Encabezado AND Var_NumSegConta = 1
					 AND Cue.CuentaCompleta NOT IN ('140307100000000000', '230710000000000000',
													...
													'110103100000000000', '550410000000000000') THEN
