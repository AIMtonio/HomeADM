...
-- INCONSISTENCIASMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `INCONSISTENCIASMOD`;DELIMITER $$

CREATE PROCEDURE `INCONSISTENCIASMOD`(
-- ============================================================================================================
-- SP PARA MODIFICAR LAS INCONSISTENCIAS QUE EXISTEN EN LOS NOMBRES DE CLIENTES, PROSPECTOS, AVALES Y GARANTES
-- ============================================================================================================
	...
	ManejoErrores:BEGIN
			DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
				...
				SET Par_ErrMen	:= CONCAT('El SAFI ha tenido un problema al concretar la operacion. ',
								'Disculpe las molestias que esto le ocasiona. Ref: SP-INCONSISTENCIASMOD');
