...
-- PLDESCALASOLMOD
DELIMITER ;
DROP PROCEDURE IF EXISTS `PLDESCALASOLMOD`;DELIMITER $$

CREATE PROCEDURE `PLDESCALASOLMOD`(
	Par_FolioID					int(11),
			...
			DECLARE EXIT HANDLER FOR SQLEXCEPTION
				BEGIN
					...
					set Par_ErrMen = concat("Estimado Usuario(a), Ha ocurrido una falla en el sistema, " ,
								 ...
								 "esto le ocasiona. Ref: SP-PLDESCALASOLMOD");
				END;
...
update PLDESCALASOL  set
	NivelRiesgoID		= Par_NivelRiesgoID,
	Peps				= Par_Peps,
	ActuaCuenTer		= Par_ActuaCuenTer,
	DudasAutDoc			= Par_DudasAutDoc,
