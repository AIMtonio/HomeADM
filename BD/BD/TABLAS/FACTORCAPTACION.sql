...
-- FACTORCAPTACION
DELIMITER ;
DROP TABLE IF EXISTS `FACTORCAPTACION`;DELIMITER $$

CREATE TABLE `FACTORCAPTACION` (
  ...
  PRIMARY KEY (`Fecha`,`ClienteID`,`InstrumentoID`,`ProductoID`),
  KEY `IDX_FACTORCAPTACION_1` (`ClienteID`),
  KEY `IDX_FACTORCAPTACION_2` (`NumTransaccion`),
  KEY `IDX_FACTORCAPTACION_3` (`Fecha`,`NumTransaccion`)
