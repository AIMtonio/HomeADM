...
-- PLDPARALEOPINUS
DELIMITER ;
DROP TABLE IF EXISTS `PLDPARALEOPINUS`;
DELIMITER $$

CREATE TABLE `PLDPARALEOPINUS` (
  ...
  PRIMARY KEY (`FolioID`),
  KEY `IDX_PLDPARALEOPINUS_1` (`TipoPersona`,`NivelRiesgo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Parametros de  Operaciones Inusuales (Alertas automaticas de'$$