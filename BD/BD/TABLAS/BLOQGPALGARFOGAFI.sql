...
-- BLOQGPALGARFOGAFI
DELIMITER ;
DROP TABLE IF EXISTS `BLOQGPALGARFOGAFI`;DELIMITER $$

CREATE TABLE `BLOQGPALGARFOGAFI` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tmp: Tabla temporal para almacenar los bloqueos correspondientes a la garantía FOGAFI'$$