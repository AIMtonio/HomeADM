...
-- TC_BITACORARESP
DELIMITER ;
DROP TABLE IF EXISTS `TC_BITACORARESP`;DELIMITER $$

CREATE TABLE `TC_BITACORARESP` (
  `RespID` int(11) NOT NULL COMMENT 'ID de la Respuesta de Transaccion',
  `TarjetaCredID` char(16) DEFAULT NULL COMMENT 'Numero de Tarjeta de Debito',
  ...
  PRIMARY KEY (`RespID`),
  KEY `Index_TarjetaCred` (`TarjetaCredID`),
