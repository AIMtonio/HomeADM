...
-- CATTIPOGARANREG
DELIMITER ;
DROP TABLE IF EXISTS `CATTIPOGARANREG`;DELIMITER $$

CREATE TABLE `CATTIPOGARANREG` (
  `TipoGaranRegID` int(11) NOT NULL COMMENT 'Consecutivo para las opciones',
