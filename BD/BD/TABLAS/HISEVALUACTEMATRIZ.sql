...
-- HISEVALUACTEMATRIZ
DELIMITER ;
DROP TABLE IF EXISTS `HISEVALUACTEMATRIZ`;DELIMITER $$

CREATE TABLE `HISEVALUACTEMATRIZ` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla Histórica de la Evaluación Periódica de Clientes.'$$