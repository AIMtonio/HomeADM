...
-- BITACORAACCESO
DELIMITER ;
DROP TABLE IF EXISTS `BITACORAACCESO`;DELIMITER $$
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Almacacena datos de los usuarios que acceden al SAFI y pantallas que accede'$$