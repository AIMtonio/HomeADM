...
-- CATCADENAPRODUCTIVA
DELIMITER ;
DROP TABLE IF EXISTS `CATCADENAPRODUCTIVA`;DELIMITER $$

CREATE TABLE `CATCADENAPRODUCTIVA` (
  `CveCadena` int(11) NOT NULL COMMENT 'Clave de la Cadena',
  `NomCadenaProdSCIAN` varchar(45) NOT NULL COMMENT 'Nombre de la Cadena',
  ...
  PRIMARY KEY (`CveCadena`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Catalogo de Cadenas Productivas segun SCIAN'$$