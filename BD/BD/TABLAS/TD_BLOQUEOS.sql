...
-- TD_BLOQUEOS
DELIMITER ;
DROP TABLE IF EXISTS TD_BLOQUEOS;

DELIMITER $$
CREATE TABLE TD_BLOQUEOS (
	...
	KEY INDEX_TD_BLOQUEOS_1 (TarjetaDebID),
	KEY FK_TD_BLOQUEOS_2 (TiposBloqID),
	KEY INDEX_TD_BLOQUEOS_3 (NatMovimiento),
	KEY INDEX_TD_BLOQUEOS_4 (FolioBloqueo),
	KEY INDEX_TD_BLOQUEOS_5 (NumAutorizacionAct),
	KEY INDEX_TD_BLOQUEOS_6 (Referencia),
	CONSTRAINT FK_TD_BLOQUEOS_7 FOREIGN KEY (TiposBloqID) REFERENCES TIPOSBLOQUEOS (TiposBloqID) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='TAB: Control de Bloqueos y Desbloqueos de Tarjetas de Debito'$$