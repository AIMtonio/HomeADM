...
-- HISGRUPOSFAM
DELIMITER ;
DROP TABLE IF EXISTS `HISGRUPOSFAM`;DELIMITER $$

CREATE TABLE `HISGRUPOSFAM` (
  `GruposFamID` bigint(12) NOT NULL COMMENT 'ID del Histórico.',
  ...
  PRIMARY KEY (`ClienteID`,`GruposFamID`),
  KEY `IDX_HISGRUPOSFAM_1` (`ClienteID`),
  KEY `IDX_HISGRUPOSFAM_2` (`FamClienteID`),
  KEY `IDX_HISGRUPOSFAM_3` (`TipoRelacionID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='His: Grupos Famiiares de un Cliente.'$$