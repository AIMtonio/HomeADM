...
-- HISCATPAISESGAFI
DELIMITER ;
DROP TABLE IF EXISTS `HISCATPAISESGAFI`;DELIMITER $$

CREATE TABLE `HISCATPAISESGAFI` (
  `PaisHisID` int(11) NOT NULL COMMENT 'Id del historico.',
  ...
  PRIMARY KEY (`PaisHisID`,`PaisID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Historico del catalogo de los Paises GAFI.'$$