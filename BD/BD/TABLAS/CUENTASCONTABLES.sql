...
DROP TABLE IF EXISTS `CUENTASCONTABLES`;DELIMITER $$
  ...
  `CodigoAgrupador` char(10) DEFAULT NULL COMMENT 'Codigo Agrupador.',
  `Nivel` int(11) DEFAULT NULL COMMENT 'Nivel de la Cta',
  `FechaCreacionCta` date DEFAULT NULL COMMENT 'Fecha de Creacion de la Cuenta.',
