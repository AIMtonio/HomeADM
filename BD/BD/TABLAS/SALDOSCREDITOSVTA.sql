...
DELIMITER ;
DROP TABLE IF EXISTS `SALDOSCREDITOSVTA`;
DELIMITER $$

CREATE TABLE `SALDOSCREDITOSVTA` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='RESPALDO Saldos Diarios de Credito en venta de cartera';$$
