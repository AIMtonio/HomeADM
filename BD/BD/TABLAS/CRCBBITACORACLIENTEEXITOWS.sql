-- CRCBBITACORACLIENTEEXITOWS
DELIMITER ;
DROP TABLE IF EXISTS CRCBBITACORACLIENTEEXITOWS;

DELIMITER $$
CREATE TABLE `CRCBBITACORACLIENTEEXITOWS` (
  ...
  `ClienteID` int(11) NOT NULL COMMENT 'Identificador del cliente registrado',
  `FechaCarga` date DEFAULT NULL COMMENT 'Fecha de carga del registro de acuerdo a la tabla CS_CRCBCLIENTESWS',
  `FolioCarga` int(11) DEFAULT NULL COMMENT 'Folio de carga del registro de acuerdo a la tabla CS_CRCBCLIENTESWS',
  ...
  `NumErr` int(11) DEFAULT '0' COMMENT 'Numero de error registrado',
  `ErrMen` varchar(400) DEFAULT '' COMMENT 'Mensaje de error registrado',
  `Proceso` varchar(100) NOT NULL COMMENT 'Proceso que lanzo el error',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tab: Tabla para almacenar los registros de clientes con que no se registraron correctamente por el proceso masivo'$$