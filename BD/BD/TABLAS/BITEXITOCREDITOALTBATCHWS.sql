-- BITEXITOCREDITOALTBATCHWS
DELIMITER ;
DROP TABLE IF EXISTS BITEXITOCREDITOALTBATCHWS;

DELIMITER $$
CREATE TABLE `BITEXITOCREDITOALTBATCHWS` (
  ...
  `SolicitudCreditoID` bigint(20) DEFAULT '0' COMMENT 'ID de la solicitud de Credito generada en el proceso masivo de Creditos',
  `CreditoID` bigint(12) DEFAULT '0' COMMENT 'ID del credito generado en el proceso masivo de Creditos',
  `IDCreditoSIERRA` char(24) DEFAULT '' COMMENT 'Numero de CREDito SIERRA',
  `CuentaAhoID` bigint(12) DEFAULT '0' COMMENT 'ID de la cuenta generada en el proceso masivo de Creditos',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tb: Tabla para guardar la informacion del credito generado en el proceso masivo.'$$
