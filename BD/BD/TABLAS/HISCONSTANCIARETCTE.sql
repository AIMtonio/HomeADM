...
-- HISCONSTANCIARETCTE
DELIMITER ;
DROP TABLE IF EXISTS `HISCONSTANCIARETCTE`;
DELIMITER $$


CREATE TABLE `HISCONSTANCIARETCTE` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla que almacena datos historicos de los Clientes que generaron Constancia de Retencion.'$$