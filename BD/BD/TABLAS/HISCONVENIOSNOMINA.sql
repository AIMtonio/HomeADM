-- Creacion de tabla HISCONVENIOSNOMINA

DELIMITER ;

DROP TABLE IF EXISTS `HISCONVENIOSNOMINA`;

DELIMITER $$

CREATE TABLE `HISCONVENIOSNOMINA` (
	`HisConvenioNomID`		BIGINT(20)		NOT NULL COMMENT 'Identificador del historico del convenio',
	`FechaSistema`			DATETIME		NOT NULL COMMENT 'Fecha de pase a historico',
	...
	`FormCapPago`			TEXT(500)		NOT NULL COMMENT 'Formula para las solictudes del flujo individual',
	`FormCapPagoRes`		TEXT(500)		NOT NULL COMMENT 'Formula para las solictudes del flujo renovacion, restructura o consolidacion',
	...
	PRIMARY KEY (`HisConvenioNomID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='His: Tabla historica para registrar las modificaciones de los convenios de las empresas de nomina'$$