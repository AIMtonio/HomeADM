...
-- TC_BLOQUEOS
DELIMITER ;
DROP TABLE IF EXISTS TC_BLOQUEOS;

DELIMITER $$
CREATE TABLE TC_BLOQUEOS (
	BloqueoID			INT(11)			NOT NULL COMMENT 'ID del bloqueo',
	TarjetaCreditoID	CHAR(16)		NOT NULL COMMENT 'ID de la Tarjeta de Crédito',
	...
	KEY INDEX_TC_BLOQUEOS_1 (TarjetaCreditoID),
	KEY FK_TC_BLOQUEOS_2 (TiposBloqID),
	KEY INDEX_TC_BLOQUEOS_3 (NatMovimiento),
	KEY INDEX_TC_BLOQUEOS_4 (FolioBloqueo),
	KEY INDEX_TC_BLOQUEOS_5 (NumAutorizacionAct),
	KEY INDEX_TC_BLOQUEOS_6 (Referencia),
	CONSTRAINT FK_TC_BLOQUEOS_7 FOREIGN KEY (TiposBloqID) REFERENCES TIPOSBLOQUEOS (TiposBloqID) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='TAB: Control de Bloqueos y Desbloqueos de Tarjetas de Crédito'$$