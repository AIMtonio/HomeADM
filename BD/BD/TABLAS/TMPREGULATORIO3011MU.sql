...
-- ---------------------------------------------------------------------------------
-- TMPREGULATORIO3011MU
DELIMITER ;
DROP TABLE IF EXISTS `TMPREGULATORIO3011MU`;DELIMITER $$

CREATE TABLE `TMPREGULATORIO3011MU` (
  `EstadoID` int(11) NOT NULL DEFAULT '0' COMMENT 'ID del estado',
  `MunicipioID` varchar(20) NOT NULL DEFAULT '' COMMENT 'ID del municipio',
  ...
  `NumTransaccion` bigint(20) NOT NULL COMMENT 'Numero de transaccion que genera el reporte',
  ...
  KEY `idxNumTranTmp` (`NumTransaccion`)
