...
-- SALDOSCREDITOSCONT
DELIMITER ;
DROP TABLE IF EXISTS `SALDOSCREDITOSCONT`;
DELIMITER $$


CREATE TABLE `SALDOSCREDITOSCONT` (
  ...
  `FrecuenciaCap` char(1) DEFAULT NULL COMMENT 'Frecuencia del capital',
  ...
  `PeriodicidadInt` int(11) DEFAULT NULL COMMENT 'Periodicidad',
  ...
  `FechAutoriza` date DEFAULT NULL COMMENT 'Fecha de autorizacion',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Saldos Diarios de Creditos Contingentes'
/*!50100 PARTITION BY RANGE ( TO_DAYS(FechaCorte))
