...
-- CATTIPODISCREDREG
DELIMITER ;
DROP TABLE IF EXISTS `CATTIPODISCREDREG`;DELIMITER $$

CREATE TABLE `CATTIPODISCREDREG` (
  `TipoDispCredRegID` int(11) NOT NULL COMMENT 'Consecutivo para las opciones',
