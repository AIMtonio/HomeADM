...
-- RENDIMIENTOCEDES
DELIMITER ;
DROP TABLE IF EXISTS `RENDIMIENTOCEDES`;DELIMITER $$

CREATE TABLE `RENDIMIENTOCEDES` (
  ...
  KEY `fk_RENDIMIENTOCEDES_2_idx` (`TipoCedeID`),
  CONSTRAINT `fk_RENDIMIENTOCEDES_1` FOREIGN KEY (`CedeID`) REFERENCES `CEDES` (`CedeID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_RENDIMIENTOCEDES_2` FOREIGN KEY (`TipoCedeID`) REFERENCES `TIPOSCEDES` (`TipoCedeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
