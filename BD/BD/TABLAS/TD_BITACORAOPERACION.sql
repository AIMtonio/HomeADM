-- TD_BITACORAOPERACION
DELIMITER ;
DROP TABLE IF EXISTS TD_BITACORAOPERACION;

DELIMITER $$
CREATE TABLE TD_BITACORAOPERACION (
	...
	CardNumber					CHAR(16)		NOT NULL COMMENT 'Numero de Tarjeta de Debito',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tb: Tabla de Respaldo Para las Tarjetas de Débito'$$