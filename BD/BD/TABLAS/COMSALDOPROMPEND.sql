...
-- COMSALDOPROMPEND
DELIMITER ;
DROP TABLE IF EXISTS `COMSALDOPROMPEND`;

DELIMITER $$
CREATE TABLE COMSALDOPROMPEND(
    ...
    KEY `INDEX_COMSALDOPROMPEND_1` (`CuentaAhoID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1  COMMENT='TAB: Tabla de Comisiones Pendientes por Cobrar de Saldo Promedio'$$