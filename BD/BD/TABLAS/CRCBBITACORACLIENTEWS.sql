-- CRCBBITACORACLIENTEWS
DELIMITER ;
DROP TABLE IF EXISTS CRCBBITACORACLIENTEWS;

DELIMITER $$
CREATE TABLE `CRCBBITACORACLIENTEWS` (
  ...
  `NumErr` int(11) NOT NULL COMMENT 'Numero de error registrado',
  `ErrMen` varchar(400) NOT NULL COMMENT 'Mensaje de error registrado',
  ...
  `IDClienteSAFI` bigint(20) DEFAULT '0' COMMENT 'Numero de Cliente SAFI',
