...
-- RESAMORTICREDITOMIN
DELIMITER ;
DROP TABLE IF EXISTS `RESAMORTICREDITOMIN`;
DELIMITER $$


CREATE TABLE `RESAMORTICREDITOMIN` (
  ...
  `CuentaID` bigint(12) DEFAULT NULL COMMENT 'Numero de cuenta de ahorro.',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Respaldo por reversa de desembolsos o cancelaciones de Ministraciones. AMORTICREDITO.'$$