...
-- PRODUCTOSINVKUBO
DELIMITER ;
DROP TABLE IF EXISTS `PRODUCTOSINVKUBO`;DELIMITER $$

CREATE TABLE `PRODUCTOSINVKUBO` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Productos del Modelo de Inversionistas Kubo'$$