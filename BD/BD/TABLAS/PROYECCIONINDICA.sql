...
-- PROYECCIONINDICA
DELIMITER ;
DROP TABLE IF EXISTS `PROYECCIONINDICA`;DELIMITER $$

CREATE TABLE `PROYECCIONINDICA` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tab: Tabla que almacacena datos de las Proyecciones de Indicadores'$$