...
-- TC_HISBLOQUEOS
DELIMITER ;
DROP TABLE IF EXISTS TC_HISBLOQUEOS;

DELIMITER $$
CREATE TABLE TC_HISBLOQUEOS (
	...
	KEY INDEX_TC_HISBLOQUEOS_1 (BloqueoID),
	KEY INDEX_TC_HISBLOQUEOS_2 (TarjetaCreditoID),
	KEY INDEX_TC_HISBLOQUEOS_3 (TiposBloqID),
	KEY INDEX_TC_HISBLOQUEOS_4 (NatMovimiento),
	KEY INDEX_TC_HISBLOQUEOS_5 (FolioBloqueo),
	KEY INDEX_TC_HISBLOQUEOS_6 (NumAutorizacionAct),
	KEY INDEX_TC_HISBLOQUEOS_7 (Referencia)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='TAB: Historico de Control de Bloqueos y Desbloqueos de Tarjetas de Crédito'$$