...
-- HISAMORTIZAAPORT
DELIMITER ;
DROP TABLE IF EXISTS `HISAMORTIZAAPORT`;DELIMITER $$

CREATE TABLE `HISAMORTIZAAPORT` (
  ...
  KEY `INDEX_HISAMORTIZAAPORT_1` (`AportacionID`),
  KEY `INDEX_HISAMORTIZAAPORT_2` (`Estatus`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='His: Amortizaciones de las Aportaciones.'$$