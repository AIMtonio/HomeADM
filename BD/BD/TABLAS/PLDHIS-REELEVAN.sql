...
-- PLDHIS-REELEVAN
DELIMITER ;
DROP TABLE IF EXISTS `PLDHIS-REELEVAN`;
DELIMITER $$

CREATE TABLE `PLDHIS-REELEVAN` (
  `FechaGeneracion` date NOT NULL,
  `PeriodoID` int(11) NOT NULL,
  `OpeReelevanteID` int(11) NOT NULL COMMENT 'Clave o ID de la Operacion Reelevante',
  `PeriodoInicio` date DEFAULT NULL COMMENT 'Fecha de inicio del Periodo\n',
  `PeriodoFin` date DEFAULT NULL COMMENT 'Fecha Fin del periodo\n',
  `Archivo` varchar(45) DEFAULT NULL,
  `SucursalID` int(11) DEFAULT NULL COMMENT 'Clave o ID de la Sucursal',
  ...
  `PrimerNombreCliente` varchar(45) DEFAULT NULL COMMENT 'Primer Nombre del Cliente',
  `SegundoNombreCliente` varchar(45) DEFAULT NULL COMMENT 'Segundo Nombre del Cliente',
  `TercerNombreCliente` varchar(45) DEFAULT NULL COMMENT 'Tercer nombre del Cliente',
  `ApellidoPatCliente` varchar(45) DEFAULT NULL COMMENT 'Apellido Paterno del Cliente',
  `ApellidoMatCliente` varchar(45) DEFAULT NULL COMMENT 'Apellido Materno del Cliente',
  ...
  PRIMARY KEY (`PeriodoID`,`OpeReelevanteID`,`FechaGeneracion`)
