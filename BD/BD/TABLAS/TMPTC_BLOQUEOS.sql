...
-- TMPTC_BLOQUEOS
DELIMITER ;
DROP TABLE IF EXISTS TMPTC_BLOQUEOS;

DELIMITER $$
CREATE TABLE TMPTC_BLOQUEOS (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tmp:Temporal para el Control de Bloqueos y Desbloqueos de Tarjetas de Crédito'$$