...
-- CATPERIODOPAGCOMREG
DELIMITER ;
DROP TABLE IF EXISTS `CATPERIODOPAGCOMREG`;DELIMITER $$

CREATE TABLE `CATPERIODOPAGCOMREG` (
  `PeriodoPagComID` int(11) NOT NULL COMMENT 'Consecutivo para las opciones',
