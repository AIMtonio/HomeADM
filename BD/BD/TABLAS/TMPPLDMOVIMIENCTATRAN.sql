DELIMITER ;
DROP TABLE IF EXISTS `TMPPLDMOVIMIENCTATRAN`;
DELIMITER $$

CREATE TABLE `TMPPLDMOVIMIENCTATRAN` (
  `IDPLDMov` bigint(12) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `IDX_TMPPLDMOVIMIENCTATRAN_1` (`ClienteID`),
  KEY `IDX_TMPPLDMOVIMIENCTATRAN_2` (`NumTransaccion`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT 'TMP:Tabla temporal almacena movimientos cuenta para deteccion de operaciones inusuales-PLDOPEINUSALERTTRANSPRO'$$