...
-- REPORTESXMLPARAM
DELIMITER ;
DROP TABLE IF EXISTS `REPORTESXMLPARAM`;
DELIMITER $$

CREATE TABLE `REPORTESXMLPARAM` (
  ...
  CONSTRAINT `fk_REPORTESXMLPARAM_1` FOREIGN KEY (`ReporteID`) REFERENCES `REPORTESXML` (`ReporteID`) ON DELETE NO ACTION ON UPDATE NO ACTION
