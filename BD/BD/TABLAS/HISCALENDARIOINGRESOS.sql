-- Creacion de tabla HISCALENDARIOINGRESOS

DELIMITER ;

DROP TABLE IF EXISTS `HISCALENDARIOINGRESOS`;

DELIMITER $$

CREATE TABLE `HISCALENDARIOINGRESOS` (
	`CalendarioIngID`		BIGINT(12)		AUTO_INCREMENT NOT NULL COMMENT 'Numero Consecutivo de Calendario Ingresos',
	...
	`UsuarioID`	   			INT(11)			NOT NULL COMMENT 'Numero de Usuario que realizo la transaccion',
	`Hora`	   				VARCHAR(11)			NOT NULL COMMENT 'Hora en que se realizo la transaccion',
