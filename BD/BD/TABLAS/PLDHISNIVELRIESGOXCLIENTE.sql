...
-- ---------------------------------------------------------------------------------
-- PLDHISNIVELRIESGOXCLIENTE
DELIMITER ;
DROP TABLE IF EXISTS `PLDHISNIVELRIESGOXCLIENTE`;
DELIMITER $$

CREATE TABLE `PLDHISNIVELRIESGOXCLIENTE` (
  `ClienteID` int(11) NOT NULL COMMENT 'Numero de Cliente',
  `Fecha` date NOT NULL COMMENT 'Fecha en la que se actualizo el Nivel de Riesgo',
  `Hora` time NOT NULL COMMENT 'Hora en la que se Actualizo el Nivel de Riesgo',
  ...
  `TipoProceso` char(1) DEFAULT 'A' COMMENT 'Tipo de proceso A:Automatico M:Manual',
  ...
  PRIMARY KEY (`ClienteID`,`Fecha`,`Hora`),
  KEY `IDX_PLDHISNIVELRIESGOXCLIENTE_01` (`Fecha`)
