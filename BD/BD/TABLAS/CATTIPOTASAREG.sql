...
-- CATTIPOTASAREG
DELIMITER ;
DROP TABLE IF EXISTS `CATTIPOTASAREG`;DELIMITER $$

CREATE TABLE `CATTIPOTASAREG` (
  `TipoTasaRegID` int(11) NOT NULL COMMENT 'Consecutivo para las opciones',
