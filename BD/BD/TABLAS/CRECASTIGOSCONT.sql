...
-- CRECASTIGOSCONT
DELIMITER ;
DROP TABLE IF EXISTS `CRECASTIGOSCONT`;DELIMITER $$

CREATE TABLE `CRECASTIGOSCONT` (
  ...
  KEY `fk_CRECASTIGOSCONT_1_idx` (`MotivoCastigoID`),
  KEY `CRECASTIGOSCONT_IDX3` (`Fecha`),
  CONSTRAINT `fk_CRECASTIGOSCONT_1` FOREIGN KEY (`MotivoCastigoID`) REFERENCES `MOTIVOSCASTIGO` (`MotivoCastigoID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tab: Tabla que almacena Castigos de Cartera Contingente'$$