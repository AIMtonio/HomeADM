...
-- BUROCREDINTFMEN
DELIMITER ;
DROP TABLE IF EXISTS `BUROCREDINTFMEN`;DELIMITER $$

CREATE TABLE `BUROCREDINTFMEN` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Almacena la Cinta Mensual por Clave y Fecha de Envio'$$