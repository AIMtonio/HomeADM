...
-- TMPPLDCNBVOPREL
DELIMITER ;
DROP TABLE IF EXISTS `TMPPLDCNBVOPREL`;
DELIMITER $$

CREATE TABLE `TMPPLDCNBVOPREL` (
  ...
  `Domicilio` varchar(200) DEFAULT NULL COMMENT 'Domicilio del Sujeto Involucrado\n',
  ...
  `ClienteID` int(11) NOT NULL DEFAULT '0' COMMENT 'Clave o Id del Cliente',
  ...
  PRIMARY KEY (`Folio`,`PeriodoReporte`,`TipoReporte`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tlaba temporal para Reportar Operaciones PLD ante la CNBV'$$