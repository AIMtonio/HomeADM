...
-- BITACORACEDEVENMAS
DELIMITER ;
DROP TABLE IF EXISTS `BITACORACEDEVENMAS`;DELIMITER $$

CREATE TABLE `BITACORACEDEVENMAS` (
  ...
  `Exitos` int(11) NOT NULL COMMENT 'Total de registros que si se procesaron en el vencimiento masivo de CEDES',
