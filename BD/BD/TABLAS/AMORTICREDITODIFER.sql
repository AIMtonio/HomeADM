DELIMITER ;
DROP TABLE IF EXISTS AMORTICREDITODIFER;

DELIMITER ;
CREATE TABLE `AMORTICREDITODIFER` (
  ...
  `DiasAtraso` INT(11) DEFAULT 0 COMMENT 'Numero de dias de atraso que tenia al momento del diferimiento',
