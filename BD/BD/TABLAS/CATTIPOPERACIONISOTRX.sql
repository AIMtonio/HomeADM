...
-- ---------------------------------------------------------------------------------
-- CATTIPOPERACIONISOTRX
DELIMITER ;
DROP TABLE IF EXISTS `CATTIPOPERACIONISOTRX`;

DELIMITER $$
CREATE TABLE CATTIPOPERACIONISOTRX(
	CodigoOperacion			INT(11)			NOT NULL COMMENT 'Llave de Tabla: Código de Operación',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cat: Catálogo de Tipo Operaciones para ISOTRX.'$$