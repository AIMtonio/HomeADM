...
-- ---------------------------------------------------------------------------------
-- PLDHISPERFILTRANSREAL
DELIMITER ;
DROP TABLE IF EXISTS `PLDHISPERFILTRANSREAL`;
DELIMITER $$

CREATE TABLE `PLDHISPERFILTRANSREAL` (
  ...
  `Estatus` char(1) DEFAULT NULL COMMENT 'Estatus A:Autorizada R:Rechazada',
  `Hora` time DEFAULT NULL COMMENT 'Hora en la que se genero el perfil transaccional',
